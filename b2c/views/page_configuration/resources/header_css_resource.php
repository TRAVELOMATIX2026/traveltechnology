...
array_unshift(Js_Loader::$css, array('href' => $GLOBALS['CI']->template->template_css_dir('flags16.css'), 'media' => 'screen'));
array_unshift(Js_Loader::$css, array('href' => $GLOBALS['CI']->template->template_css_dir('flags32.css'), 'media' => 'screen'));
