...
<section class="passenger-details">
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div class="panel card b-r-0 m-0">
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td class="text-end"><?php echo $cur_Currency?> <span class="h4 text-i"><?=$price['BaseFare']?></span></td>
							</tr>
							<tr>
								<td>Taxes & Fees</td>
								<td class="text-end"><?php echo $cur_Currency?> <span class="h4 text-i"><?=$price['TotalTax']?></span></td>
							</tr>
							<tr>
								<td>Convenience Fees</td>
								<td class="text-end"><?php echo $cur_Currency?> <span class="h4 text-i"><?=$convinence_fees?></span></td>
							</tr>
							<tr>
								<td>Grand Total</td>
								<td class="text-end"><?php echo $cur_Currency?> <span class="h4 text-i"><?=$flight_total_price;?></span></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="panel card b-r-0 m-0">
					<div class="card-body p-t-0 p-b-0 text-center">
						<h2 class="h4 text-p text-start">Booking Summary
						 <?=$search_data['from']?>-<?=$search_data['to']?>(<?=get_trip_type($search_data['trip_type'])?>)</h2>
					</div>
					<?php foreach($summary as $___k => $___v) { //START FOR LOOP?>
					<div class="card-body p-t-0 p-b-0 text-center <?php echo ($___k > 0 ? 'more-details hide' : ''); ?>">
						<span class="badge bg-primary">Segment <?=($___k+1)?></span> <h3 class="h5"><b><?php echo $___v['from_loc']; ?></b></h3>
					...
					<table class="table text-start">
						<tbody>
								...
								<td class="text-end">
									<div role="" class="">
										<div role="group" class="btn-group btn-group-xs">
											<button class="btn btn-secondary b-r-0" type="button">
							...
							<tr>
								...
								<td class="text-end"><b><?php echo $___v['from_time']; ?></b></td>
							</tr>
							<tr>
								<td>Arrival Time</td>
								<td class="text-end"><b><?php echo $___v['to_time']; ?></b></td>
							</tr>
							<tr class="hide">
								<td>Class</td>
								<td class="text-end"><b>Economy</b></td>
							</tr>
							<tr>
								<td>Duration</td>
								<td class="text-end"><b><?php echo get_time_duration_label($___v['duration']); ?></b></td>
							</tr>
						</tbody>
					</table>
					</div>
...
<img src="<?=$GLOBALS['CI']->template->template_images('icons/angle-arrow-down.png')?>" alt="Angle Arrow Down Icon"> Billing Details</h1>
                    ...
                    <input type="hidden" name="billing_address_1" value="test">
							...
							<div class="clearfix">
								<div class="float-start alert-wrapper hide">
									<div role="alert" class="alert alert-danger">
									  <strong>Note :</strong> <span class="alert-content"></span>
									</div>
								</div>
								<div class="float-end text-end col-12 txtwrapRow">
									<div class="checkbox">
										<label>
