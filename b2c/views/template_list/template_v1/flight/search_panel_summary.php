			...
			<div class="panel card b-r-0">
				<div class="card-body p-0">
					<div class="row m-0 lg-flex">
						<div class="col-lg-2 col-md-4 col-sm-6 col-6 p-tb-5 lg-text-center b-r rslt_iconcntr">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-6 p-tb-5 b-r">
						...
						<div class="col-lg-1 col-md-4 col-sm-6 col-6 p-tb-5 b-r">
							<h2 class="h4">Class</h2>
							<h3 class="h5"><?php echo $flight_search_params['v_class'] ?></h3>
						</div>
						<div class="clearfix visible-sm-block"></div>
						<div class="col-lg-2 col-md-4 col-sm-6 col-12 p-tb-5 b-r">
							<h2 class="h4">Passengers</h2>
							<div class="btn-toolbar" role="toolbar">
								<div class="btn-group btn-group-xs" role="group">
									<button type="button" class="btn btn-secondary b-r-0">
						...
						<div class="col-lg-2 col-md-4 col-sm-6 p-tb-5">
							<br>
							<button type="button" class="btn btn-lg btn-block btn-p b-r-0 flight_search_form" data-bs-toggle="collapse" href="#flight_search_form">Modify Search</button>
						</div>
					</div>
