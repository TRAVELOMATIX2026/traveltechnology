...
<main class="main-main header" id="top" style="background-image: url('<?=$GLOBALS['CI']->template->domain_images().$image?>');">
	<div class="container theme1banner">
		...
		<div role="tabpanel" style="width:100% !important;">
           ...
           <li role="presentation" class="<?php echo set_default_active_tab(META_AIRLINE_COURSE, $default_active_tab)?>"><a href="#flight" aria-controls="flight" role="pill" data-bs-toggle="pill"><img src="<?php echo $GLOBALS['CI']->template->template_images('icons/flight-icon.png'); ?>" alt="Flight Icon"> <span class="hidden-xs">Flight</span></a></li>
           <?php } ?>
           <?php if (in_array(META_ACCOMODATION_COURSE, $active_domain_modules)) { ?>
           <li role="presentation" class="<?php echo set_default_active_tab(META_ACCOMODATION_COURSE, $default_active_tab)?>"><a href="#hotel" aria-controls="hotel" role="pill" data-bs-toggle="pill"><img src="<?php echo $GLOBALS['CI']->template->template_images('icons/hotel-icon.png'); ?>" alt="Hotel Icon"> <span class="hidden-xs">Hotel</span></a></li>
           <?php } ?>
           <?php if (in_array(META_BUS_COURSE, $active_domain_modules)) { ?>
           <li role="presentation" class="<?php echo set_default_active_tab(META_BUS_COURSE, $default_active_tab)?>"><a href="#bus" aria-controls="bus" role="pill" data-bs-toggle="pill"><img src="<?php echo $GLOBALS['CI']->template->template_images('icons/bus-icon.png'); ?>" alt="Bus Icon"> <span class="hidden-xs">Bus</span></a></li>
           <?php } ?>
           <?php if (in_array(META_PACKAGE_COURSE, $active_domain_modules)) { ?>
           <li role="presentation" class="<?php echo set_default_active_tab(META_PACKAGE_COURSE, $default_active_tab)?>"><a href="#holiday" aria-controls="holiday" role="pill" data-bs-toggle="pill"><img src="<?php echo $GLOBALS['CI']->template->template_images('icons/holiday-icon.png'); ?>" alt="Holiday Icon"> <span class="hidden-xs">Holiday</span></a></li>
           <?php } ?>
         </ul>
       </div>
     </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-sm-6 col-md-4">
					<img src="http://placehold.it/500x400" alt="Hotel" class="img-fluid mx-auto d-block">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-6">
				...
				<hr class="hr-10">
				<figure>
					<img src="http://placehold.it/800x300" alt="Flight Deals" class="img-fluid mx-auto d-block">
							...
							foreach ($top_destination_hotel as $tk => $tv) :?>
								<div class="col-lg-4 col-sm-6 htd-wrap">
									<figure class="explore-more">
										<img src="<?php echo $GLOBALS['CI']->template->domain_images($tv['image']); ?>" alt="<?=$tv['destination']?>" class="img-fluid mx-auto d-block">
										<figcaption>
											<div class="clearfix">
												<div class="float-start">
		...
		<div class="card card-body">
			<div class="row">
				...
				<div class="col-sm-6 col-md-4">
					<a href="#" role="button" class="btn btn-lg btn-secondary btn-block">
						<b>Call to Action</b>
					</a>
				</div>
			</div>
