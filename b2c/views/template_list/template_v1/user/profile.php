                ...
                <div role="tabpanel" class="tab-pane <?php echo (@$_GET['active'] == 'profile')? 'active' : ''?>" id="profile">
                	<div class="dashdiv">
                        <div class="alldasbord">
                            ...
                            <a href="#edit_user_profile" data-aria-controls="home" data-role="tab" data-bs-toggle="tab" class="editpro">Edit profile</a>
                            <div class="clearfix"></div>
							    ...
							    <form method="post" name="edit_user_form" id="edit_user_form" enctype="multipart/form-data" autocomplete="off">
							        <div class="infowone">
							            ...
							            <div class="paspertorgn2 paspertedit">
							                ...
							                <a href="#show_user_profile" data-aria-controls="home" data-role="tab" data-bs-toggle="tab" class="cancelll">Cancel</a>
							            </div>
							        </div>
							        </form>
							    </div>
                            ...
                            <div class="othinformtn">
                            	<ul class="nav nav-tabs tabssyb" role="tablist">
                                    <li data-role="presentation" class="active">
                                        <a href="#passportinfo" data-aria-controls="home" data-role="tab" data-bs-toggle="tab">Passport Information</a>
                                    </li>
                                    <li data-role="presentation" class="">
                                        <a href="#visainfo" data-aria-controls="home" data-role="tab" data-bs-toggle="tab">Visa Information</a>
                                    </li>
                ...
                <div role="tabpanel" class="tab-pane <?php echo (@$_GET['active'] == 'traveller')? 'active' : ''?>" id="travellerinfo">
                	<div class="trvlwrap">
                    	<div class="topbokshd">
                            ...
                            <a class="addbutton" data-bs-toggle="modal" data-bs-target="#add_traveller_tab">Add Traveller</a>
                        </div>
				                ...
				                <div class="tab-pane active" role="tabpanel">
				                    ...
				                    <form action="<?=base_url().'user/add_travller'?>" method="post" name="add_traveller_form" id="add_traveller_form">
				                        <div class="paspertedit">
				                            ...
				                            <a class="cancelll" data-bs-dismiss="modal">Cancel</a>
				                        </div>
				                        </form>
				                    </div>
				                </div>
					...
					<!-- Add Travller Modal Ends-->
                        <div class="fulltable">
                        	...
                        	<div class="trow tblhd">
                            	<div class="col-3 tblpad">
                                	<span class="lavltr">Name</span>
                                </div>
                                <div class="col-2 tblpad">
                            ...
                            <div class="trow">
                                ...
                                <div class="col-2 tblpad">
                                	<span class="lavltr">
                                    	<a class="detilac" data-bs-toggle="collapse" data-bs-target="#collapse101" aria-expanded="true">Detail</a>
                            ...
                            <div id="collapse101" class="collapse">
                            	...
                            	<ul class="nav nav-tabs tabssyb" role="tablist">
                                    <li data-role="presentation" class="active">
                                        <a href="#useinform" data-aria-controls="home" data-role="tab" data-bs-toggle="tab">User Information</a>
                                    </li>
                                    <li data-role="presentation" class="">
                                        <a href="#passportinfo1" data-aria-controls="home" data-role="tab" data-bs-toggle="tab">Passport Information</a>
                                    </li>
                                    <li data-role="presentation" class="">
                                        <a href="#visainfo1" data-aria-controls="home" data-role="tab" data-bs-toggle="tab">Visa Information</a>
                                    </li>
		...
		<div class="row">
			<div class="col-md-3">
				...
				<div class="panel card">
					<div class="card-body">
						<img alt="User profile picture" src="<?=$GLOBALS['CI']->template->template_images(get_profile_image($GLOBALS['CI']->entity_image));?>" class="profile-user-img img-fluid rounded-circle">
						...
						<a class="btn btn-secondary btn-block" href="#">Since :<b><?=app_friendly_date($this->entity_created_datetime)?></b></a>
					</div>
					<!-- /.box-body -->
				</div>
				<!-- /.box -->
			...
			<div class="col-md-9">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a data-bs-toggle="tab" href="#activity" aria-expanded="true">Activity</a></li>
						<li class=""><a data-bs-toggle="tab" href="#timeline" aria-expanded="false">Timeline</a></li>
						<li class=""><a data-bs-toggle="tab" href="#settings" aria-expanded="false">Settings</a></li>
					</ul>
					<div class="tab-content">
							...
							<!-- The timeline -->
							 ...
							 <div id="event_bottom_chain">
								<div style="" class="data-utility-loader text-center">
									...
									<!-- 
									<span><span/>
									Please Wait <img class="img-fluid mx-auto d-block" src="/proapp_ng/extras/system/template_list/template_v1/images/tiny_loader_v1.gif">
									 -->
								</div>
							</div>
						</div>
						...
						<div id="settings" class="tab-pane">
							...
							<form class="row" autocomplete="off" method="post">
								...
								<div class="form-group">
									<label class="col-sm-2 form-label" for="">Signature</label>
									<div class="col-sm-10">
