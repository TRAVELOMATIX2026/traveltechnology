			...
			<div class="col-md-4">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-end"><?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <span class="h4 text-i"><?=$pre_booking_params['markup_price_summary']['RoomPrice']?></span></td>
							...
							<tr>
								...
								<td class="text-end"><?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <span class="h4 text-i"><?=($convenience_fees+$tax_service_sum)?></span></td>
							...
							<tr>
								...
								<td class="text-end"><?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <span class="h4 text-i"><?=$convenience_fees+$total_price?></span></td>
				...
				<div class="panel card b-r-0 m-0">
					...
					<div class="card-body p-t-0 p-b-0 text-center">
						...
						<h2 class="h4 text-p text-start">Hotel Details</h2>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-end"><b><?=app_friendly_day($search_data['from_date'])?></b></td>
							...
							<tr>
								...
								<td class="text-end"><b><?=app_friendly_day($search_data['to_date'])?></b></td>
							...
							<tr>
								...
								<td class="text-end"><b><?=$search_data['no_of_nights']?></b></td>
							...
							<tr>
								...
								<td class="text-end"><b><?=$search_data['room_count']?></b></td>
							...
							<tr>
								...
								<td class="text-end"><b>Adult : <?=array_sum($search_data['adult_config'])?>, Child : <?=array_sum($search_data['child_config'])?></b></td>
							...
							<tr class="hide">
								...
								<td class="text-end"><a href="#">Fare Breakup</a></td>
