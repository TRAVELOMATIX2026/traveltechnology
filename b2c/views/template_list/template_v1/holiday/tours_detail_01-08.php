...
<div id="subtqry" class="card card-bodyme minwnwidth" style="display: none;">
    ...
    <div class="signdiv">
      ...
      <div class="col-md-10 col-12">
        <div class="col-md-6 col-12 "><input type="cancel"  value="Cancel" class="btn colorcancel closequery" id="hideCancelPopup" readonly/></div>
        <div class="col-md-6 col-12"><button type="submit"  value="Send Enquiry" class="btn colorsave" id="startCancelProc">Send Enquiry</button></div>
        </div>
      </div>
      </form>
    </div>
