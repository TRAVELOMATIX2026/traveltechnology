  ...
  <div class="container">
        ...
        <div class="contentpad">
            ...
            <div class="fulldetab">
                ...
                <div class="col-md-4 col-12 nopadMob fulatnine frtrit">
                <div class="alsidex">
                    <div class="sidebfs">
...
<div class="clearfix visible-sm-block visible-xs-block"></div>
                <div class="col-md-8 col-12 nopad fulatnine">
                    <div class="detailtab">
                        <ul class="nav nav-tabs trul">
                          <li class="active"><a href="#ovrvw" data-bs-toggle="tab">OverView</a></li>
                          <li class="trooms"><a href="#itnery" data-bs-toggle="tab">Detailed Itinerary</a></li>
                          <li class="tfacility"><a href="#tandc" data-bs-toggle="tab">Terms &amp; Conditions</a></li>
                        ...
                        <div class="tab-pane" id="ovrvw">
                        	<div class="innertabsxl">
                            	<div class="comenhtlsum">
                                	<?php echo !empty($package->package_description)?($package->package_description):"No Description"; ?>
                                </div>
                            ...
                            <div class="htlrumrowxl">
                            	<div class="hotelistrowhtl">
                                    ...
                                    <div class="dayecd">
                                        ...
                                        <?php if($pi->itinerary_image !=''):?>
                                        <img src="<?php echo $GLOBALS['CI']->template->domain_upload_pckg_images(basename($pi->itinerary_image)); ?>" width="50%">
                                        <?php endif;?>
                                    </div>
...
<div id="subtqry" class="card card-bodyme minwnwidth" style="display: none;">
    ...
    <div class="signdiv nopad">
      ...
      <div class="col-md-12 col-12 nopad">
        <div class="col-md-6 col-6"><input type="cancel"  value="Cancel" class="btn colorcancel closequery" id="hideCancelPopup" readonly/></div>
        <div class="col-md-6 col-6"><button type="submit"  value="Send Enquiry" class="btn colorsave" id="startCancelProc">Send Enquiry</button></div>
        </div>
      </div>
      </form>
    </div>
...
//  Check Radio-box
    ...
    $('#startCancelProc').click(function (e) {
        ...
        $.ajax({
            ...
            success:function(msg){
                if(msg.status == true){
                    $('.success_msg').html('<div class="alert alert-success alert-dismissible">'+msg.message+'</div>');
                    $('#tourenquiry')[0].reset(); 
                }
            },
            error:function(){
