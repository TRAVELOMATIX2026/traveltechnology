<link
	href="<?php echo $GLOBALS['CI']->template->template_css_dir('holiday-result.css') ?>"
	rel="stylesheet">
<link
...
<style type="text/css">
 ...
 .tabrow{ border:none; }   
 .padfive{ border:none; background:none; }
 .padselct{ padding-left:10px !important; background:#fff !important; }
</style>

<!-- <button onclick="topFunction()" id="backtotop" title="Go to top"></button>
 -->
 <div class="full witcontent">
	<div class="container">
          ...
          <?php $country_name = $this->Package_Model->getCountryName($pack->package_country); ?>
            <li class="col-md-12 col-12 nopadMob nopad">
							<div class="inlitp">
								...
								<div class="tpcontent col-sm-7 col-7 mobile_width">
								...
								<div class="pkprice col-sm-2 col-2 mobile_width nopad">
								...
								<a class="relativefmsub trssxl"
									href="<?php echo base_url(); ?>index.php/tours/package_pdf/<?php echo $pack->package_id; ?>" target="_blank">
									<span class="sfitlblx">Download</span> 
								</a>
								</div>
							</div>
						</li>
