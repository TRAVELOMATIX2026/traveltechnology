...
<body>
	<noscript>
		<img
			...
			class="img-fluid mx-auto d-block"></img>
	</noscript>
	<!-- header -->
				...
				<div class="row">
					<div class="col-md-3">
						<div class="navbar-header">
							<button type="button" class="navbar-togglerrrr collapsed"
							...
							<div class="clearfix">
								<div class="navbar-right">
									...
									<?php } else { ?>
										...
										data-bs-target="#myModal_1" class="btn btn-t b-r-0 navbar-btn">Sign
										in / Sign up</button>
									<?php } ?>
								</div>
							</div>
		...
		<div class="links">
			<div class="container">
                ...
                <?php } ?>
					 ...
					 ***************************************************************************************-->
					<div class="col-md-3 text-capitalize col-6 col-sm-4">
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-8">
						<ul class="list-inline text-end text-capitalize xs-text-center txtwrapRow">
							<li><a href="#">Home</a></li>
