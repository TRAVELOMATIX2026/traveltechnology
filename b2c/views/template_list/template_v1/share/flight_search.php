...
<form autocomplete="off" name="flight" id="flight_form" action="<?php echo base_url();?>index.php/general/pre_flight_search" method="get" class="activeForm oneway_frm" style="">
	<div class="row">
		...
		<div class="col-md-6 text-end">
			<div class="form-group">
				<label class="form-check form-check-inline hand-cursor">
	...
	<div class="row">
		<div class="col-sm-4">
			<div class="form-group">
				...
				<div class="input-group">
					<span class="input-group-text b-r-0 p-0">
		...
		<div class="col-sm-4">
			<div class="row">
			<div class="col-sm-6 date-wrapper noPL col-6">
			<div class="form-group">
		...
		<div class="col-sm-6 date-wrapper col-6 noPR">
			<div class="form-group">
