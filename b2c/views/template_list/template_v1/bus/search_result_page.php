	...
	<?php echo $GLOBALS['CI']->template->isolated_view('share/loader/bus_result_pre_loader',$data);?>
		<div class="row">
					...
					<div class="card-body refine">
						<div class="row">
							<div class="col-lg-12 col-md-4 col-sm-6">
								<h3 class="h4 m-t-0 refine-header" data-bs-toggle="collapse" data-bs-target=".price-refine"><img src="<?=$template_images?>icons/price-tag-icon.png" alt="Price Tag Icon"> Price</h3>
							...
							<div class="col-lg-12 col-md-4 col-sm-6 PT15mob">
								...
								<h3 class="h4 m-t-0 refine-header" data-bs-toggle="collapse" data-bs-target=".bustype-refine"><img src="<?=$template_images?>icons/bus-search-result-small-icon.png" alt="Bus Icon"> Bus Type</h3>
							...
							<div class="col-lg-12 col-md-4 col-sm-6 hide">
								<hr class="visible-lg-block hr-10">
								<h3 class="h4 m-t-0 refine-header" data-bs-toggle="collapse" data-bs-target=".departure-refine"><img src="<?=$template_images?>icons/bus-boarding-point-icon.png" alt="Bus Boarding Point Icon"> Departure</h3>
							...
							<div class="col-lg-12 col-md-4 col-sm-6 hide">
								<hr class="visible-lg-block hr-10">
								<h3 class="h4 m-t-0 refine-header" data-bs-toggle="collapse" data-bs-target=".arrival-refine"><img src="<?=$template_images?>icons/bus-dropping-point-icon.png" alt="Bus Dropping Point Icon"> Arrival</h3>
							...
							<div class="col-lg-12 col-md-4 col-sm-6">
								...
								<h3 class="h4 m-t-0 refine-header" data-bs-toggle="collapse" data-bs-target=".travel-refine"><img src="<?=$template_images?>icons/bus-star-icon.png" alt="Bus Star Icon"> Operators</h3>
			...
			<div class="col-lg-10">
				...
				<div id="bus_search_result" class="panel xs-text-center bus-search-result-panel card b-r-0 m-b-10">
				</div>
