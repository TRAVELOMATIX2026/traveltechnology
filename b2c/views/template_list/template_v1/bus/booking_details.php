		...
		<div class="row">
			...
			<div class="col-sm-<?php echo $col_md;?>">
				...
				<?php } ?>
					...
					<div class="col-sm-6">
						<h5 class="float-end m0 font13"><span class="colorgray">Booking ID :</span> <?php echo $booking_id;?></h5>
						<div class="clear-fix"></div>
						<br />
						<h5 class="float-end mb0 mt5 colorgray font12">Booking Date : <?php echo $booking_made_on;?></h5>
					</div>
				</div>
				<div class="row mt20 mb10 font12 bold">
						...
						<div class="col-md-3" style=" text-align: right; ">
							<div class="dropdown menu_action_holder" id="dLabel2" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
