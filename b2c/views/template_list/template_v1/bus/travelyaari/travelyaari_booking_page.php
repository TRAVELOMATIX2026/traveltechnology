			...
			<div class="col-md-3">
				<div class="panel card b-r-0 m-0">
					...
					<table class="table">
						<tbody>
							<tr>
								<td>Total Seat(s)</td>
								<td class="text-end"><span class="h4 text-i"><?=$seat_count?></span></td>
							</tr>
							<tr>
								<td>Grand Total</td>
								<td class="text-end"><?=$default_currency_symbol?> <span class="h4 text-i"><?=$markup_total_fare?></span></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="panel card b-r-0 m-0">
					<div class="card-body p-t-0 p-b-0 text-center">
						<h2 class="h4 text-p text-start">Bus Details</h2>
						<div class="clearfix">
							<div class="">
				...
				<div class="panel card b-r-0">
					<div class="card-body">
						<form action="<?php echo base_url().'index.php/bus/pre_booking/'.$search_data['search_id'] ?>" autocomplete="off" method="POST">
							...
							<!-- End Dynamics -->
							<div class="clearfix">
								<div class="float-end text-end txtwrapRow col-12">
									<div class="checkbox">
										<label>
