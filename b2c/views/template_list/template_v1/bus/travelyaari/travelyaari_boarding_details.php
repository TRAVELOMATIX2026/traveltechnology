...
<table class="table table-sm table-striped">
	<caption><img class="media-object float-start" src="<?php echo $template_images?>icons/bus-boarding-dropping-point-icon.png" alt="Bus Boarding Dropping Point Icon"><h4>Boarding Point Details</h4></caption>
	<tr>
		<th>Sno</th>
		<th>Pick Up</th>
		<th>Time</th>
...
<div>
<table class="table table-sm table-striped">
	<caption><img class="media-object float-start" src="<?php echo $template_images?>icons/bus-boarding-dropping-point-icon.png" alt="Bus Boarding Dropping Point Icon"><h4>Drop Point Details</h4></caption>
	<tr>
		<th>Sno</th>
		<th>Drop</th>
		<th>Time</th>
