...
<form name="activity_search" id="activity_search" autocomplete="on" action="<?php echo base_url().'index.php/general/pre_activity_search' ?>">
	<div class="intabs tabspl sight_form">
		<div class="outsideserach" style="float: left; width: 100%; margin-bottom: 15px;">
            ...
            <div class="col-6 nopad aftremarg padfive">
			<div class="col-md-7 col-12 nopad padfive">
				<div class="col-6 fiveh padfive">
			...
			<div class="col-md-5 col-12 nopad padfive">
                                        ...
                                        <div class="celroe col-5">
                                            <div class="selectedwrapnum">
                                                <div class="onlynumwrap wrap1 pax-count-wrapper">
															<div class="onlynum">
															<button data-field="adult" data-type="minus"  class="btn btn-secondary btn-number btnpot minusValueAct adult" type="button"> 
															...
															<button data-field="adult" data-type="plus" class="btn btn-secondary btn-number btnpot btn_right plusValAct" type="button"> 
                                        ...
                                        <div class="celroe col-5">
                                            <div class="selectedwrapnum">
                                                <div class="onlynumwrap wrap1">
													...
													<button type="button" class="btn btn-secondary btn-number btnpot minusValueAct child" data-type="minus" data-field="child"> <span class="fa fa-minus"></span> </button>
													...
													<button type="button" class="btn btn-secondary btn-number btnpot btn_right plusValAct" data-field="child" data-type="plus"> <span class="fa fa-plus"></span> </button>
													</div>
                                                </div>
                                            </div> 
                                        </div>
             ...
             ?>
				...
				<?php 	
							for($c = 1;$c<=10;$c++) {
								...
								?>
                <div class="col-6 fiveh padfive child-ages">
			...
			<div class="col-2 fiveh padfive float-end">
