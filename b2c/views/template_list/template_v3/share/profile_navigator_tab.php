<?php
	if($GLOBALS['CI']->uri->segment(2) != 'profile') {
		...
		$navigator_url = '';
		$navigator_toggle = 'data-aria-controls="home" data-role="tab" data-bs-toggle="tab"';
	}
?>
<ul class="nav nav-tabs customteam customteam2" role="tablist">
	<li data-role="presentation" class="<?php echo (((isset($_GET['active']) == false && empty($navigator_url) == true) || @$_GET['active'] == 'dashboard'))? 'active' : ''?>">
		...
		<!-- <span class="fa fa-dashboard icon_sml_mob"></span> --><span class="fa fa-tachometer icon_sml_mob"></span>
	...
	<!-- <li data-role="presentation" class="<?php echo (@$_GET['active'] == 'coupon')? 'active' : ''?>">
		<a class="a_coupon" href="<?php echo empty($navigator_url) ? '#coupon' : $navigator_url.'?active=coupon';?>" <?=$navigator_toggle?>>
		<span class="fa fa-tags icon_sml_mob"></span><strong>Coupon</strong></a>
	</li> -->
