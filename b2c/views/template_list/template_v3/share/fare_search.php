...
?>
<form autocomplete="off" name="flight" id="flight_form" action="<?php echo base_url();?>flight/calendar_fare" method="get" class="activeForm oneway_frm" style="">
	<div class="tabspl nopad">
		<div class="tabrow">
			...
			<div class="col-12 padfive marg12">
			...
			<div class="col-12 padfive marg12">
				...
				<div class="col-12 padfive date-wrapper hide">
						...
						<div class="roomcount pax_count_div">
							<div class="inallsn">
								<div class="oneroom fltravlr">
									<div class="roomrow">
										<div class="celroe col-4">Adults
											<span class="agemns">(12+)</span>
										</div>
										<div class="celroe col-8">
											<div class="input-group countmore"> <span class="input-group">
												<button type="button" class="btn btn-secondary btn-number" disabled="disabled" data-type="minus" data-field="adult"> <span class="glyphicon glyphicon-minus"></span> </button>
												</span>
									...
									<div class="roomrow hide">
										<div class="celroe col-4">Children
											<span class="agemns">(2-11)</span>
										</div>
										<div class="celroe col-8">
											<div class="input-group countmore"> <span class="input-group">
												<button type="button" class="btn btn-secondary btn-number" disabled="disabled" data-type="minus" data-field="child"> <span class="glyphicon glyphicon-minus"></span> </button>
												</span>
									...
									<div class="roomrow hide">
										<div class="celroe col-4">Infants
											<span class="agemns">(0-2)</span>
										</div>
										<div class="celroe col-8">
											<div class="input-group countmore infant_count_div"> <span class="input-group">
												<button type="button" class="btn btn-secondary btn-number" disabled="disabled" data-type="minus" data-field="infant"> <span class="glyphicon glyphicon-minus"></span> </button>
												</span>
