						...
						<tr>
							<td style="padding: 10px;">
								<table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;"> -->
									...
									<tr>
										<td width="50%" style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Reservation Ticket (<?php echo ucfirst($booking_details['departure_from']).' To '.ucfirst($booking_details['arrival_to']);?>)</td>
									</tr>
									<tr>
									...
									<tr>
										<td style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Travelers
											Information</td>
									...
									<tr>
										<td style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Rental Price Includes
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Payment Details
											</td>
									</tr>
									<tr>
										<td style="padding: 10px; border: 1px solid #cccccc;"><?php echo $attributes['payment_rule'];?>
											</td>
									...
									<tr>
										<td
											style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Cancellatio Policy
											</td>
									...
									<tr>
										<td style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Pay at Pickup
										</td>
									</tr>
									<tr>
										<td
									...
									<tr>
										<td width="50%"
											style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Terms
											and Conditions</td>
									</tr>
									<tr>
