...
<div style="width:100%; position:relative; background:#ccc; padding:20px 0;" id="tickect_hotel" class="table-responsive">
                  ...
                  <tr>
                     <td style="padding: 0px;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                              ...
                              <td colspan="2" style="border-bottom:1px solid #ddd;">
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                       ...
                                       <td style="padding: 0px 0px 10px; float:right;line-height: 26px;">
                                          <span style="font-weight:600;"><img width="15px" style="margin-right:5px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->template_images("call_v.png");?>"><span><?=$data['phone_code']?><?=$data['phone']?></span></span><br>
                                          <span style="font-weight:600;"><img width="18px" style="margin-right:5px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->template_images("mail_v.png");?>"> info@kapido.com</span>
                                       </td>
                                       <!-- <td style="padding: 0px;">
                                          ...
                                          <td valign="top" style="padding:0px 10px;width:70%;">
                                             ...
                                             <table style="width:100%; margin-top:10px; margin-bottom: 5px;color:#000;">
                                                <tr>
                                                   ...
                                                   <td>
                                                      <span style="background: #0080BD; padding: 4px 24px 6px; border: 1px solid #0080BD; color: #fff; border-radius:5px;" class="htl_nights">
                           ...
                           <tr><td style="line-height:12px;">&nbsp;</td></tr>      
                           <!-- <tr>
                              <td colspan="2" style="background-color:#0080BD;border: 1px solid #0080BD; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=BASE_PATH.SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Hotel Details</span></td>
                           </tr> -->
                           <tr>
                           ...
                           <tr><td style="line-height:12px;">&nbsp;</td></tr>
                           <!-- <tr>
                              <td colspan="2" style="background-color:#0080BD;border: 1px solid #0080BD; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=BASE_PATH.SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
                           </tr> -->
                           <tr>
                                       ...
                                       <tr>
                                             ...
                                             <table cellspacing="0" cellpadding="5" width="100%" style="font-size:13px; padding:0;">
                                                ...
                                                <?php } ?>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td style="border-top:1px solid #ccc;padding:5px;font-weight:600;"><span style="font-size:14px"><?php echo roundoff_number($booking_details['total_fare_markup']+$booking_details['total_fare_tax']+$itinerary_details['gst']-$booking_details['discount']); ?></span></td>
                                                   </tr>
                                          ...
                                          <!-- <td width="100%" style="display:block; width:100%;">
                                             <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #666;font-size:12px; padding:0;">
                                                <tbody>
                                                   <tr>
                                                      <td style="background-color:#0080BD;border-bottom:1px solid #ccc;padding:5px; color:#333"><span style="font-size:14px;color:#fff;">Room Inclusions</span></td>
                                                   </tr>
                                                   <?php if($attributes['Boarding_details']): ?>
                                                      <?php foreach($attributes['Boarding_details'] as $b_value):?>
                                                         <tr>
                           ...
                           <!-- <tr>
                              <td align="left" style="padding:10px;font-size:13px;line-height:20px;background: #efefef;border-radius:5px;">
                                 <span style="font-weight:600;line-height:30px;"><?=$data['domainname']?> Support: </span>
                                 <span>Email address: info@kapido.com </span> <br><span><?=$data['address']?></span>
                              </td>
                              <td><span>Contact No : <?=$data['phone_code']?><?=$data['phone']?></span></td>
                           </tr> -->
                           <tr>
                              <td style="background-color:#efefef;padding:15px;border-radius:5px;"><table cellspacing="0" cellpadding="5" width="100%">
                                 <tbody>
                                    <tr>
                                       <td>
                                          <span style="font-size:14px; font-weight: 700;"><?=$data['domainname']?> Support: <span style="font-size: 13px;font-weight:500;">Email Address: <span>info@kapido.com</span></span></span>
                                       </td>
   ...
   <table id="printOption"onclick="getPrint();"
      ...
      <tbody>
         <tr>
            <td align="center"><input style="background:#418bca; height:34px; padding:0px 10px; border-radius:4px; border:none; color:#fff; margin:0 2px;" type="button" value="Print" />
         </tr>
      </tbody>
   </table>
</div>
