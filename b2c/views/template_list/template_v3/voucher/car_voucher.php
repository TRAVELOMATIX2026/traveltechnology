...
$grand_total = ($booking_details['total_fare_markup']+$booking_details['total_fare_tax'])-$booking_details['discount'];//($booking_details['total_fare']+$booking_details['convenience_fees'])-$booking_details['discount'];
$grand_total = round($grand_total,2);
// debug($booking_details);exit;
 $currency_obj = new Currency(array('module_type' => 'car', 'from' => get_api_data_currency(), 'to' => get_application_currency_preference()));
 $currency_transaction_symbol = $currency_obj->get_currency_symbol($booking_details['transaction_currency']);
?>
<div class="container">
	<div class="table-responsive" id="tickect_car">
	<table
						...
						<tr>
							<td>
								<table width="100%" style="border-collapse: collapse;"
									...
									<tr>
										<td width="50%"
											style="padding: 10px; border: 1px solid #008100;background:#008100;color:#fff; font-size: 14px; font-weight: bold;">Reservation Ticket (<?php echo ucfirst($booking_details['car_pickup_lcation']).' To '.ucfirst($booking_details['car_drop_location']);?>)</td>
									</tr>
									<tr>
									...
									<tr>
										<td
											style="padding: 10px; border: 1px solid #008100; font-size: 14px; background:#008100;color:#fff;font-weight: bold;">Travelers
											Information</td>
										...
										<td style="border: 1px solid #008100;">
											<table width="100%" cellpadding="5"
												...
												<tr style="font-size: 15px;">
													<td colspan="5" align="right"><strong>Total Fare (<?=$booking_details['transaction_currency'];?>) : </strong></td>
													<td><strong><?=@$currency_transaction_symbol;?>  <?=$grand_total?></strong></td>
												</tr>
											</table>
										</td>
										<td></td>
									...
									<tr>
										<td
											style="padding: 10px; border: 1px solid #008100; font-size: 14px; background:#008100;color:#fff;font-weight: bold;">Rental Price Includes
											</td>
									...
									<tr>
										<td
											style="padding: 10px; border: 1px solid #008100; font-size: 14px;background:#008100;color:#fff;font-weight: bold;">Payment Details
											</td>

									</tr>
									<tr>
										<td
											style="padding: 10px; border: 1px solid #008100;"><?php echo $attributes['payment_rule'];?>
											</td>
									...
									<tr>
										<td
											style="padding: 10px; border: 1px solid #008100; font-size: 14px; font-weight: bold;background:#008100;color:#fff;">Cancellation Policy
											</td>
									...
									<tr>
										<td
											style="padding: 10px; border: 1px solid #008100; font-size: 14px; font-weight: bold;">Pay at Pickup
											</td>
									...
									<tr>
										<td width="50%"
											style="padding: 10px; border: 1px solid #008100; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Terms
											and Conditions</td>
									</tr>
									<tr>
