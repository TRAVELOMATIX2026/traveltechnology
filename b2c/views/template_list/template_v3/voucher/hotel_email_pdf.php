...
<table style="border-collapse: collapse; background: #ffffff;font-size: 12pt; margin: 0 auto; font-family: arial; padding:0px;" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tbody>
    <!-- <tr>
      <td style="border-collapse: collapse;" ><table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0"> -->
        ...
        <tr>
          <td colspan="2" style="border-bottom:1px solid #ddd;"><table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td style="width:100%;" colspan="4"><img width="150" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>"></td>
              <td style="padding:10px;" colspan="2"><table width="100%" style="border-collapse: collapse;text-align: right; font-size:10pt" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="font-size:10pt;text-align:left;padding-bottom:10px;"><img width="15px" style="margin-right:5px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->template_images("call_v.png");?>"><strong><?=$data['phone_code']?><?=$data['phone']?></strong></td>
                </tr>
                <tr>
                  <td style="font-size:10pt;"><img width="15px" style="margin-right:5px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->template_images("mail_v.png");?>"><strong>info@kapido.com</strong></td>
                </tr>
              </table></td>
            </tr>
            <!-- <tr>
          ...
          <td style="padding:0;background-color:#efefef;" colspan="2"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 10pt;padding:5px;">
            <tbody>
              <tr style="display:flex;align-items:stretch;">
                ...
                <?php else:?>
                  <td width="30%" colspan="2"><img style="width:200px; height:130px; object-fit:cover;" src="<?=$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" /></td>
                <?php endif;?>
                <td width="70%" colspan="5" valign="top"><strong style="font-size:14pt;vertical-align:middle;"><?php echo $booking_details['hotel_name']; ?></strong><br>
                  <span style="display: block;"><img style="width:70px;padding:8px 0px;" src="<?php echo $GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>" /></span><br><span style="display: block;font-size: 10pt;"><?php echo $booking_details['hotel_address'];?> </span>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 25%; text-align: center;padding:20px 0px 0px;">
                            <table><tr><td style="display:block;color: #fff;font-size:10pt;width:80px;background-color: #0E4D8D;text-align:center;padding:5px 0px;"><?= $booking_details['total_nights'] ?>
            ...
            <tbody>
              ...
              <tr>
                <td style="padding-left:210px;" width="100%">
                  &nbsp;&nbsp;<img style="width:18px;" src="<?php echo $GLOBALS['CI']->template->template_images('rooms_v.png'); ?>"><br><span style="font-size:10pt;"> 
                  <?php echo $booking_details['total_rooms']; ?> room
                  </span>
                </td>
                <td style="padding-right:70px;" width="100%">
                  &nbsp;<img style="width:22px;margin:auto;display:block; text-align:center;" src="<?php echo $GLOBALS['CI']->template->template_images('adults_v.png'); ?>"><br><span style="font-size:10pt;"> 
                    <?= $booking_details['adult_count'] ?> Adult
                  </span>
                </td>
                <td style="padding-right:20px;">
                  &nbsp;&nbsp;<img style="width:15px;" src="<?php echo $GLOBALS['CI']->template->template_images('child_v.png'); ?>"><br><span style="font-size:10pt;"> 
        ...
        <tr>
          <td style="padding: 10px;background-color:#efefef;" colspan="2">
            <table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;padding:10px;">
              <!-- <tr>
              ...
              <!-- <tr>
                <td width="100%" style="padding:0;"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 9pt;"> -->
                  <!-- <tr>
        ...
        <tr>
          <td width="100%" style="background: #efefef;padding:0" colspan="2"><table width="100%" cellpadding="5" style="padding: 10px;font-size:10pt;">  
            <tr>
              <td style="padding:5px;color: #333333;" width="16.66%"><strong>Sr No.</strong></td>
              <td style="padding:5px;color: #333333;" width="16.66%"><strong>Passenger(s) Name</strong></td>
              <td style="padding:5px;color: #333333;" width="16.66%"><strong>Email</strong></td>
              <td style="padding:5px;color: #333333;" width="16.66%"><strong>Contact No.</strong></td>
              <td style="padding:5px;color: #333333;" width="16.66%"><strong>Type</strong></td>
              <td style="padding:5px;color: #333333;" width="16.66%"><strong>Age</strong></td>
            </tr>
            <?php
                  $i=1;
                ?> 
            ...
            <tr>
              <td style="padding:5px;" width="16.66%"><?=$i?></td>
              <td style="padding:5px" width="16.66%"><?php echo $details['title'].' '.$details['first_name'].' '.$details['last_name']?></td>
              ...
              <td style="padding:5px;" width="16.66%"><?=$details['pax_type']?></td>
                <?php
                  ...
                  $i++;
                ?>
              <td style="padding:5px;" width="16.66%"><?=$age?></td>    
            </tr>
            <?php endforeach;?> 
          </table>
          </td>
        ...
        <tr><td style="line-height:2px;">&nbsp;</td></tr>
        <tr>
          <td style="padding:0; background:#efefef;" colspan="2"><table width="100%" cellpadding="5" style="padding: 10;font-size: 10pt;">   
            <tbody>
              <!-- <tr>
                <td width="100%"><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;">
                  <tbody> -->
                    <tr>
                      <td style="padding:5px;" width="100%" colspan="4"><strong style="font-size:10pt">Payment Details</strong></td>
                      <td style="padding:5px;" colspan="2"><strong style="font-size:10pt">Amount (<?=$booking_details['currency']?>)</strong></td>
                    </tr>
                    <tr>
                      <td style="padding:5px" width="100%" colspan="4"><span>Room Rate</span></td>
                      <td style="padding:5px"><span><?php echo roundoff_number($booking_details['total_fare_markup']); ?></span></td>
                    </tr>
                    <tr>
                      <td style="padding:5px" width="100%" colspan="4"><span>Taxes & Fees</span></td>
                    ...
                    <tr>
                      <td style="border-top:1px solid #ccc;padding:5px" colspan="4" width="100%"><strong style="font-size:10pt">Total Fare</strong></td>
                      <td style="border-top:1px solid #ccc;padding:5px;"><strong style="font-size:10pt;"><?php echo roundoff_number($booking_details['total_fare_markup']+$booking_details['total_fare_tax']+$itinerary_details['gst']-$booking_details['discount']); ?></strong></td>
                    </tr>
                     <?php if($booking_details['total_destination_charge'] > 0){?>
                      <tr>
                        <td style="border-top:1px solid #ccc;padding:5px" colspan="4" width="100%"><span>Local Tax <small>(Pay at property)</small></span></td>
                        <td style="border-top:1px solid #ccc;padding:5px;"><span><?php echo roundoff_number($booking_details['total_destination_charge']); ?></span></td>
                      </tr>
                    <?php } ?>
                  <!-- </tbody>
                </table>
...
<div style="font-family:arial;font-size:10pt; color:#555;">
  <tr>
    <td style="border-bottom:1px solid #999999; padding:15px 0px; line-height:16px;" width="100%" colspan="2">
    <ul>
        ...
        <tbody>
          <tr>
              <td colspan="2" width="100%">
                <span style="font-size:10pt;"><strong><?=$data['domainname']?> Support: </strong><span style="font-size: 10pt;">Email Address: <span>info@kapido.com</span></span></span>
              </td>
