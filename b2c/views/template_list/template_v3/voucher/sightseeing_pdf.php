...
?>
   ...
   <table class="table" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; width:1000px; margin:0px auto;background-color:#fff;">
      <tbody>
         <tr>
