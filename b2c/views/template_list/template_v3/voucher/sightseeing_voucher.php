...
<div class="table-responsive" style="width:100%;position:relative;background: #ccc;padding: 20px 0px;" id="tickect_sightseeing">
            ...
            <td style="border-collapse: collapse; padding:50px 35px;">
               <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                  <tbody>
                     <tr>
                                       ...
                                       <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                          <tbody>
                                             <tr style="background: #008100;color:#fff;">
                                                <td style="padding: 0px;"><img style="width:170px;" src="<?=BASE_PATH .$GLOBALS['CI']->template->domain_images($data['logo'])?>"></td>
                                                <td style="padding: 0px;">
                      ...
                      ?></strong>                              </td>
                                       ...
                                       <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                          <tbody>
                                             <tr>
                                                ...
                                                <?php else:?>
                                                     <img style="width:160px;height:107px;" src="<?=BASE_PATH .$GLOBALS['CI']->template->template_images("no_image_available.jpg");?>"></td>
                                                <?php endif; ?>
                                                <td valign="top" style="padding:10px;"><span style="line-height:22px;font-size:16px;color:#008100;vertical-align:middle;font-weight: 600;"><?=$booking_details['product_name']?></span><br><span style="display: block;line-height:22px;font-size: 13px;"><?=$attributes['Destination']?> </span><br><span style="display: block;line-height:22px;font-size: 13px;" class="hide"><img style="width:70px;" src="<?php echo BASE_PATH .$GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>"></span></td>
                                 ...
                                 <tr>
                                    <td style="background-color:#008100;border: 1px solid #008100; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src='<?=BASE_PATH .SYSTEM_IMAGE_DIR.'hotel_v.png';?>'/> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Activity Details</span></td>
                                 </tr>
                                 <tr>
                ...
                ?>
                                 ...
                                 <tr>
                                    <td style="background-color:#008100;border: 1px solid #008100; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=BASE_PATH .SYSTEM_IMAGE_DIR.'people_group.png'?>"> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Traveller(s) Details</span></td>
                                 </tr>
                                 <tr>
                                    <td width="100%" style="border: 1px solid #008100; padding:0px;">
                                       <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;">
                                          <tbody>
                                             <tr>
                                                ...
                                                <td style="background-color:#d9d9d9;padding:5px;color: #333333;">No Of Paxes</td>
                                             </tr>
                                             <?php $i=1;?>  
                                             ...
                                             <tr>
                                               ...
                                               <td style="padding:5px;"><?=$booking_details['no_of_paxes'];?></td>                            
                                             </tr>
                                              <?php $i++;?>
                                             <?php endforeach;?>
                                          </tbody>
                                             ...
                                             <tr>
                                                   ...
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #008100;">
                                                      <tbody>
                                                        ...
                                                        <?php } ?>
                                                         ...
                                                         <tr>
                                                            <td style="border-top:1px solid #008100;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #008100;padding:5px"><span style="font-size:13px"><?php echo roundoff_number($booking_details['product_total_price']+$itinerary_details['gst']+$booking_details['convinence_amount']-$booking_details['discount']); ?></span></td>
                                                         </tr>
                                                ...
                                                <td width="50%" style="padding:0;padding-left:14px; vertical-align:top">
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:12px; padding:0;">
                                                      <tbody>
                                                         <tr>
                                                            <td style="background-color:#008100;border-bottom:1px solid #008100;padding:5px; color:#fff"><span style="font-size:13px">Activity Inclusions</span></td>
                                                         </tr>
                                                         <?php 
                                                         //debug($inclustions);exit;
                                                         if($inclustions):?>
                                 ...
                                 <tr>
                                    <td align="center" colspan="4" style="border-bottom:1px solid #008100;padding-bottom:15px"><span style="font-size:13px; color:#555;">Customer Contact Details | E-mail : <?=$customer_details[0]['email']?> | Contact No : <?=$booking_details['phone_code'] ." ". $customer_details[0]['phone']?></span></td>
                                 </tr>
                                 <tr>
                                    <td style="line-height:12px;">&nbsp;</td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td colspan="4" style="line-height:20px; padding-bottom:15px; font-size:12px; color:#555">
                                      ...
                                      <ul><?php foreach($exclustions as $exclu):?><li><?=$exclu['description']?></li><?php endforeach;?></ul>
                                    </td>
                                 </tr>                                 
                                 <tr>
                                 ...
                                 <tr>
                                    <td colspan="4" align="" style="padding-top:10px;font-size: 14px;">
                                       <span style="font-weight:600;"><?= $this->entity_domain_name ?></span>&nbsp;&nbsp; | &nbsp;&nbsp;<span style="font-weight:600;">Contact No: </span><?= $this->entity_domain_phone_code ?> <?= $this->entity_domain_phone; ?>&nbsp;&nbsp; | &nbsp;&nbsp;<span  style="font-weight:600;">Address: </span><?= $this->application_address ?>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
  ...
  <table class="no-print" id="printOption"onclick="getPrint();"
