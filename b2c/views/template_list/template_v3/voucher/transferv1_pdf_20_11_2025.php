    ...
    <!-- <tr>
      <td style="border-collapse: collapse; padding:10px 20px 20px">
        <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0"> -->
			    ...
			    <tr>
					  <td style="background: #008100;color:#fff;">
              <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
			          <tr>
                          ...
                          <td width="100%" colspan="4" style="padding:0px;vertical-align:top;"><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #008100;">
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="border-top:1px solid #008100;padding:5px" width="100%" colspan="4"><span style="font-size:13px"><?php echo roundoff_number($booking_details['product_total_price']+$booking_details['convinence_amount']-$booking_details['discount']); ?></span></td>
                                </tr>
