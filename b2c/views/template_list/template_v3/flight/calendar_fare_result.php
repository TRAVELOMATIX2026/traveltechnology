...
<section class="search-result">
	<div class="container">
		...
		<div class="resultalls">
			<div class="coleft">
				<div class="flteboxwrp" style="background:#fff;">
					<div class="filtersho">
						<div class="avlhtls">
							<strong style="color: #fff;">Modify Search</strong>
						</div>
					</div>
			...
			<div class="colrit">
				<div class="insidebosc">
					...
					<div class="margcalndr" style="background:#fff; padding:14px;">
		...
		*/
		...
		function core_flight_fare_loader(booking_source_id, departure) {
			...
			if ((departure in fare_cache) == false) {
				...
				$.ajax({
					type: 'POST',
					url: app_base_url+'ajax/fare_list/'+booking_source_id+'?'+jQuery.param(search_params),
					async: true,
					cache: true,
					dataType: 'json',
