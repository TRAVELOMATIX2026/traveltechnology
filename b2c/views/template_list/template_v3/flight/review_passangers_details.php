  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="<?= base_url() ?>flight/edit_pax" class="row">
        </form>
      </div>
    </div>
  </div>
      ...
      <table cellspacing="0" cellpadding="5" width="100%" style="font-size:14px; padding:0;">
        <tbody>
          ...
          <tr>
            ...
            <td><button type="button" class="edit_pax" data-id="<?= $cus_v['origin'] ?>" data-bs-toggle="modal" data-bs-target="#editPax"><i class="fa fa-pencil"></i></button>
              <div class="hidden edit_pax_html">
                ...
                <div class="form-group">
                  <label class="form-label col-md-4" for="first_name">Passenger First Name<span class="required"> *</span></label>
                  <div class="col-md-5">
                    <input class="code form-control" required="required" type="text" name="first_name" value="<?= $cus_v['first_name'] ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="form-label col-md-4" for="last_name">Passenger Last Name<span class="required"> *</span></label>
                  <div class="col-md-5">
                    <input class="code form-control" required="required" type="text" name="last_name" value="<?= $cus_v['last_name'] ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="form-label col-md-4" for="first_name">Dob<span class="required"> *</span></label>
                  <div class="col-md-5">
                    <?php
                      $dob_id = "";
                ...
                <?php
                  ...
                  if ($booking_details ['is_domestic'] != true) { ?>
                    <div class="form-group">
                      <label class="form-label col-md-4" for="last_name">Passport Number<span class="required"> *</span></label>
                      <div class="col-md-5">
                    ...
                    <div class="form-group">
                      <label class="form-label col-md-4" for="last_name">Passport Issuing Country<span class="required"> *</span></label>
                      <div class="col-md-5">
                    ...
                    <div class="form-group">
                      <label class="form-label col-md-4" for="last_name">Passport expiry<span class="required"> *</span></label>
                      <div class="col-md-2">
  ...
  <tr>
    <td colspan="4" style="border-bottom:1px solid #999999;padding-bottom:15px">
      <span style="font-size:14px; color:#555;"><p style="color:#212121;font-size:16px;font-weight: bold;">Customer Contact Details :<span style="display: block; float: right;">
        <button type="button"data-bs-toggle="modal" data-bs-target="#editBookingDetails" class="contact_info_edit"><i class="fa fa-pencil"></i></button></span></p>
   ...
   <tr>
      <td>
        <div style="text-align: center;">
            <a href="<?php echo base_url().'payment_gateway/payment/'.$app_reference.'/'.$book_origin ?>" class="no-pad" style="padding-left: 0">
...
<div id="editBookingDetails" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="booking_details" action="<?= base_url() ?>flight/edit_booking_details" class="row">
          <input type="hidden" name="origin" value="<?= $booking_details['origin'] ?>">
          <input type="hidden" name="app_reference" value="<?= $app_reference ?>">
          <div class="form-group">
            <label class="form-label col-md-3" for="first_name">Email<span class="required"> *</span></label>
            <div class="col-md-5">
              <input class="code form-control" type="text" required="required" name="email" value="<?= $booking_details['email'] ?>" />
            </div>
          </div>
          <div class="form-group">
             <label class="form-label col-md-3">Phone<span class="required"> *</span></label>
            <div class="col-md-5">
          ...
          <div class="form-group">
            <label class="form-label col-md-3" for="last_name"></label>
            <div class="col-md-5">
