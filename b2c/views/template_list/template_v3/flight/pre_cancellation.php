    	...
    	<div class="cancellation_page">
            ...
            ?>
            	<div class="col-3 nopad">
                	<div class="pad_evry">
                    	<div class="imge_can"><img class="airline-logo" src="<?=SYSTEM_IMAGE_DIR.'airline_logo/'.$airline_code.'.svg'?>" alt="Flight Image"></div>
				...
				<div class="clearfix"></div>
                <?php } ?>
                <form name="passenger_ticket_form" id="passenger_ticket_form" class="passenger_ticket_form" method="post" action="<?=base_url().'flight/cancel_booking'?>"><!-- Passenger Form Starts -->
            ...
            <div class="clearfix"></div>
            <div class="ritside_can col-6 nopad">
