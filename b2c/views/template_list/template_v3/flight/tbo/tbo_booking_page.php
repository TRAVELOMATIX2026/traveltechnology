...
// $flight_total_amount = floatval( number_format(($FareDetails['BaseFare']+ $FareDetails['TotalTax']+$convenience_fees),2));

$flight_total_amount = round(($FareDetails['BaseFare'] + $FareDetails['TotalTax'] + $convenience_fees), 2);
// echo $total = $FareDetails['BaseFare']+ $FareDetails['TotalTax']+$convenience_fees;
// die;


//$flight_amount = $FareDetails['TotalFare'];
// $flight_amount = floatval( number_format(($FareDetails['BaseFare']+ $FareDetails['TotalTax']),2));
$flight_amount = round(($FareDetails['BaseFare'] + $FareDetails['TotalTax']), 2);
/* * ******************************* Convenience Fees ******************************** */
    ...
    <div class="container nopad">
        ...
        <div class="ovrgo">
            ...
            <div class="bktab1 xlbox <?= $review_tab_details_class ?>">
                ...
                <div class="col-8 nopadding full_summery_tab">
                <div class="moreflt boksectn">
                        <?= $flight_segment_details['segment_full_details']; ?>
                    </div>
                    <?php if (!empty($middle_ads)) { ?>

                        <?php foreach ($middle_ads as $middle_ad) { ?>

                            <div class="lstng_banner_hrzntl ">

                                <img src="<?php echo $GLOBALS['CI']->template->domain_images($middle_ad['image']) ?>" width="131px" height="1186px" alt="" />

                                <p><?= $middle_ad['message'] ?></p>
                                <!-- <p>For Worry-free Travel: Grab Up to 30% OFF*</p> -->
                                ...
                                <div class="loginspld">
                                    <div class="logininwrap">
                                        ...
                                        <div class="newloginsectn">
                                            <div class="col-7 celoty nopad">
                                                <div class="insidechs">
                                                    ...
                                                    <div class="havealrdy">
                                                        ...
                                                        <label for="alreadyacnt" class="haveacntd">I have a Password</label>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="twotogle">
                                                        <div class="cntgust">
                                                            <div class="phoneumber">
                                                                <div class="col-5 nopadding">
                                                                    <select class="newslterinput nputbrd _numeric_only" id="before_country_code">
                                                                        ...
                                                                        //foreach($iso_country_list as $cuntry_key => $country_val) { 
                                                                        ?>
                                                                        <!--  <option value="<?= $cuntry_key; ?>" ><?= $country_val; ?></option> -->
                                                                        <?php // } 
                                                                        ?>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="clearfix"></div>
                                                            <div class="continye col-12 nopad">
                                            ...
                                            <div class="col-1 celoty nopad linetopbtm">
                                                <div class="orround"><span>OR</span></div>
                                            </div>

                                            <div class="col-4 celoty nopad">
                                                <div class="insidechs booklogin">
                                                    <div class="leftpul">
                                                        ...
                                                        if ($social3) {
                                                            ...
                                                            echo $GLOBALS['CI']->google->login_booking_button();
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
            ...
            <div class="topalldesc  d-none">
                    
                    <!-- Outer Summary -->
                    <div class="col-4 nopadding celtbcel colrcelo">
                        <div class="bokkpricesml">
                            ...
                            <div class="totlbkamnt"> Total Amount <span class="total_amount_span"><?php echo $currency_symbol; ?> </span> <span id="total_booking_amount"><?php echo $flight_total_amount; ?></span></div>
                            ...
                            <a class="fligthdets" data-bs-toggle="collapse" data-bs-target="#fligtdetails">Flight Details</a>
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="splbukdets" id="fligtdetails">
                    <div class="moreflt insideagain boksectn">
                        <?= $flight_segment_details['segment_full_details']; ?>
                    </div>
                </div>
                <!-- Segment Details Ends-->
                        ...
                        <div class="wrapper mx-auto d-block insrnce mt10 <?php echo $insurance_status; ?> hide">
                            <div class="card-group mb0" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel card">
                                    ...
                                    <div id="collapseOne" class="collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="card-body">
                        ...
                        <div class="col-12 p-0">
                             ...
                             * @param int $total_adult   total adult count
                             */
                            ...
                            ?>
                            <form action="<?= base_url() . 'flight/pre_booking/' . $search_data['search_id'] ?>" method="POST" autocomplete="off" id="pre-booking-form">
                                <div class="hide">
                                    ...
                                    <input type="hidden" required="required" name="fare_quote_params" value="<?= @$fare_quote_params; ?>" />
                                    ...
                                    <input type="hidden" name="total_fare_markup" value="<?= @$FareDetails['TotalFare']; ?>" />
                                    <input type="hidden" name="total_fare_tax" value="<?= ((@$convenience_fees ? $convenience_fees : 0) + $FareDetails['_GST']); ?>" />
                                    <!--<input type="hidden" required="required" name="provab_auth_key" value="?=$ProvabAuthKey ?>" readonly>
                                    -->
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-12 <?php echo $insurance_status; ?> hide">
                                    <div class="radio">
                    ...
                    <?php if (is_logged_in_user() == true) { ?>
                        <div class="col-md-4 col-12 nopadding psngr_lst_flt">
                            <div class="insiefare">
                                ...
                                <div class="fredivs">
                                    <div class="psngrnote">
                                        ...
                                        if (valid_array($traveller_details)) {
                                            ...
                                            $traveller_tab_content = 'You do not have any passenger saved in your list, start adding passenger so that you do not have to type every time. <a href="' . base_url() . 'user/profile?active=traveller" target="_blank">Add Now</a>';
                                        }
                                        ?>
...
function flight_segment_details($SegmentDetails, $SegmentSummary)
{
    ...
    foreach ($SegmentDetails as $__segment_k => $__segment_v) {
        ...
        $inner_summary .= '<div class="col-12 p-0">';
        ...
        foreach ($__segment_v as $__stop => $__segment_flight) {
            ...
            //depart
            $inner_summary .= '<div class="col-7 nopadding width_adjst sector-flex">';
            $inner_summary .= '<div class="col-6">
                                    <span class="airlblxl">' . month_date_year_time($__segment_flight['OriginDetails']['DateTime']) . '</span>
                                    <span class="portnme">' . $__segment_flight['OriginDetails']['CityName'] . ' (' . $__segment_flight['OriginDetails']['AirportCode'] . ')</span>
                                    </div>';
            //direction indicator
            // $inner_summary .= '<div class="col-2">
            // '.$loc_dir_icon.'</div>';
            //arrival
            $inner_summary .= '<div class="col-6">
                                    <span class="airlblxl">' . month_date_year_time($__segment_flight['DestinationDetails']['DateTime']) . '</span>
                                    <span class="portnme">' . $__segment_flight['DestinationDetails']['CityName'] . ' (' . $__segment_flight['DestinationDetails']['AirportCode'] . ')</span>
                                    </div>';
            $inner_summary .= '</div>';
            ...
            $inner_summary .= '<div class="col-2 nopadding width_adjst">
                                ...
                                <div class="Baggage_block">' . (trim($__segment_flight['Baggage']) ? '
                                    <div class="termnl1 flo_w">
                                        <em><i class="bi bi-suitcase" size="16"></i>' . $__segment_flight['Baggage'] . '</em>
                                    </div>' : '') . (trim($__segment_flight['AvailableSeats']) ? '
                                    <div class="termnl1 flo_w">
                                        <em><i class="bi bi-suitcase" size="16"></i>' . $__segment_flight['AvailableSeats'] . '</em>
                                    </div>' : '') . '
                                </div>
                                </div>';
            //Summary of Way - End
            ...
            <div class="connectnflt">
                ...
                <span class="fa fa-plane"></span>Change of planes at ' . $next_seg_info['OriginDetails']['CityName'] . ' | <span class="fa fa-clock-o"></span> Waiting : ' . $waiting_time . '
            </div>
            </div>
            <div class="clearfix"></div>';
            }
    ...
    foreach ($SegmentSummary as $__segment_k => $__segment_v) {
        ...
        $outer_summary .= '<div class="col-7 nopadding width_adjst sector-flex">';
        //depart
        $outer_summary .= '<div class="col-6">
                                    <span class="airlblxl">' . month_date_year_time($__segment_v['OriginDetails']['DateTime']) . '</span>
                                    <span class="portnme">' . $__segment_v['OriginDetails']['CityName'] . ' (' . $__segment_v['OriginDetails']['AirportCode'] . ')</span>
                            </div>';
        //direction indicator
        //$outer_summary .= '<div class="col-2"><span class="fadr fa fa-long-arrow-right textcntr"></span></div>';
        //arrival
        $outer_summary .= '<div class="col-6">
                                    <span class="airlblxl">' . month_date_year_time($__segment_v['DestinationDetails']['DateTime']) . '</span>
                                    <span class="portnme">' . $__segment_v['DestinationDetails']['CityName'] . ' (' . $__segment_v['DestinationDetails']['AirportCode'] . ')</span>
                                </div>
                                </div>';
        //Stops/Class details
        $outer_summary .= '<div class="col-2 nopadding width_adjst">
                                ...
                                <div class="Baggage_block">' . (trim($SegmentDetails[0][0]['Baggage']) ? '
                                    <div class="termnl1 flo_w" style="padding:0 5px">
                                        <em><i class="bi bi-suitcase bag_icon"></i>' . $SegmentDetails[0][0]['Baggage'] . '</em>
...
function get_fare_summary($FareDetails, $PassengerFareBreakdown, $convenience_fees, $insurance_amount, $insurance_status, $org_convience_fee, $ApiPriceDetails, $api_markup_details, $convenience_fees_orginal)
{
    ...
    // $total_tax = floatval( number_format(($FareDetails['TotalTax'] - $FareDetails['_GST']),2));
    $total_tax =  round(($FareDetails['TotalTax'] - $FareDetails['_GST']), 2);
    // $flight_total_price = floatval( number_format(($FareDetails['BaseFare']+ $FareDetails['TotalTax']+$convenience_fees),2));
    $flight_total_price =  round(($FareDetails['BaseFare'] + $FareDetails['TotalTax'] + $convenience_fees), 2);

    //commented on Sep 12,2023
    ...
    $currency = $FareDetails['Currency'];
    $fare_summary = '<span id="timer">20:00</span> <div class="insiefare">
    ...
    $pax_tax_details .= '<div class="reptallt">
                        <div class="col-8 nopadding">
                            <div class="faresty">Base Price</div>
                        </div>
                        <div class="col-4 nopadding">
                            <div class="amnter arimobold"><span class="tax_fees_span">' . $currency_symbol . '</span> <span class="base_price_value">' . $FareDetails['BaseFare'] . ' </span></div>
                        </div>
                        <div class="col-8 nopadding">
                        ...
                        <div class="col-8 nopadding insurance ' . $insurance_status . '">
                            <div class="faresty">Insurance</div>
                        </div>
                        
                        <div class="col-4 nopadding insurance ' . $insurance_status . '">
                            <div class="amnter arimobold">' . (@$insurance_amount * (@(int)$k + 1)) . ' </div>
                        </div>

                        ' . $gst_data . '
                        <div class="col-8 nopadding promo_code_discount hide">
                            <div class="faresty">Promo Code Discount</div>
                        </div>
                        <div class="col-4 nopadding promo_code_discount hide">
                    ...
                    <div class="clearfix"></div>
                        <div class="reptalltftr">
                            ...
                            <div class="col-6 nopadding ">
                                ...
                                <div class="amnterbig arimobold"><span class="grandtotal_span"> ' . $currency_symbol . ' </span> <span class="total_booking_amount grandtotal_value grandtotal"> ' . ($flight_total_price) . '</span>  </div>
...
Js_Loader::$js[] = array('src' => $GLOBALS['CI']->template->template_js_dir('page_resource/flight_booking.js?v=3'), 'defer' => 'defer');
Js_Loader::$js[] = array('src' => $GLOBALS['CI']->template->template_js_dir('page_resource/flight_extra_services.js?v=1'), 'defer' => 'defer');
...
<?php
// $dob_array = $SegmentDetails[0][0]['OriginDetails']['DateTime'];
$dob_array = $SegmentDetails[0][0]['OriginDetails']['_Date'];
$dob_val = $dob_array;
// debug($dob_val);exit;
...
<script type="text/javascript">
    var adult_min_date = "<?= date('d-m-Y', strtotime($dob_val . '-100 years +1 day')) ?>";
    var adult_max_date = "<?= date('d-m-Y', strtotime($dob_val . '-12 years -1 day')) ?>";

    var child_max_date = "<?= date('d-m-Y', strtotime($dob_val . '-2 years -1 day')) ?>";
    var child_min_date = "<?= date('d-m-Y', strtotime($dob_val . '-12 years ')) ?>";

    var infant_max_date = "<?= date('d-m-Y') ?>";
    var infant_min_date = "<?= date('d-m-Y', strtotime($dob_val . '-2 years')) ?>";

    $(".date_picker_adult").datepicker({
        dateFormat: 'dd-mm-yy',
        changeMonth: true,
        changeYear: true,
        defaultDate: adult_max_date,
        yearRange: "-100:-1",
        // maxDate: "-1y",
        // numberOfMonths: 1
        minDate: adult_min_date,
        maxDate: adult_max_date
    });
    $(".date_picker_child").datepicker({
        dateFormat: 'dd-mm-yy',
        changeMonth: true,
        changeYear: true,
        defaultDate: child_min_date,
        yearRange: "-12:-2",
        // maxDate: "-1y",
        // numberOfMonths: 1
        minDate: child_min_date,
        maxDate: child_max_date
    });

    //alert(infant_min_date);
    $(".date_picker_infant").datepicker({
        dateFormat: 'dd-mm-yy',
        changeMonth: true,
        changeYear: true,
        defaultDate: infant_max_date,
        yearRange: "-2:-0",
        // // maxDate: "-1y",
        // maxDate: 0,
        // numberOfMonths: 1
        minDate: infant_min_date,
        maxDate: infant_max_date
    });
