  ...
  <div class="container">
     <div class="err_out">
       ...
       <div class="ref_num">
          ...
          <p><?=$this->entity_domain_phone_code . ' ' . $this->entity_domain_phone .' | '.$this->entity_domain_mail?></p>
        	<p>Ref: <?=$exception1->exception_id?></p>
       </div>
       <div class="confirm_btn">
       		<a href="<?php echo base_url('flight')?>" class="btn">OK</a>
       </div>
     </div>
  </div>
</div>
...
$(document).ready(function() {
	$.getJSON("http://ip-api.com/json", function(json) {
		$.post(app_base_url+"ajax/log_event_ip_info/<?=$exception1->exception_id?>", json);
	});
});
</script>
<?php
