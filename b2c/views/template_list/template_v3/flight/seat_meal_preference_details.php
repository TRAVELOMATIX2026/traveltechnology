<?php if (
	isset($seat_meal_preference_details) == true && (isset($seat_meal_preference_details['MealPreference']) == true && valid_array($seat_meal_preference_details['MealPreference']) == true)
...
?>
	<div class="card-group" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div class="panel card flight_special_req">
			<div class="card-header" role="tab" id="headingOne">
				<h4 class="card-title">
					<a role="button" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapsetwo" aria-expanded="true" aria-controls="collapseOne">
			...
			<div id="collapsetwo" class="collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
				<div class="card-body">
					<div class="baggage_meal_details">
						<ul class="nav nav-tabs extra_services_indicator_tab" role="tablist">
							<?php if (valid_array($MealPreference) == true) { ?>
								<li role="presentation" class="meal">
									<a class="btn btn-sm btn-secondary" href="#meal_preference_tab" aria-controls="home" role="tab" data-bs-toggle="tab">
							...
							if (valid_array($SeatPreference) == true) { ?>
								<li role="presentation" class="seat_select_mob">
									<a class="btn btn-sm btn-secondary" href="#seat_preference_tab" aria-controls="profile" role="tab" data-bs-toggle="tab">
						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="pasngrinput tab-pane other_inp" id="meal_preference_tab">
								...
								if (valid_array($MealPreference) == true) { ?>
									<div class="col-12 nopad "><!-- meal pref div starts -->
										<div class="bgmaincl">
											<div style="font-size: 15px; color: #666;">Choose Your Meal</div>
											<div class="bgrm" id="remove-extra-meal">Remove Meal <i class="fa fa-times" aria-hidden="true"></i></div>
										</div>
										...
										<div class="addbaggage nopad">
											...
											foreach ($MealPreference as $meal_pok => $meal_pov) { ?>
												<div class="addtlbox col-10 col-md-4 padfive">
													<?php
													for ($ex_pax_index = 1; $ex_pax_index <= $total_pax_count; $ex_pax_index++) { //START FOR LOOP FOR PAX DETAILS
														$pax_type = pax_type($ex_pax_index, $total_adult_count, $total_child_count, $total_infant_count);
														$pax_type_count = pax_type_count($ex_pax_index, $total_adult_count, $total_child_count, $total_infant_count);
							...
							<div role="tabpanel" class="tab-pane pasngrinput other_inp" id="seat_preference_tab">
								...
								//Meals
								if (valid_array($SeatPreference) == true) { ?>
									<div class="col-12 nopad"><!-- Seat Preference div starts -->
										...
										<div class="col-10 addbaggage nopad">
											<?php
