...
Js_Loader::$css[] = array('href' => $GLOBALS['CI']->template->template_css_dir('page_resource/transfer-result.css'), 'media' => 'screen');
     ...
     Sightseeing Type
        ...
        <div id="accordion" class="card-group category-list">
                ...
                <div id="demo" class="collapse collapse in">
                                ...
                                <div class="septor"></div>
                                <div class="rangebox hide" id="suitecase_div">
    ...
    <div id="empty-search-result" class="empty-search-page-container" style="display:none">
        <div class="empty-search-page-content">
            ...
            <div class="empty-search-page-title">
                <i class="fas fa-shuttle-van"></i> Oops!
            </div>
            <div class="empty-search-page-message">
                <p class="main-message">No Transfer places were found in this location today.</p>
                <p class="sub-message">
