                    ...
                    <div class="m-media">
                        <div class="m-media__container">
                            <div class="m-media__headline">
                                <div class="col-3 nopad listimage full_mobile">
                                ...
                                <div class="col-9 nopad listfull full_mobile">
...
$(document).ready(function(){
	// Open activity filter panel (mobile FAB)
	...
	function updateFilterCount() {
		var count = ($('.time-category:checked').length || 0);
		if (count > 0) {
	...
	$(document).on('change', '.time-category', function() {
		updateFilterCount();
	});
