...
<div class="bgcolor">
	...
	<div class="row top20">
		...
		<div class="col-sm-6">
			<h5 class="float-end m0 font13"><span class="colorgray">Booking ID :</span> <span class="bold"><?php echo $proapp_booking_id;?></span></h5>
			<div class="clear-fix"></div>
			<h5 class="float-end mb0 mt5 colorgray font12">Booking Date : <?php echo $booking_made_on;?> Hrs</h5>
			
				<div class="col-md-6 float-end pad0">
...
function hotel_menu($booking_details,$customer_email){
	...
	$action ='<div class="col-md-2 float-end pad0">
			<div class="dropdown" id="dLabel1" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<a href="">Actions</a>
