...
$hotel_total_price = $this->hotel_lib->total_price($pre_booking_params['markup_price_summary']);

/********************************* Convenience Fees *********************************/

$subtotal = $hotel_total_price;
$pre_booking_params['convenience_fees'] = $convenience_fees;
$hotel_total_price = $hotel_total_price-$pre_booking_params['markup_price_summary']['_GST'];
/********************************* Convenience Fees *********************************/
...
<div class="alldownsectn pt-4">
  ...
  <div class="ovrgo">
	...
	<div class="col-4 nopadding rit_summery">
		...
		<div class="col-12 col-md-8 toprom nopad m-0">
		  <div class="col-12 nopad full_room_buk">
			<div class="bookcol">
			  <div class="hotelistrowhtl">
				<div class="col-md-4 col-4 nopad xcel">
				...
				<div class="col-md-12 col-12 padall10 xcel">
	  ...
	  <div class="fligthsdets">
		<div class="flitab1">
		  ...
		  <div class="col-4 nopad full_room_buk hide">
			<div class="sckint">
			  <div class="ffty">
				<div class="borddo brdrit"> <span class="lblbk_book">
				<span class="fa fa-calendar"></span>
