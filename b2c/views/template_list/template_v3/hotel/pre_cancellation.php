...
<div class="search-result">
	...
	<div class="bakrd_color">
		...
		<div class="cancellation_page hotl_cancl_page">
			<div class="head_can">
			...
			<div class="clearfix"></div>
			<div class="cancel_bkd pre_cncl_htl">
			...
			<div class="col-6 nopad">
			 ...
			 <div class="col-6 nopad">   
				<div class="btn_continue">
				<button data-bs-toggle="modal" data-bs-target="#confirm_cancel" class="b-btn bookallbtn" type="button">Confirm</button>
				</div>
			 </div>
			</div>
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		...
		<a href="<?=base_url().'hotel/cancel_booking/'.$app_reference.'/'.$booking_source?>" class="btn btn-danger">Yes</a>
	  </div>
	</div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
