...
<div class="content-wrapper dashboard_section">
	...
	<div class="staffareadash">
		<?php if(($print_voucher!='yes')){ echo $GLOBALS['CI']->template->isolated_view('share/profile_navigator_tab'); } ?>

<div class="bakrd_color">
				<div class="cetrel_all">
					<?php if($print_voucher!='yes'){ echo $GLOBALS['CI']->template->isolated_view('share/navigation'); } ?>
				</div>   
									...
									<div class="bookrow">
										...
										<div class="remful">
											...
											<div class="xlbook col-3 bordbor">
												<div class="sideprice">
													<?=$currency?> <?=$grand_total-($net_commission+ceil($net_commission_tds))?>
												</div>
...
{
	$action_tab  = '';
	$ticket_details = '<a href="'.base_url().'index.php/voucher/flight/'.$app_reference.'/'.$booking_source.'" target="_blank" class="viwedetsb">View</a>';
	$ticket_pdf = '<a href="'.base_url().'index.php/voucher/flight/'.$app_reference.'/'.$booking_source.'/'.$status.'/show_pdf" target="_blank" class="viwedetsb">pdf</a>';
