...
{
	$action_tab  = '';
	$ticket_details = '<a href="'.base_url().'index.php/voucher/car/'.$app_reference.'/'.$booking_source.'" target="_blank" class="viwedetsb">View</a>';
	$ticket_pdf = '<a href="'.base_url().'index.php/voucher/car/'.$app_reference.'/'.$booking_source.'/'.$status.'/show_pdf" target="_blank" class="viwedetsb">pdf</a>';
