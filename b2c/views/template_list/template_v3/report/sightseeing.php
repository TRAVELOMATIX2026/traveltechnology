								...
								<div class="full_bkingg">
									<div class="bookrow">
										...
										<div class="remful">
											...
											<?php 
												$booking_amount = roundoff_number($parent_v['product_total_price']+ $parent_v['convinence_amount']-$parent_v['discount']+$parent_v['gst']);
...
{
	$action_tab  = '';
	$ticket_details = '<a href="'.base_url().'index.php/voucher/sightseeing/'.$app_reference.'/'.$booking_source.'" target="_blank" class="viwedetsb">View</a>';
	$ticket_pdf = '<a href="'.base_url().'index.php/voucher/sightseeing/'.$app_reference.'/'.$booking_source.'/'.$status.'/show_pdf" target="_blank" class="viwedetsb">pdf</a>';
