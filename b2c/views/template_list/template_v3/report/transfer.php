									...
									<div class="bookrow">
										<div class="topbokro">
											<h4 class="bokrname">
															<span class="fa fa-taxi"></span>
																<?=$transfer_type?>, <?=$itinerary_details['from_location']?> - <?=$itinerary_details['to_location']?>
															</h4>
											<div class="pnrnum">
										...
										<div class="remful">
											<div class="xlbook col-sm-2 col-3 htlimage_xl">
												<div class="imghtlflt">
													<img src="<?=$itinerary_details['image']?>" alt="ProductImage" />
												</div>
											</div>
											<div class="xlbook col-sm col-9 htlimage_xl ">
												<div class="htlfltr">
													<h3 class="shtlname"><?=$transfer_type?> - <?=$vehicle_name?> - <?=$category_name?></h3>
...
{
	$action_tab  = '';
	$ticket_details = '<a href="'.base_url().'index.php/voucher/transfer/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">View</a>';
    $ticket_pdf = '<a href="'.base_url().'index.php/voucher/transfer/'.$app_reference.'/'.$booking_source.'/'.$status.'/show_pdf" target="_blank" class="viwedetsb">pdf</a>';
    $action_tab .= $ticket_details.$ticket_pdf;
	if($status == 'BOOKING_CONFIRMED') {
		$cancel_booking = '<a href="'.base_url().'index.php/transfer/pre_cancellation/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">Cancel</a>';
