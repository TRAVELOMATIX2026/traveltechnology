					...
					<div class="innd acttbosrch">
						...
						<div class="strrat">
							...
							<?php } ?>
							 ...
							 <?php } 
							 if(valid_array($product['Cat_Ids']))
							 {
							 	foreach($product['Cat_Ids'] as $cat_name){
							 ?>
							 <li><span class="adreshotle"><b><?=$cat_name;?></b></span></li>
						...
						<div class="adreshotle h-adr">
						 ...
						 <p><i class="bi bi-geo-alt"></i><?php echo $product['DestinationName']?></p>
						</div>
						<div class="clearfix"></div>
