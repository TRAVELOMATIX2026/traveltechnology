						...
						<div class="bookcol">
							<div class="hotelistrowhtl">
								...
								<div class="col-md-12 col-sm-8 col-8 padall10 xcel">
									...
									<div class="hotelhed1">Code: <?=$pre_booking_params['GradeCode']?></div>
									<?php if($pre_booking_params['GradeDescription']):?>
										<div class="hotelhed2" id="tourDescription"><?=$pre_booking_params['GradeDescription']?></div>
										<button type="button" class="read-more-btn" id="readMoreBtn" style="display:none;">
											...
											<div class="borddo brdrit">
												<span class="lblbk_book">
				  								...
				  								<div class="fuldate_book">
													<span class="bigdate_book"><?=$travel_date[0]?></span>
