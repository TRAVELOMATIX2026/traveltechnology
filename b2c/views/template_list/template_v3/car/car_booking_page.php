...
$total_estimate_amount = roundoff_number($car_details['TotalCharge']['EstimatedTotalAmount']);
$car_details['convenience_fees'] = $convenience_fees =$page_data['convenience_fees'];
$total_amount = $car_details['convenience_fees']+$total_estimate_amount;
$total_amount = roundoff_number($total_amount);
...
<div class="alldownsectn car_bkng_pge">
  <div class="container nopad">
    ...
    <div class="bktab1 xlbox <?=$review_tab_details_class?>">
      <div class="col-12 col-md-4 col-sm-12 nopadding_right frmbl rit_summery" id="sidebar">
              ...
              <span class="portnmeter">Business Hours</span>
               <div class="bokkpricesml p-0 d-flex">
                ...
                <?php if($cancellationPolicy['non_ref'] == false){ ?>
                  <span class="text-center non_ref"><a id="cancel_" class="cancel-policy-btn" data-bs-target="#roomCancelModal" data-bs-toggle="modal" data-cancel= '<?php echo $cancellationPolicy['policy_text']; ?>'>Cancellation Policy</a></span>
                <?php } else{ ?>
           ...
           <div class="insiefare mt-3">
              ...
              <div class="fredivs">
               ...
               <div class="reptalltftr">
                ...
                <div class="col-6 nopadding">
                 <div class="amnterbig arimobold"><span class="style_currency"><?=$currency_obj->get_currency_symbol($currency_obj->to_currency)?></span> <span class="discount_total"><?php echo $total_amount; ?></span></div>
                </div>
               </div>
              </div>
             </div>
      ...
      <div class="col-md-8 col-sm-12 nopad fulbuki">     
        <div class="madgrid">
          <div class="col-12 nopad">
                    ...
                    <div class="hoteldist">
                      ...
                      <div class="pick-wrapper">
                        <div class="pick cr_wdt">
                          <span><i class="material-icons">category</i> Vehicle Category:</span>
                          <h3><?=@$car_details['VehicleCategoryName'] ?></h3>                        
                        </div>

                        <div class="pick fuel-plcy" data-bs-toggle="modal" data-bs-target="#myModal">
                          <span class="fuel_icon"><i class="material-icons">local_gas_station</i> Fuel Information:<?=$fuel_policy_code?></span>
                          <h3>
                        ...
                        <div class="pick">
                          ...
                          <h3><?=@$car_details['VehClassSizeName'] ?></h3>
                        </div>
                      </div>
                      ...
                      <div class="middleCol">
                        <ul class="features">
                          <li class="person tooltipv">
                            <a data-original-title="Passengers" data-bs-toggle="tooltip">
                              <i class="material-icons">people</i>
                              <strong><?=@$car_details['PassengerQuantity'] ?></strong>
                            </a>
                          </li>
                          <li class="baggage tooltipv">
                            <a data-original-title="Bags" data-bs-toggle="tooltip">
                              <i class="material-icons">luggage</i>
                              <strong><?=@$car_details['BaggageQuantity'] ?></strong>
                            </a>
                          </li>
                          <li class="doors tooltipv dor">
                            <a data-original-title="Doors" data-bs-toggle="tooltip">
                              <i class="material-icons">directions_car</i>
                              <strong><?=@$car_details['DoorCount'] ?></strong>
                            </a>
                          </li>
                          <li class="hdng">Age Limit: <?php echo $car_details['RateRestrictions']['MinimumAge']; ?> years - <?php echo $car_details['RateRestrictions']['MaximumAge']; ?> years</li>
                        </ul>

                        <div class="pick">
                          <span><i class="material-icons">speed</i> Mileage Allowance:</span>
                          <h3><?=(@$car_details['PricedCoverages'][0]['Coverage']['@attributes']['CoverageType'] != '' )? 'Unlimited' : 'Limited' ; ?></h3>
                        </div>
                        
                        <div class="suplier_logo">
                          <img src="<?= $car_details['TPA_Extensions']['SupplierLogo'];?>" alt="Supplier Logo">
                        </div>
                      </div>
                    </div>
                  </div>
...
if($social1){
  ...
  echo $GLOBALS['CI']->facebook->login_button ();?>
      <?php } 
        ...
        if($social2){
        ?>
  <a class="logspecify tweetcolor"><i class="material-icons">alternate_email</i><div class="mensionsoc">Login with Twitter</div></a>
      <?php } 
