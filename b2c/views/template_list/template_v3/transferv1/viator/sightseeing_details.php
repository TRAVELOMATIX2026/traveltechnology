        ...
        <li><img src="<?php echo $GLOBALS['CI']->template->template_images('meet_up.svg'); ?>" alt="icon" /> Meet Up At Location</li>
            ...
            <form id="check_tourgrade" action="">
                ...
                <h5>Select date and participants:</h5>
                 ...
                 <div class="org_row">
                 <div class="col-12 col-sm-4 smpad">
                 <div class="outdate">
                  ...
                  ?>
                   <?php foreach($product_details['Product_AgeBands'] as $key=>$age_band):?> 
                        <div class="roomrow">
                          ...
                          <div class="celroe col-7"><i class="fal <?=$fa_class?>"></i> <?=$age_band['description']?>
                          ...
                          <div class="celroe col-5">
                            <div class="input-group countmore pax-count-wrapper <?=$age_band['description']?>_count_div">
                             ...
                             <span class="input-group">
                              <button type="button" class="btn btn-secondary activities-btn-number" data-type="minus" data-field="no_of_<?=$age_band['description']?>"> <span class="glyphicon glyphicon-minus"></span> 
                              </button>
                              </span>
                              ...
                              <span class="input-group">
                              <button type="button" class="btn btn-secondary activities-btn-number" data-type="plus" data-field="no_of_<?=$age_band['description']?>"> <span class="glyphicon glyphicon-plus"></span> </button>
                              </span> 
                            </div>
                          </div>
                        </div>
