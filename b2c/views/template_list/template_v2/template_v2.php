...
<body id="page-top">
	...
	<!-- header -->
	<header>
  <nav id="mainNav" class="navbar navbar-light main_nav navbar-fixed-top">
    <div class="container"> 
      <!-- Brand and toggle get grouped for better mobile display -->
      <div class="navbar-header">
        <button type="button" class="navbar-togglerrr collapsed" data-bs-toggle="collapse" data-bs-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<img src="<?php echo $GLOBALS['CI']->template->template_images('icons/'.($k).'-nav-icon.png'); ?>"	alt="<?php echo strtoupper($v)?> Icon"><?php echo ucfirst($v);?>
			...
			?>
			<li class="dropdown">
				<a href="#" class="dropdown-toggle page-scroll" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
				<?php
				...
				?>
					...
					<ul class="dropdown-menu">
							...
							<?php if (is_logged_in_user() == true) { ?>
								...
								<?php } else { ?>
									<li><a href="#" data-bs-toggle="modal" data-bs-target="#myModal_1" class="btn btn-t b-r-0 navbar-btn">Sign In/Sign Up</a></li>
								<?php } ?>
