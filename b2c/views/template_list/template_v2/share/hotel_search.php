...
<form name="hotel_search" id="hotel_search" autocomplete="off" action="<?php echo base_url().'index.php/general/pre_hotel_search' ?>">
	...
	<div class="col-lg-10 col-md-10 col-sm-10 col-12 nopad">
		<div class="col-md-6">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 nopad nmbrspnr-outer">
					...
					<div class="repeatedroom">
						<div class="childgroup" data-roomid="<?php echo $loop_room_index?>">
							<div class="col-md-12 nopad">
								<div class="col-md-2 col-12 mefullwdhtl nopad">
								...
								<div class="col-md-4 col-6 mefullwdhtl fiveh noPL">
								...
								<div class="col-md-4 col-6 mefullwdhtl fiveh noPL noPR">
					...
					//Start child age looping
							if (intval($current_room_child_count) > 0) {
								...
								for($temp_index=0; $temp_index<$current_room_child_count; $temp_index++) {
									...
									?>
									<div class="col-md-12">
										<div class="col-md-2 col-4 mefullwdhtl"></div>
										<div class="col-md-4 fiveh childAge cl_rt float-end childAge<?php echo ($temp_index+1)?>">
