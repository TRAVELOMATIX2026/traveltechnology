    ...
    <div class="banner_content">
      ...
      <div class="col-md-12 nopad search-engine">
        <ul class="nav nav-tabs col-md-6 nopad mar_auto">
          ...
          <li class="<?php echo set_default_active_tab(META_AIRLINE_COURSE, $default_active_tab)?>"><a data-bs-toggle="tab" href="#flight_tab">
          ...
          <li class="<?php echo set_default_active_tab(META_ACCOMODATION_COURSE, $default_active_tab)?>"><a data-bs-toggle="tab" href="#hotel_tab">
          ...
          <li  class="<?php echo set_default_active_tab(META_PACKAGE_COURSE, $default_active_tab)?>"><a data-bs-toggle="tab" href="#sight_tab">
          ...
          <li class="<?php echo set_default_active_tab(META_BUS_COURSE, $default_active_tab)?>"><a data-bs-toggle="tab" href="#bus_tab">
...
<section class="advc_section">
    ...
    --><div class="servc_boxes">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
            ...
            <h3>Why Chose Us</h3>
            <p>Get the best deals in flight specially to the Indian sub continent. With a strong hold in India, get the best fares for the flights within India as card card-body.</p>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
	...
	<div class="container">
        ...
        <div class="top_dest_box">
			<?php if (in_array(META_ACCOMODATION_COURSE, $active_domain_modules) AND valid_array($top_destination_hotel) == true) : //TOP DESTINATION
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-12 htd-wrap">
...
<section class="newltr_section">
	<div class="container">
    	<div class="col-lg-8 col-md-8 col-sm-7 col-12 nwsltr_outr">
        ...
        <div class="col-lg-4 col-md-4 col-sm-5 col-12 socialmedia_outr">
