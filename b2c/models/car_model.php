...

{
    ...
    function save_booking_details ( $domain_origin, $status, $app_reference, $booking_source, $currency, $phone_number, 
        ...
        $car_to_date, $pickup_time, $drop_time, $car_pickup_lcation, $car_drop_location, $car_drop_address, $car_pickup_address, $final_cancel_date, $transfer_type,$oneway_fee, $total_fare_markup, $total_fare_tax, $transaction_currency ){
        ...
        $data['alternate_number'] = $phone_number;
  ...
  function booking_count($condition=array(), $count=false, $offset=0, $limit=100000000000)
	...
	function booking_guest_user($app_reference, $booking_source, $booking_status){
        ...
        $bd_query = 'select * from car_booking_details AS BD WHERE BD.app_reference like '.$this->db->escape($app_reference).' or BD.booking_reference like '.$this->db->escape($app_reference);
