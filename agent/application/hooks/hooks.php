...
class application {
	...
	public $transfer_url;
	// public $active_user_previleges_url;
	...
	{
		$skip_validation_list = array('forgot_password', 'agentRegister', 'get_state_list', 'get_city_lists', 'check_otp', 'notifyResult');
		//SKIP LIST
	...
	function initialize_domain_previleges()
	{
		...
		if (! empty($user_id)) {
			...
			$this->CI->active_user_previleges = [];
			$active_user_previleges_url = [];
			...
			// debug($active_user_previleges_url);exit;
