...
define('CURRENT_DOMAIN_KEY', 'TMX2783081694775862'); // TMX2783081694775862 test //  // live 
define('DOMAIN_AUTH_ID', 'domain_auth_id');
define('DOMAIN_KEY', 'domain_key');
define('PHONE', 'phone');
define('EMAIL', 'email');
define('GENERAL_SOCIAL', 1);
define('PROJECT_NAME','TMX V2');
/*
 |--------------------------------------------------------------------------
 | Folder Names
 |--------------------------------------------------------------------------
