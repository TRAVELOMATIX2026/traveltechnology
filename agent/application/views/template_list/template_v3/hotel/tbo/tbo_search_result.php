				...
				<div class="celhtl width70">
					<div class="innd">
					    <div class="imptpldz">
							...
							<div class="adreshotle h-adr" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php echo $hd['HotelAddress']?>"><?php echo $hd['HotelAddress']?>
							</div>
							<div class="preclsdv">
				...
				<div class="celhtl width30">
					<div class="sidepricewrp">
						...
						<div class="priceflights">
							<!-- <strong>  </strong> -->
							<span class="h-p"><p><?php echo $currency_obj->get_currency_symbol($currency_obj->to_currency); ?> <?php echo roundoff_number($RoomPrice); ?></p><strike>$389</strike></span>
							<div class="prcstrtingt">+ 0 taxes & fees <p class="hotl_per_nyt">per night</p></div>
						</div>
						<form id="f-sub-<?=$hd_key?>" action="<?php echo base_url().'index.php/hotel/hotel_details/'.($search_id)?>">
