...
<div class="htl_dtls_cont htldetailspage">
	<div class="rowfstep">
	  <!-- slider -->
       ...
       <!-- slider end -->
	   <div class="col-md-4 col-sm-12 col-12 resmagfix">
						...
						<h3 class="mobile_view_header">Facilities</h3>
							...
							if (valid_array($sanitized_data['Attractions']) == true) {
								...
								foreach ($sanitized_data['Attractions'] as $ak => $av) {?>
									<div class="col-4 nopad"><div class="facltyid"><span class="glyphicon glyphicon-check" style="color:<?php echo $color_code?>"></span> <?php echo $av['Value']; ?></div></div>
								<?php
								}?>
								</div>
							<?php
