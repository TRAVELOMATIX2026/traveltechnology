	...
	<div class="col-12">
		<div class="ovrgo">
			<div class="bktab1 xlbox <?=$review_tab_details_class?>">
				<div class="toprom">
					<div class="col-8 nopad full_room_buk">
						<div class="bookcol">
							<div class="hotelistrowhtl">
								<div class="col-md-4 nopad xcel">
									 <div class="imagehotel">
								  		<?php if(!empty($pre_booking_params['HotelImage'])){?>
								  		<img alt="<?=$pre_booking_params['HotelName']?>" src="http://photos.hotelbeds.com/giata/original/<?php echo $pre_booking_params['HotelImage']?>">
								  	<?php }else{?>
				...
				<div class="clearfix"></div>
				<div class="col-8 nopadding full_log_tab">
				...
				<div class="col-12 topalldesc">
					<div class="col-12 nopad">
						<div class="bookcol">
							...
							<div class="totlbkamnt"> Total Amount <?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <span id="total_booking_amount"><?php echo round($hotel_total_price,2); ?></span></div>
							...
							<form action="<?=base_url().'index.php/hotel/pre_booking/'.$search_data['search_id']?>" method="POST" autocomplete="off">
								...
								<div class="flitab1">
									...
									<div class="contbk">
										...
										<div class="col-12 nopad full_smal_forty">
										<div class="col-12 nopad full_smal_forty">
											...
											<div class="emailperson col-12 nopad full_smal_forty">
                                    ...
                                    <div class="panel card for_gst flight_special_req">
                                        ...
                                        <div class="card-header" role="tab" id="payment_opt">

                                            <h4 class="card-title">

                                                <a role="button" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#payment_optnl" aria-expanded="true" aria-controls="payment_optnl">

                                                    

                                                    <div class="labltowr arimobold"> Payment Method <i class="more-less glyphicon glyphicon-minus"></i></div>
                                        ...
                                        <div id="payment_optnl" class="collapse collapse in" role="tabpanel" aria-labelledby="payment_opt">
                                            <div class="col-12 gst_det payment_options">
                                                <label class="btn btn-info rounded mr-1 active" id="agent_pay_opt1" >
                                                    <input type="radio" name="agent_payment_option" id="option1" autocomplete="off" checked value="wallet"> Wallet Payment
                                                </label>
                                                <label class="btn btn-info rounded mr-1" id="agent_pay_opt2">
                                                    <input type="radio" name="agent_payment_option" id="option2" autocomplete="off" value="online"> Online Payment
                                                </label>
                                            </div>
                                        </div>
                                    </div>
		   ...
		   <div id="slidebarscr">
		 	<table class="table table-sm tblemd">
			 	<tbody>
			      ...
			      <tr>
			        <th>Your Service Fee</th>
			        <td><input type="number" class="form-control" name="agent_service_fee" id="agent_service_fee" onchange="addServicefee()" value="0"></td>
			      </tr>
			      ...
			      <tr class="grd_tol">
			        <th>Grand Total</th>
			        <td><?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <span class="grand_total_amount"> <?=($hotel_total_price)?> </span></td>
			      </tr>
			    </tbody>
			  </table>
		   </div>
		   <div class="clearfix"></div>
			<div class="promocode payment_link">
				<div class="col-12 nopad">
					<div class="mailsign">Send payment link</div>
					<div class="resmsg"></div>
				</div>
				<div class="col-12 nopad">
					<div class="tablesign">
						<div class="inputsign">
							<input type="text" placeholder="Enter Email" class="newslterinput nputbrd">
						</div>
						<div class="submitsign">
							<button class="promobtn">Send</button>
						</div>
					</div>
				</div>
				<div class="col-12 nopad">
					<div class="payment_copy_sec">
						<div class="payment_text">Payment Link: <span class="paymentlink"></span></div>
						<a title="Copy to clipboard" class="copyclipboard"><i class="far fa-copy"></i></a>
					</div>
				</div>
			</div>
			<div class="clearfix"></div>
			<div class="generate_pymnt_wrapper">
				<button class="genrte_paymnt_link">Generate Payment Link</button>
			</div>
		  </div>
	    	...
	    	foreach($token as $token_k => $token_v) {
			    ...
			    $room_price_details .= '<li class="baseli secf">
			              ...
			              $room_price_details .= '</div>
			                                        ...
			                                        <li class="wid20"><span class="res_op">Extras</span><a href="#"class="" data-bs-toggle="tooltip" data-placement="top" title="'.array_shift($CancellationPolicy).'">Cancellation Policy</a></li>
...
<script type="text/javascript">
	...
	$(".genrte_paymnt_link").on("click",function(){
		$(".paymentlink").html('');
		var amount = $('#total_booking_amount').text();
		$.ajax({
			url:"<?php echo base_url()?>"+'index.php/ajax/generatePaymentLink',	
			type: "POST",  // Specify POST method
			data:{ amount:amount },
			success:function(res){	
				if(res.invoice_url){
					$(".paymentlink").html(res.invoice_url);
					$(".resmsg").text('Payment link generated successfull');
					$(".genrte_paymnt_link").hide();
				}else{
					$(".resmsg").text('Payment link generation failed');
				}		
			},
			error:function(res){
				console.log(res);
	...
	$(".copyclipboard").on("click", function() {
		...
		var textToCopy = $(".paymentlink").text();
