...
?>
   ...
   <table class="table" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; margin:0px auto;background-color:#fff;">
      <tbody>
         <tr>
                                       ...
                                       <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                          <tbody>
                                             <tr style="background: #008100;color:#fff;">
                                                <td style="padding: 0px;"><img style="width:170px;" src="<?= BASE_PATH . $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo()) ?>"></td>
                                                <td style="padding: 0px;">
                                          ...
                                          <tbody>
                                             <tr>
                                                <td style="padding:10px 0">
                                                  ...
                                                  <?php else: ?>
                                                    <img style="width:160px;height:107px;" src="<?= BASE_PATH . SYSTEM_IMAGE_DIR . 'no_image_available.jpg' ?>">
                                                  <?php endif;?>
                                                </td>
                                                ...
                                                <span style="display: block;line-height:22px;font-size: 13px;">
                                                   <img style="width:70px;" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>"></span>
                                                   <?php } ?>
                                                </td>
                ...
                ?>
                                 ...
                                 <tr>
                                    <td colspan="4" align="right" style="padding:0px;">
                                       <span style="font-size:12px;">Powered by: </span> <span style="display:inline-block;"> <img style="width:90px;" src="<?= BASE_PATH . SYSTEM_IMAGE_DIR . 'starlegend_logo.png' ?>" /> </span>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
