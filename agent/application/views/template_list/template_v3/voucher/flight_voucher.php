...
$rounding_amount = isset($booking_details['booking_transaction_details'][0]['rounding_amount']) ? ($booking_details['booking_transaction_details'][0]['rounding_amount']) : 0;
?>
<style type="text/css">
    td,
    th {
...
<div style="background:#ccc; width:100%; position:relative;padding: 50px;">
    <!-- <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin: 10px auto;background-color:#fff; border-collapse:separate; color: #000;">
        <tbody>
            <tr>
                <td class="text-center" style="background: <?=($receipt_type == 'no_price') ? '#f18604' : '#808080' ;?>;border: 2px solid #fff"> <a href="<?=base_url();?>voucher/flight/<?= @$booking_details['app_reference'] ?>/<?= @$booking_details['booking_source'] ?>/<?= @$booking_transaction_details[0] ['status'] ?>/show_voucher/no_price" target="_blank" style="font-size: 16px;font-weight: bold;color: white;"> No Price Included </a> </td>
                <td class="text-center" style="background: <?=($receipt_type == 'agent_receipt') ? '#f18604' : '#808080' ;?>;border: 2px solid #fff"><a href="<?=base_url();?>voucher/flight/<?= @$booking_details['app_reference'] ?>/<?= @$booking_details['booking_source'] ?>/<?= @$booking_transaction_details[0] ['status'] ?>/show_voucher/agent_receipt" target="_blank" style="font-size: 16px;font-weight: bold;color: white;"> Agent Receipt </a> </td>
            </tr>
        </tbody>
    </table> -->
<div style="background:#ccc; width:100%; position:relative" id="tickect_flightonword">
    <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
        <tbody>
            <tr>
                <td colspan="2"><img style="width:170px;" src="<?= BASE_PATH .$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo()) ?>" /></td>
                <td colspan="2" style="padding:10px 10px 0px" align="right"><span>Booking ID : <?= @$booking_details['app_reference'] ?></span><br><span>Booked on : <?= app_friendly_absolute_date(@$booking_details['booked_date']) ?></span></td>
            </tr>
            <tr>
...
?></strong></td>
                ...
                <tr>
                    <td colspan="4" style="font-size: 18px;font-weight: 600;text-align: center;padding: 10px 0 0;">E-Ticket <?php echo $Onward; ?></td>
                        ...
                        <?php } ?>
            <tr>
                <td style="padding:10px 0;width:5%;"><img style="width:60px;" src="<?= BASE_PATH .SYSTEM_IMAGE_DIR . 'airline_logo/' . $itinerary_details[0]['airline_code'] . '.svg' ?>" /></td>
                <td style="padding:10px 20; line-height:25px;width:35%"><span style="display: block;border-right: 1px solid #999;"><span style="font-size:14px;"><?= @$itinerary_details[0]['airline_name'] ?></span><br><?php echo $airline_number ?></span></td>
...
<?php if ((!empty($gds_pnr)) || (!empty($airline_pnr))) { ?>
    ...
    <?php if ($booking_transaction_details[0] ['status'] == 'BOOKING_CONFIRMED') { ?>
                                ...
                                <span style="font-size:18px;line-height:35px;padding-bottom: 5px;font-weight: 600;"><?= @$airline_pnr ?></span>
                        </span>
                    <?php } ?>
    ...
    foreach ($itinerary_details as $segment_details_k => $segment_details_v) {
        ...
        if (in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')) {
            ...
            ?>
                                    ...
                                    $BaggageSegment_checkin = $BaggageSegment_cabin =  '';
                                    ...
                                    if (valid_array($segment_details_v) == true) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="display:block;border-left: 1px solid #808080; padding-left:10%">
                                    ...
                                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #808080;">
                                        <tbody>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td><span>Taxes &amp; Fees</span></td>
                                                    <td><span> <?php echo number_format(($Tax + $booking_details['admin_markup'] + $booking_details['agent_markup'] + ($booking_details['convinence_amount']+$booking_details['agentServicefee'])), 2) ?></span></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if ($GST > 0) { ?>
                                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border-top:1px solid #808080"><span style="font-size:13px"> <?= number_format(@$booking_details['grand_total'] + $seat_price + $meal_price + $baggage_price + $booking_details['agentServicefee'], 2) ?></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                <?php } else { ?>
                                    ...
                                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #808080;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="border-top:1px solid #808080"><span style="font-size:13px;font-weight: bold;">Grand Total</span></td>
                                                <td style="border-top:1px solid #808080"><span style="font-size:13px;font-weight: bold;"> <?= number_format(@$booking_details['grand_total'] + $seat_price + $meal_price + $baggage_price + $booking_details['agentServicefee'], 2) ?></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
...
<?php if (isset($booking_transaction_details_value['extra_service_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']) == true) { ?>
    ...
    if (isset($booking_transaction_details_value['extra_service_details']['meal_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['meal_details']) == true) {
        ...
        foreach ($meal_details['meal_source_destination_label'] as $meal_lk => $meal_lv) {
            ...
            <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
            <tr><td colspan="4" style="border-bottom:1px solid #808080;padding-bottom:15px"><span style="font-size:13px; color:#555;">Customer Contact Details | E-mail : <?= $booking_details['email'] ?> | Contact No :<?= $booking_details['phone_code'] ?> <?= $booking_details['phone'] ?></span></td></tr>
            <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
            <tr>
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;font-size: 14px;">
...
// debug($airline_contact_no);exit;
    ...
    ?></strong></td>
                ...
                <tr>
                    <td style="padding:10px 0"><img style="width:60px;" src="<?= BASE_PATH .SYSTEM_IMAGE_DIR . 'airline_logo/' . $return_segment_details[0]['airline_code'] . '.svg' ?>" /></td>
    ...
    <?php if ((!empty($return_gds_pnr)) || (!empty($return_airline_pnr))) { ?>
        ...
        <?php if ($booking_transaction_details[1] ['status'] == 'BOOKING_CONFIRMED') { ?>
                                    <span style="color:#808080;padding:5px; display:block">AIRLINE PNR</span>
            ...
            if (valid_array($segment_details_v) == true) {
                ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><span><strong><?= @$segment_details_v['from_airport_name'] ?>(<?= @$segment_details_v['from_airport_code'] ?>)</strong><br><?php echo date("D, d M Y", strtotime($segment_details_v['departure_datetime'])) . ", " . date("h:i A", strtotime($segment_details_v['departure_datetime'])); ?><br><?php echo $origin_terminal; ?></span></td>
                                                <td><span><strong><?= @$segment_details_v['to_airport_name'] ?>(<?= @$segment_details_v['to_airport_code'] ?>)</strong><br><?php echo date("D, d M Y", strtotime($segment_details_v['arrival_datetime'])) . ", " . date("h:i A", strtotime($segment_details_v['arrival_datetime'])); ?><br><?php echo $destination_terminal; ?></span></td>
                                                <td><span style="display:block;border-left: 1px solid #808080; padding-left:10%"><?php echo $non_stop; ?><br><?php echo $segment_details_v['total_duration']; ?><br><?php echo $segment_details_v['is_refundable'] ?></span></td>
                                            </tr>
                <?php
            }
        }
                                    ...
                                    <tr>
                                        <td style="padding:10px 0 0 0;vertical-align:top">
                                            <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #808080;font-size:12px; padding:0;">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="4" style="border-bottom:1px solid #808080"><span style="font-size:13px">Flight Extra Information</span></td>
                                                    </tr>
        <?php
        if (isset($booking_transaction_details_value['extra_service_details']['baggage_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['baggage_details']) == true) {
            $baggage_details = $booking_transaction_details_value['extra_service_details']['baggage_details'];
