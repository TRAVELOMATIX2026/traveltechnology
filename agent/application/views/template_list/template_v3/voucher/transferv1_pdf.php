          ...
          <!-- <tr>
            <td style="padding: 10px;">
              <table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;"> -->
                ...
                <tr><td style="line-height:2px;">&nbsp;</td></tr>
                <tr>
                  <td style="background-color:#008100;border: 1px solid #008100; color:#fff; font-size:9pt; padding:5px;"><img width="12" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:9pt;color:#fff;vertical-align:middle;"> &nbsp;Traveller(s) Details</span></td>
                </tr>
                <tr>
                  <td width="100%" style="border: 1px solid #008100;padding:0">
                    <table width="100%" cellpadding="5" style="padding: 0px;font-size: 9pt;">  
                ...
                <tr>
                  <td width="100%" style="padding:0">
                    <table width="100%" cellpadding="5" style="padding: 0;font-size: 9pt;">   
                      <tbody>
                        <tr>
                          <td width="100%" colspan="4" style="padding:0px;vertical-align:top;">
                            <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #008100;">
                              <tbody>
                                <tr>
                                  <td width="100%" colspan="4" style="border-bottom:1px solid #008100;padding:5px;background-color:#008100;color:#fff;"><span style="font-size:10pt">Payment Details</span></td>
                                  <td width="100%" colspan="4" style="border-bottom:1px solid #008100;padding:5px;background-color:#008100;color:#fff;"><span style="font-size:9pt">Amount (<?=$booking_details['currency']?>)</span></td>
                                </tr>
                                  <tr>
                                      <td width="100%" colspan="4" style="padding:5px"><span style="font-size:13px">Base Fare</span></td>
                                      <td width="100%" style="padding:5px"><span style="font-size:13px"><?php echo roundoff_number($booking_details['grand_total']-$booking_details['gst']); ?></span></td>
                                  </tr> 
                                  <?php if($booking_details['gst'] > 0){?>
                                  <tr>
                                      <td width="100%" colspan="4" style="border-top:1px solid #008100;padding:5px"><span style="font-size:13px">GST</span></td>
                                      <td width="100%" style="border-top:1px solid #008100;padding:5px"><span style="font-size:13px"><?php echo roundoff_number($booking_details['gst']); ?></span></td>
                                  </tr> 
                                  <?php } ?>  
                                    <tr>
                                      <td width="100%" colspan="4" style="border-top:1px solid #008100;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                      <td width="100%" colspan="4" style="border-top:1px solid #008100;padding:5px"><span style="font-size:13px"><?php echo roundoff_number($booking_details['grand_total']); ?></span></td>
                                  </tr>
                              </tbody>
                            </table>
                          </td>
                          <td width="100%" colspan="2" style="padding:0px 0px 0px 14px;vertical-align:top;">
                            <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:10pt; padding:0;">
                              <tbody>
                                <tr>
                                  <td width="100%" style="background-color:#008100;border-bottom:1px solid #008100;border-left:1px solid #008100;padding:5px; color:#fff"><span style="font-size:10pt">Activity Inclusions</span></td>
...
<div style="font-family: arial;">
  ...
  <tr>
    <td>
      <div style="font-size:9pt; color:#555;"><?php echo $data['terms_conditions']; ?></div></td>
  </tr>
  <tr><td style="line-height:2px;">&nbsp;</td></tr>
</div>
