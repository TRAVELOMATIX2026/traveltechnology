<?php
   ...
   <!-- <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin: 10px auto;background-color:#fff; border-collapse:separate; color: #000;">
      ...
      <table cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; margin:0px auto;background-color:#fff;">
         <tbody>
            <tr>
                     ...
                     <tr>
                        <td style="padding: 0px;">
                           <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                                 ...
                                 <td style="border-bottom:1px solid #ddd;">
                                    <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                       <tr style="background: #008100; color:#fff;">
                                          <td style="padding: 5px;"><img style="width:170px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())?>"></td>
                                          <!-- <td style="padding: 0px;">
                                          ...
                                          <td style="padding: 15px 10px 10px; float:right;line-height: 26px;">
                                             <span style="font-weight:600;"><img width="15px" style="margin-right:5px;filter: brightness(0) invert(1);" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('call_v.png'); ?>"> + <?= $this->entity_country_code?> <?=$this->entity_phone?></span><br>
                                             <span style="font-weight:600;"><img width="18px" style="margin-right:5px;filter: brightness(0) invert(1);" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('mail_v.png'); ?>"><?=$this->entity_email;?></span>
                                          </td>
                                       </tr>
                                    </table>
                                 </td>
                              ...
                              <tr>
                                 <td colspan="2">
                                    <img width="100%" style="border-radius:5px;" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('mail_banner_1.png'); ?>">
                                 </td>
                              </tr>
                              <tr><td style="line-height:12px;">&nbsp;</td></tr>                           
                              <tr>
                                       ...
                                       <tbody>
                                          <tr style="padding-bottom: 10px;border-bottom:1px dashed #ccc;">
                                             ...
                                             <?php 
                                                ...
                                                <td style="padding:0;width:30%;"><img style="width:200px; height:130px; object-fit:cover;" src="<?=BASE_PATH.$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" /></td>
                                             <?php };?>
                                             <td valign="top" style="padding:10px;width:70%;">
                                                ...
                                                <span style="display: block;line-height:22px;font-size: 13px;"><img style="width:70px;" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>" /></span>
                                             ...
                                             <table style="width: 80%;" align="right">
                                                <tr style="color:#616161;text-align: center;">
                                                   <td style="padding-top:8px;"><img width="20px" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('rooms_v.png'); ?>">
                                                      <p style="font-size:14px; margin:0;"><?php echo $booking_details['total_rooms']; ?> room</p>
                                                   </td>
                                                   <td style="padding-top:8px;"><img width="22px" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('adults_v.png'); ?>">
                                                      <p style="font-size:14px; margin:0;"><?php echo $booking_details['adult_count']; ?> Adult</p>
                                                   </td>
                                                   <td style="padding-top:8px;"><img width="15px" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('child_v.png'); ?>">
                       ...
                       <tr><td style="line-height:12px;">&nbsp;</td></tr>
                              ...
                              <tr>
                                 <td colspan="4" align="right" style="padding:5px 0px;">
                                       <span style="font-size:12px;">Powered by: </span> <span style="display:inline-block;"> <img style="width:90px;" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('starlegend_logo.png'); ?>" /> </span>
                                 </td>
                              </tr>
                           </table>
                        </td>
