		...
		<div class="col-12">
			<div class="contentsdw">
				<div class="smldescrptn">
					<div class="col-sm-8 col-10 nopad">
						...
						<?php if(@$sight_seen_search_params['from_date']):?>
							<div class="col-3 boxpad none_boil">
					...
					<div class="col-sm-4 col-2 nopad">
						
						<div class="col-4 boxpad float-end">
							<a class="modifysrch" data-bs-toggle="collapse" data-bs-target="#modify"><span class="mdyfydsktp">Modify Search</span><i class="fa fa-angle-down mobresdv" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
