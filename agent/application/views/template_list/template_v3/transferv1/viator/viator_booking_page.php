		  ...
		  <div class="col-12 nopad full_room_buk">
			<div class="bookcol">
			  <div class="hotelistrowhtl">
				<div class="col-md-4 col-12 nopad xcel">
...
<div class="clearfix"></div>
				...
				<div class="contbk">
					...
					<div class="hide">
					<input type="hidden" name="billing_country" value="91">
					...
					<div class="col-4 nopadding">
					<input value="<?=@$lead_pax_details['phone'] == 0 ? '' : @$lead_pax_details['phone'];?>" type="number" name="passenger_contact" id="passenger-contact" placeholder="Mobile Number" class="newslterinput nputbrd _numeric_only" maxlength="10" required="required">
					</div>
					<div class="clearfix"></div>
