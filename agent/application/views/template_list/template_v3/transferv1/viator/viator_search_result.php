			...
			<div class="sidenamedesc">
				...
				<div class="celhtl width30">
					<div class="sidepricewrp">					
                        ...
                        <a class="detailsflt iti-btn" data-bs-toggle="modal" data-bs-target="#sendmail_multi_<?=$product_key?>" data-backdrop="static"><span class="fal fa-envelope"></span> Send Mail</a>
   ...
   <div class="modal-dialog" style="margin: 200px auto;">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title mdltitl">Send Transfer Information</h4>
         </div>
         <div class="modal-body">
            <div class="form-group">
               <input type="email" class="form-control mfc" id="email_multi_<?=$product_key?>" placeholder="Enter Email ID" name="email" /><input type="hidden" class="form-control mfc" id="transferdetails_multi_<?=$product_key?>" placeholder="Enter email" name="email" value="<?= serialized_data($product)?>" /> <span id="errormsg_multi_<?=$product_key?>"></span> 
            ...
            <button type="button" id="send_email_btn_not_multi<?=$product_key?>" class="btn btn-secondary flteml" onclick="sendTranserdetails_multi(<?=$product_key?>)">Send</button> 
         </div>
      </div>
   </div>
</div>
