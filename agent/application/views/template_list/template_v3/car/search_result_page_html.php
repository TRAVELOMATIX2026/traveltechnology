	...
	<div id="page-parent">
		  ...
		  <div class="search-result car_search_results">
                               ...
                               <img src="images/car1.jpg">
                                 <ul class="features">                                      
                                   <li class="person tooltipv">
                                     <a data-original-title="Passengers" data-bs-toggle="tooltip"><strong>4</strong> <span class="mn-icon"></span></a>
                                   </li>
                                   <li class="person tooltipv">
                                     <a data-original-title="Passengers" data-bs-toggle="tooltip"><strong>4</strong> <span class="mn-icon"></span></a>
                                   </li> 
						...
						<div class="rowresult r-r-i" rel="sort0">          
                              ...
                              <div class="hoteldist"> 
                                    ...
                                    <div class="pick">    
                                       ...
                                       <h3> <a href="#" data-bs-toggle="tooltip" title="" data-original-title="Full to Full: Pick up and drop off with a full tank. If the car is not returned with a full tank, suppliers will charge fuel plus refueling charges. ">              
                                  ...
                                  <i class="fal fa-tachometer-alt"></i> <span>Mileage Allowance:</span>            
                                   ...
                                   <ul class="features">             
                                       <li class="person tooltipv">              
                                       <a title="" data-bs-toggle="tooltip" data-original-title="Passengers"><strong>5</strong> 
                                       <span class="mn-icon"></span>               
                                       </a>             
                                       </li> 
                                        <li class="baggage tooltipv">              
                                        <a title="" data-bs-toggle="tooltip" data-original-title="Bags"> <strong>3</strong> 
                                        <span class="mn-icon"></span>               
                                        </a>             
                                        </li> 

                                         <li class="doors tooltipv">              
                                         <a title="" data-bs-toggle="tooltip" data-original-title="Doors"> 
            ...
            <div class="width20 mobile_f_i">         
	            <div class="mrinfrmtn">          
	               ...
	               <a class="detailsflt" data-bs-toggle="collapse" data-bs-target="#car_rental0"> More <label>Details</label><span class="caret"></span> </a>        
	           </div>       
           </div>       
        </div>             
        ...
        <div class="middleCol">            
	        <ul class="features1">                                      
	             ...
	             <li class="fuel tooltipv" data-bs-toggle="tooltip" title="" data-original-title="Registration Fee"><i class="fa fa-plus"></i><strong> Registration Fee</strong></li>            
	        </ul>                                             
         </div>           
         ...
         <div class="tab-content"> 
              ...
              <div class="secn_pot"> 
                 ...
                 <li> <span class="fa fa-check"></span>VAT</li>                                         
                  ...
                  <button type="button" class="sumtab" data-bs-toggle="collapse" id="carnect0" data-bs-target="#agelmt00"><b>Registration Fee</b></button>
                       ...
                       <p style="padding-left: 28px;">Pay on pick-up in local currency:per day: 4.00 INR</p>                     
                                       ...
                                       <div class="carprc clearfix">           
	                                       <button type="button" class="sumtab" data-bs-toggle="collapse" id="carnect0" data-bs-target="#agelmt01">
                                       ...
                                       <div class="carprc clearfix">           
                                       <button type="button" class="sumtab" data-bs-toggle="collapse" id="carnect0" data-bs-target="#agelmt02">
                                       ...
                                       <div class="carprc clearfix">           
                                       <button type="button" class="sumtab" data-bs-toggle="collapse" id="carnect0" data-bs-target="#agelmt03">
