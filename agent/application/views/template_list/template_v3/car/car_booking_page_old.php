...
<li class="lostcart ">            
            ...
            <div class="col-12 nopad colrcelo">              
            ...
            <div class="date_loc">29 Apr 2018 09:00</div>               
             ...
             <tr>                        
              ...
              <td>Convenience Fee <a href="#" data-bs-toggle="tooltip" title="We retain our service fees as compensation in servicing your travel reservation"><i class="fa fa-info-circle" aria-hidden="true"></i></a></td>                  
              ...
              <td class="text-end" style="text-align: right;white-space: nowrap;">
              ...
              <div class="col-md-3 celcart"> 
               ...
               <div class="carttitlebuk1">                
	               <div class="col-6 nopad">Pick Up 
	                 <div class="cartsec_time">28 Apr 2018</div>                
	               </div>               

                  <div class="col-6 nopad">To 
                ...
                <span class="float-end hide"> INR <span class="total_extras">0</span></span></h3>             
                <div class="fare_show">              
                <div class="show_fares_table">               
                <table class="table table-striped">                
               ...
               <form name="promocode" id="promocode" novalidate="">                   
                ...
                <input type="text" placeholder="Enter Promo" name="code" id="code" class promocode" aria-required="true">                         
                 ...
                 <p class="error_promocode text-danger"></p>                     
                      ...
                      <a href="#" data-bs-toggle="tooltip" title="Full to Full: Pick up and drop off with a full tank. If the car is not returned with a full tank, suppliers will charge fuel plus refueling charges. ">                            
                      <i class="fa fa-info-circle" aria-hidden="true"></i> 
                            ...
                            <a data-original-title="Passengers" data-bs-toggle="tooltip"><strong>5</strong> <span class="mn-icon"></span> </a>
                            </li>          

                            <li class="baggage tooltipv">
                            <a data-original-title="Bags" data-bs-toggle="tooltip"><strong>2</strong> <span class="mn-icon"></span> </a>
                            </li>                          

                            <li class="doors tooltipv dor"><a data-original-title="Doors" data-bs-toggle="tooltip"><strong>2</strong> <span class="mn-icon"></span> 
                            </a></li>                          
							...
							<div class="clearfix"></div>
								...
								<div class="clearfix"></div>
											...
											<div class="col-md-8 col-sm-8 col-12 nopad fulbuki passenger-book-detail">        
...
<div class="col-md-1 col-2 downsrt set_margin nopad">                            
<div class="lokter"> 
...
<div class="col-md-11 col-12 nopad">                          
	<div class="col-sm-2 col-2 set_margin">                            
...
<div class="col-sm-4 col-4 set_margin">                           
...
<div class="col-sm-3 col-3 set_margin">                           
...
<div class="col-sm-6 col-6 set_margin">                     
<div class="paylabel">Email <strong class="text-danger no_block">* </strong></div>                     
...
<div class="sectionbuk billingnob">              
              ...
              <option value="CA">Canada</option>                        
                ...
                <fieldset id="city_holder">                      
                      ...
                      <div class="selectedwrap col-6 nopad">                      
         ...
         <div class="padleftpay">           
	           <div class="pre_summery1">   
	           <a class="chn_crncy" style="padding:15px 15px; display: block;" data-bs-toggle="modal" data-bs-target="#book_terms"> Booking Terms and Conditions</a>          
	           </div>          
         </div> 
         ...
         <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>            
	         ...
	         <div class="checkcontent" id="my_err_msg">          
			         ...
			         <label for="squaredThree1" class="lbllbl">By selecting to complete this booking I agree to pay the total amount shown, which includes Service Fees (if applicable), and I acknowledge that I have read and accept the <a class="colorbl" data-bs-toggle="modal" data-bs-target="#book_terms"> Booking Terms and Conditions</a> and 
			           <a class="colorbl" data-bs-toggle="modal" href="https://ziphop.com/privacy-policy" target="_blank">Privacy Policy</a>.</label>          
	          </div>         
          </div>         

	          <div class="payrowsubmt">          
		          <div class="col-md-4 col-8 fulat500 nopad">           
