...
.selection .select2-selection.select2-selection--single{    height: 46px !important; padding-top: 0px !important;}
.c-details{padding-top: 19px !important;}
</style>
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('provablib.js'); ?>"></script>
<div class="fldealsec">
  <div class="container">
  ...
  <div class="ovrgo">
                    ...
                    <div class="ontyp">
                        ...
                        <div class="allboxflt">
                            ...
                            <div class="col-7 nopadding">
                                ...
                                <div class="col-2"><span class="fadr fa fa-long-arrow-right textcntr"></span></div>
                                <div class="col-5">
                                    <span class="airlblxl">26 Jun, 08:30</span>
                                    <span class="portnme"> Mumbai (BOM) </span>
                                    <span class="portnmeter">Terminal</span>
                        	...
                        	<div class="insidechs">
                                ...
                                <div class="cntgust">
                                    <div class="phoneumber">
                                        <div class="col-2 nopadding"><input type="text" placeholder="+91" class="newslterinput nputbrd"></div>
                                        <div class="col-1 nopadding"><div class="sidepo">-</div></div>
                                        <div class="col-9 nopadding"><input type="text" placeholder="Mobile Number" class="newslterinput nputbrd"></div>
                                        <div class="clearfix"></div>
    ...
    <div class="bktab2 xlbox">
    	...
    	<div class="topalldesc">
        	<div class="col-8 nopadding celtbcel">
                ...
                <div class="ontyp">
                    ...
                    <div class="allboxflt">
                        ...
                        <div class="col-6 nopadding">
                            ...
                            <div class="col-4"><span class="fadr fa fa-long-arrow-right textcntr"></span></div>
                            <div class="col-4">
                                <span class="airlblxl">26 Jun, 08:30</span>
                                <span class="portnme"> Mumbai (BOM) </span>
                                <span class="portnmeter">Terminal</span>
    	...
    	<div class="col-8 nopadding">
        	...
        	<div class="fligthsdets">
                            ...
                            <div class="col-10 nopadding">
                            	<div class="inptalbox">
                                    ...
                                    <div class="col-6 spllty">
                                    	<div class="col-6 nopadding">
                                            <div class="lablmal">
                                                <label class="form-check form-check-inline radio-styled radio-success fivetop">
                                    ...
                                    <div class="col-6 spllty">
                                    	<div class="col-4 nopadding"><span class="fmlbl">Date of birth</span></div>
                                        <div class="col-8 nopadding">
                ...
                <div class="contbk">
                    ...
                    <div class="col-1 nopadding c-details"><input type="text" placeholder="+91" class="newslterinput nputbrd"></div>
                    <div class="col-1"><div class="sidepo">-</div></div>
                    <div class="col-6 nopadding"><input type="text" placeholder="Mobile Number" class="newslterinput nputbrd"></div>
                    <div class="clearfix"></div>
