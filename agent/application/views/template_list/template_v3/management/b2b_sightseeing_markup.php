...
<div class="bodyContent">
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
		...
		<div class="panel_bdy mb-3"><!-- PANEL BODY START -->
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0"><i class="fa fa-hotel"></i> Activities - Markup</h5>
				</div>
				<div class="card-body">
		...
		<div class="panel_bdy mb-3"><!-- PANEL BODY START -->
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0"><i class="fa fa-hotel"></i> Activities - Specific Domain Markup</h5>
				</div>
				<div class="card-body">
