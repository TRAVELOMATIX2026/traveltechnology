				...
				<div class="panel_bdy mb-3">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0"><i class="bi bi-bank"></i> Credit Limit Request Details</h5>
						</div>
						<div class="card-body">
							<?php
				...
				<div class="card-body">
					<form method="GET" autocomplete="off">
						...
						<div class="form-group mt-3">
							...
							<a href="<?php echo base_url(); ?>index.php/management/b2b_credit_limit" id="clear-filter" class="btn btn-sm btn-secondary"><i class="bi bi-x-circle"></i> Clear Filter</a>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="d-flex align-items-center gap-2">
						...
						<strong class="text-primary"><?php $balance = agent_current_application_balance(); echo agent_base_currency().' '.@$balance['value']?></strong>
					</div>
				</div>
			</div>
		</div>
