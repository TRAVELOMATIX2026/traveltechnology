	...
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
		...
		<div class="panel_bdy"><!-- PANEL BODY START -->
				...
				<div class="card-body">
                 ...
                 <!-- <div class="col-sm-6 col-md-3">
                  ...
                  <div class="form-group">
                   <label class="col-sm-3 form-label text-end">Request Type </label>
                     <div class="col-sm-6">                        
                        <div class="panel_selcts selctmark_dash">
                            <select id="balance_request_type" class="normalsel_dash" autocomplete="off">
                                <?php echo generate_options($provab_balance_requests, array($balance_request_type));?>
			...
			<form method="GET" autocomplete="off">
				...
				<button type="reset" class="btn btn-gradient-warning"><i class="fa fa-refresh"></i> Reset</button>
				</div>
			</form>
		</div>
...
{
	$pagination = '<div class="float-start">'.$GLOBALS['CI']->pagination->create_links().' <span class="">Total '.$total_rows.' Request found</span></div>';

	$table = '';
	$table .= '<div id="tableList" class="clearfix table-responsive">';
	$table .= $pagination;
	$table .='<div class="table-responsive col-md-12">
   <table class="table table-hover table-striped table-bordered table-sm" id="balance_request_table">';
      $table .= '<thead><tr>
   <th>Sno</th>
