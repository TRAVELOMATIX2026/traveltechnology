...
<form action="<?php echo base_url();?>index.php/general/pre_transferv1_search" autocomplete="off" id="holiday_search" class="activity_search">

  <div class="tabspl forhotelonly">

    <div class="tabrow">

      <div class="offset-md-0 col-md-12 col-sm-12 col-12 nopad">

        <div class="col-md-9 col-sm-12 col-12 padfive full_smal_tab mobile_width">
       ...
       <!--  <div class="sel-cate col-md-6 col-sm-6 col-6 padfive full_smal_tab">
      ...
      <div class="col-md-6 col-sm-6 col-12 nopad hide">

      

      

      <div class="col-md-6 col-sm-6 col-6 full_mobile resdvmg hide">
      ...
      <div class="col-md-3 col-sm-4 col-5 full_mobile padfive mobile_width last_border">
