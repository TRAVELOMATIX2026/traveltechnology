...
<style>
  ...
  <div class="tab_border">                  <!-- Nav tabs -->                  <div class="srch_flts">Search for <span>Flights</span></div>                  <ul class="nav nav-tabs tabstab">                                             <li class="active">                           <a href="#flight" role="tab" data-bs-toggle="tab">                              <span class=" iconcmn">                                 <i class="fal fa-plane"></i>                              </span><label>Flights</label>                           </a>                        </li>                        <li class="active">                           <a href="#hotel" role="tab" data-bs-toggle="tab">                              <span class=" iconcmn">                                 <i class="fal fa-building"></i>                              </span><label>Hotel</label>                           </a>                        </li>                         <li class="active">                           <a href="#flight" role="tab" data-bs-toggle="tab">                              <span class=" iconcmn">                                 <i class="fal fa-building"></i>                              </span><label>Flight + Hotel</label>                           </a>                        </li>                                                                                    <!-- <li class="deals"><a  target="_blank" href="special-fares-june2018.html"><span class="sprte iconcmn"><strong class="new_deal">New!</strong><i class="fal fa-tags"></i></span><label>Hot Deals!</label></a></li> -->                     
                                                               <!---->                     
                  </ul>               </div>
