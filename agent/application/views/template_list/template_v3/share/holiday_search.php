...
<!-- holiday packages -->
<?php
// Load holiday search form CSS
Js_Loader::$css[] = array('href' => $GLOBALS['CI']->template->template_css_dir('page_resource/holiday-search-form.css'), 'media' => 'screen');
?>
...
<div class="tabspl forhotelonly">
		<div class="tabrow">
			<div class="col-md-3 col-sm-3 col-6 padfive full_smal_tab">
				<div class="lablform">Country</div>
				<div class="selectedwrap sidebord">
					<i class="material-icons field-icon field-icon-right">public</i>
			...
			<div class="col-md-3 col-sm-3 col-6 padfive full_smal_tab">
				...
				<div class="selectedwrap sidebord">
					<i class="material-icons field-icon field-icon-right">card_travel</i>
			...
			<div class="col-md-2 col-sm-3 col-6 padfive full_smal_tab">
				<div class="lablform">Duration</div>
				<div class="selectedwrap sidebord">
					<i class="material-icons field-icon field-icon-right">schedule</i>
			...
			<div class="col-md-2 col-sm-3 col-6 padfive full_smal_tab last_border">
				<div class="lablform">Budget</div>
				<div class="selectedwrap sidebord">
					<i class="material-icons field-icon field-icon-right">attach_money</i>
			...
			<div class="col-md-2 col-sm-12 col-12 padfive full_smal_tab hldy_srch">
				<label class="lablform">&nbsp;</label>
				<div class="searchsbmtfot flightbutton holiday_searchBtn">
					<i class="fas fa-search"></i>
					<input type="submit" class="searchsbmt flight_search_btn" value="Search Holiday" />
				</div>
			</div>
