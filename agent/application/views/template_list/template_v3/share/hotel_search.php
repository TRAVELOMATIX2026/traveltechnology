...
// Load hotel search form CSS

Js_Loader::$css[] = array('href' => $GLOBALS['CI']->template->template_css_dir('page_resource/hotel-search-form.css'), 'media' => 'screen');
...
<form name="hotel_search" id="hotel_search" autocomplete="on" action="<?php echo base_url().'general/pre_hotel_search' ?>">
	...
	<div class="tabspl forhotelonly hotel-form modifySearchHotel">

		<div class="tabrow">

			<div class="col-lg-3 col-md-3 col-sm-6 col-5 bordrt padfive full_clear border_btms">

				<div id="citysearch" <?php echo $city_div_style; ?>>	

					<div class="lablform mobile_label">Going to</div>
					...
					<input class="hide hotel_loc_id_holder" name="hotel_destination_location" type="hidden" value="<?=@$hotel_search_params['hotel_destination_location']?>" >

					<div class="exportcomplete_hotel" id="exporthotel" style="display: none;"></div>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-7 nopad full_clear ">

				<div class="col-md-6 col-6 padfive bordrt border_btms">

					<div class="lablform mobile_label">Check-in</div>

					<div class="plcetogo datemark sidebord">

						<i class="material-icons field-icon field-icon-right">calendar_today</i>

						<input  type="text" class="form-control b-r-0 normalinput" data-date="true" readonly name="hotel_checkin" id="hotel_checkin"  placeholder="Check-In" required value="<?=(@$hotel_search_params['from_date'] != '') ? date('d-m-Y',strtotime(@$hotel_search_params['from_date'])):'';?>"/>

						

					</div>

					<div class="hotelToAppendPicker checkindate_append"></div>

				</div>

				<div class="col-md-6 col-6 padfive bordrt border_btms">

					<div class="lablform mobile_label">Check-out</div>
					...
					<div class="plcetogo datemark sidebord">
						...
						<input type="text"
					       ...
					       class="normalinput form-control b-r-0"
					       ...
					       value="<?= (@$hotel_search_params['to_date'] != '')

					            ? date('d-m-Y', strtotime(@$hotel_search_params['to_date'].' +1 day'))
					...
					<div class="hotelToAppendPicker checkoutdate_append"></div>

				</div>

			</div>

			<div class="col-md-4 col-sm-8 col-12 nopad">

				<div class="col-md-4 col-sm-6 col-6 padfive mobile_width bordrt">

					<div class="lablform mobile_label">No.of Nights</div>

					<div class="plcetogo nitmark selctmark hotel_mark sidebord ">

						<i class="material-icons field-icon field-icon-right">nights_stay</i>

						<select class="normalsel padselct arimo hotel_slct" id="no_of_nights">
				...
				<div class="col-md-8 col-sm-6 col-6 padfive mobile_width">

					

					<div class="totlall hotel_total">

					<div class="lablform mobile_label">Guests & Rooms</div>

						<i class="material-icons field-icon field-icon-left-hotel">people</i>
							...
							?>
								...
								<div class="mobile_adult_icon">Travellers<i class="fa fa-male"></i></div>
									...
									<div class="roomrow">
										...
										<div class="celroe col-4">

											<span class="d-flex align-items-center gap-2"><i size="24" class="material-icons">person</i> Adults</span>

											<span class="agemns">(12+)</span></div>

										<div class="celroe col-8">

											<div class="input-group countmore pax-count-wrapper">

												<span class="input-group">

													<button type="button" class="btn btn-secondary btn-number" data-type="minus" data-field="adult[]">
												...
												<span class="input-group">
													...
													<button type="button" class="btn btn-secondary btn-number" data-type="plus" data-field="adult[]">
									...
									<div class="roomrow">
										...
										<div class="celroe col-4">
											...
											<span class="d-flex align-items-center gap-2"><i size="24" class="material-icons">child_care</i> Children</span>
										...
										<div class="celroe col-8">
											...
											<div class="input-group countmore pax-count-wrapper">
												...
												<span class="input-group">
													...
													<button type="button" class="btn btn-secondary btn-number" data-type="minus" data-field="child[]">
												...
												<span class="input-group">
													...
													<button type="button" class="btn btn-secondary btn-number" data-type="plus" data-field="child[]">
									...
									<div class="chilagediv" style="<?=$child_room_visibility?>">
										...
										<div data-child="<?=$child?>" data-currnet="<?=$current_room_child_count?>" class="col-6 child-age-wrapper-<?=$child?>" style="<?=$child_age_visibility?>">
			...
			<div class="col-md-2 col-sm-4 col-12 srch_btn padfive">

			 <div class="searchsbmtfot flightbutton hotel_search_btn">

				<i class="fas fa-search"></i>

			 	<label class="lablform">&nbsp;</label>

				<input type="submit" id="hotel-form-submit" class="searchsbmt flight_search_btn" value="Search Hotel" />
		...
		<div class="hide" id="addlocation" <?php echo $loc_div_style; ?>>

				 <div class="col-md-8 col-sm-8 col-12 mobile_width padfive">

				 <div class="lablform">Location</div>

		   				<div class="plcetogo plcemark sidebord">

					<input type="text" id="pac-input" name="location" placeholder="Region, City, Area (Worldwide)" class="normalinput form-control b-r-0" value="<?php echo $location; ?>"/>

					</div>

					</div>

					<div class="col-md-4 col-sm-4 col-12 mobile_width padfive">
				...
				<div class="float-start location-search hide" id="locationsearch" style="padding-top: 10px;">
		   ...
		   <!--  <div class="searchsbmtfot flightbutton">
				...
				<input style="line-height: 50px !important;" type="submit" id="hotel-form-submit" class="searchsbmt flight_search_btn" value="Search Hotel" />
...
function initMap() {
  ...
  <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAiR9CLZshY_vQpB7z5M7nIGCg16gfo2E8&libraries=places&callback=initMap" async defer></script> -->
