<?php
Js_Loader::$css[] = array('href' => $GLOBALS['CI']->template->template_css_dir('page_resource/flight-search-form.css'), 'media' => 'screen');
...
<style>
.totlall .remngwd { padding-left: 0 !important; margin-top: 0 !important; }
.searchsbmtfot{bottom: 0px !important;}
</style>
...
<div class="search_button_container">
  <div class="searchsbmtfot flightbutton mt-3 mb-1">
