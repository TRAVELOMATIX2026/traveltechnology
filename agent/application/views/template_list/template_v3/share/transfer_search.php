...
if ((isset($transfer_search_params) == false) || (isset($transfer_search_params) == true && valid_array($transfer_search_params) == false)) {
    ...
    if ($sid > 0) {
        $transfer_search_params = $this->transfer_model->get_safe_search_data($sid, META_TRANSFER_COURSE);
...
<form id="trasfer" name="trasfer" autocomplete="off" action="<?= base_url() ?>index.php/general/pre_transfer_search">
    <div class="intabs">
        ...
        <div class="outsideserach">
            <div class="clearfix"></div>
            <div class="col-md-5 col-12 nopad padfive marginbotom10 aftremarg">
            ...
            <div class="col-md-4 col-12 padfive nopad">
                <div class="col-6 padfive fiveh">
                    <div class="borderinp">
                ...
                <div class="col-6 padfive fiveh date-wrapper">
                    <div class="borderinp">
            ...
            <div class="col-md-3 col-12 padfive nopad last_border">

                <div class="col-12 padfive mobile_width last_border">
                    <div class="borderinp">
                                ...
                                <div class="inallsn">
                                    <div class="oneroom fltravlr">
                                        ...
                                        <div class="roomrow">
                                            ...
                                            <div class="col-12 nopad float-end padfive hide">
        ...
        <div class="col-12 fiveh padfive float-end last_border">
                    <!-- <span class="formlabel">&nbsp;</span> -->
                    <div class="searchsbmtfot marginbot10">
                        <button class="searchsbmt flight_search_btn" type="submit">Search<span class="srcharow"></span></button>
                    </div>
        </div>
