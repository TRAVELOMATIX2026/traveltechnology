...
<form id="trasfer" name="car" autocomplete="off" action="<?=base_url()?>index.php/general/pre_car_search">
	<div class="tabspl forbusonly car_form" style="padding: 15px 0px;">
		...
		<div class="outsideserach custom_divclass">
			<div class="clearfix"></div>
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 nopad cr_plce">
			<div class="col-sm-6 col-6 padfive">
			...
			?>			
			<div class="col-md-5 col-12 nopad">
				<div class="col-4 padfive">					
				...
				<div class="clearfix"></div>
				<div class="col-12 nopad marginbotom10 aftremarg">
					<div class="float-end hide remove_age" id="remove_age">
					...
					<!-- <div id='add_age' class="hide float-end">
            ...
            <div class="col-md-2 col-12 padfive">
