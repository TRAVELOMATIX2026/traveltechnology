						...
						<div class="childgroup" data-roomid="<?php echo $loop_room_index?>">
							<div class="row">
								<div class="col-md-2 mefullwdhtl">
									...
									<div class="roomnumpn"><br><i class="bi bi-house-door"></i> <strong>(<?php echo $loop_room_index; ?>)</strong></div>
								</div>
							...
							if (intval($current_room_child_count) > 0) {
								...
								for($temp_index=0; $temp_index<$current_room_child_count; $temp_index++) {
									...
									<div class="row">
										...
										<div class="col-md-5 fiveh childAge cl_rt float-end childAge<?php echo ($temp_index+1)?>">
