...
-->
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-4 "><?php echo "<font color='Blue'><b>-". date("dMy",strtotime($result['bus_date_1']))."-></b></font>";?></div>
			<div class="col-lg-5 col-md-5 col-sm-5 col-4 ">
				<div class="float-end">
				...
				<div
					class="col-lg-8 col-md-8 col-sm-8 col-12 float-end arr_ldr_otr">
