...
extract($form_data);
$date_of_birth = $date_of_birth ? strtotime($date_of_birth) : null;
            ...
            <div class="alldasbord">
              <div class="userfstep">
                <div class="step_head">
                  ...
                  <a href="#edit_user_profile" data-aria-controls="home" data-role="tab" data-bs-toggle="tab" class="editpro" id="edit_profile_btn">Edit profile</a> </div>
                    ...
                    <form action="<?=base_url().'index.php/user/account?'.$_SERVER['QUERY_STRING']?>" method="post" name="edit_user_form" id="edit_user_form" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <div class="infowone">
                        ...
                        <div class="paspertorgn2 paspertedit">
                          ...
                          <div class="col-4 margpas">
                            <div class="tnlepasport_b2b">
                              <div class="paspolbl ">Date of Birth <span class="text-danger">*</span></div>
                              <div class="lablmain ">
                                <input type="text" name="date_of_birth" id="date_of_birth" placeholder="dob" value="<?=(($date_of_birth <= 0) ? '': $date_of_birth)?>" class="clainput" readonly required="required"/>
                              </div>
                            </div>
                          </div>
                         <?php if((empty($pan_number)) == true){
                          ...
                          <div id="pan_data" <?php echo @$style; ?>>
                            <div class="col-4 margpas">
                              <div class="tnlepasport_b2b">
                                ...
                                <div class="lablmain ">
                                  <input type="text" name="pan_number" placeholder="PAN Number" value="<?=$pan_number?>" class="clainput"  maxlength="10">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-4 margpas">
                            <div class="tnlepasport_b2b">
                              ...
                              <div class="lablmain ">
                                <input class="clainput" type="file" name="image" accept="image/*" />
                              </div>
                            </div>
                          </div>
                          <div class="col-4 margpas">
  <div class="tnlepasport_b2b">
    <div class="paspolbl">Company Incorporation Certificate</div>
    <div class="lablmain">
      <input type="file" name="c_certificate" accept="image/*" class="clainput" />
      <!-- Show uploaded image if exists -->
      <?php if (isset($c_certificate) && !empty($c_certificate)) { ?>
        <div class="uploaded-image">
          <img src="<?php echo str_replace('agent', '', base_url()).'extras/custom/TMX2565771716449443/images/agent_proofs/' . $c_certificate; ?>" alt="Company Incorporation Certificate" style="width:100px;height:auto;">
        </div>
      <?php } ?>
    </div>
  </div>
...
<div class="col-4 margpas">
  <div class="tnlepasport_b2b">
    <div class="paspolbl">Company GST Certificate</div>
    <div class="lablmain">
      <input type="file" name="c_gst" accept="image/*" class="clainput" />
      <!-- Show uploaded image if exists -->
      <?php if (isset($c_gst) && !empty($c_gst)) { ?>
        <div class="uploaded-image">
          <img src="<?php echo str_replace('agent', '', base_url()).'extras/custom/TMX2565771716449443/images/agent_proofs/'  . $c_gst; ?>" alt="Company GST Certificate" style="width:100px;height:auto;">
        </div>
      <?php } ?>
    </div>
  </div>
...
<div class="col-4 margpas">
  <div class="tnlepasport_b2b">
    <div class="paspolbl">Company Owner Proof</div>
    <div class="lablmain">
      <input type="file" name="c_owner_proof" accept="image/*" class="clainput" />
      <!-- Show uploaded image if exists -->
      <?php if (isset($c_owner_proof) && !empty($c_owner_proof)) { ?>
        <div class="uploaded-image">
          <img src="<?php echo str_replace('agent', '', base_url()).'extras/custom/TMX2565771716449443/images/agent_proofs/' . $c_owner_proof; ?>" alt="Company Owner Proof" style="width:100px;height:auto;">
        </div>
      <?php } ?>
    </div>
  </div>
...
<div class="col-4 margpas">
  <div class="tnlepasport_b2b">
    <div class="paspolbl">Company Address Proof</div>
    <div class="lablmain">
      <input type="file" name="c_address_proof" accept="image/*" class="clainput" />
      <!-- Show uploaded image if exists -->
      <?php if (isset($c_address_proof) && !empty($c_address_proof)) { ?>
        <div class="uploaded-image">
          <img src="<?php echo str_replace('agent', '', base_url()).'extras/custom/TMX2565771716449443/images/agent_proofs/' . $c_address_proof; ?>" alt="Company Address Proof" style="width:100px;height:auto;">
        </div>
      <?php } ?>
    </div>
  </div>
