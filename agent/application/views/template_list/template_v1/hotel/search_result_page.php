    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      <ul class="nav nav-justified nav-inverse">
        ...
        <li class="dropdown bg-default sortMobhtl">
          <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-arrows-v"></i> Hotel Name <span class="caret"></span></a>
        ...
        <li class="dropdown bg-default sortMobhtl">
          <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-arrows-v"></i> Star <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
        ...
        <li class="dropdown bg-default sortMobhtl">
          <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-arrows-v"></i> Price <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
	...
	<?php echo $GLOBALS['CI']->template->isolated_view('share/loader/hotel_result_pre_loader',$data);?>
		<div class="row">
			<div class="col-lg-2">
				...
				<div class="panel card b-r-0">
					<div class="card-body refine">
						<div class="row">
						<form>
							<div class="col-lg-12 col-md-4 col-sm-6 hidden-xs hidden-sm">
								<h3 class="h4 m-t-0 trigger-collapse-view refine-header" data-bs-toggle="collapse" data-bs-target=".price-refine"><img src=" <?php echo $GLOBALS['CI']->template->template_images('icons/price-tag-icon.png')?>" alt="Price Tag Icon"> Price <?php echo $mini_loading_image?></h3>
							...
							<div class="col-lg-12 col-md-4 col-sm-6 hidden-xs hidden-sm">
								...
								<h3 class="h4 m-t-0 trigger-collapse-view refine-header" data-bs-toggle="collapse" data-bs-target=".starrating-refine"><img src="<?php echo $GLOBALS['CI']->template->template_images('icons/hotel-star-icon.png')?>" alt="Hotel Star Icon"> Star Rating <?php echo $mini_loading_image?></h3>
							...
							<div class="col-lg-12 col-md-4 col-sm-6 hidden-xs hidden-sm">
								...
								<h3 class="h4 m-t-0 trigger-collapse-view refine-header" data-bs-toggle="collapse" data-bs-target=".propertytype-refine"><img src="<?php echo $GLOBALS['CI']->template->template_images('icons/property-type-icon.png')?>" alt="Property Type Icon"> <abbr title="Property">P</abbr> Type  <?php echo $mini_loading_image?></h3>
							...
							<div class="col-lg-12 col-md-4 col-sm-6">
								<hr class="visible-lg-block hr-10">
								<h3 class="h4 m-t-0 trigger-collapse-view refine-header" data-bs-toggle="collapse" data-bs-target=".hotelsearch-refine"> Hotel Name <?php echo $mini_loading_image?></h3>
								<div class="collapse hotelsearch-refine">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<div class="input-group">
												<button type="submit" class="btn btn-secondary b-r-0" id="hotel-name-search-btn"><i class="fa fa-search fa-fw"></i></button>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-12 col-md-4 col-sm-6 hidden-xs hidden-sm">
								<hr class="visible-lg-block hr-10">
								<h3 class="h4 m-t-0 trigger-collapse-view refine-header" data-bs-toggle="collapse" data-bs-target=".location-refine"> Location <?php echo $mini_loading_image?></h3>
			...
			<div class="col-lg-10">
				...
				<div class="btn-group" role="group">
					<label type="button" class="btn btn-secondary btn-lg b-r-0 filter-hotels-view" for="all-hotels-view">
					...
					<label type="button" class="btn btn-secondary btn-lg b-r-0 filter-hotels-view" for="deal-hotels-view">
				...
				<div id="hotel_search_result" class="panel xs-text-center hotel-search-result-panel card b-r-0 m-b-10">
				</div>
