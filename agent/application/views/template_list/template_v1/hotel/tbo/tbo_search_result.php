...
?>
	<div class="card-body p-0 r-r-i">
		<div class="row lg-flex">
			<div class="col-md-2 col-sm-6 p-tb-10">
				<figure>
					<img class="img-fluid mx-auto d-block" alt="Hotel Image" src="<?php echo $hd['HotelPicture']?>">
				</figure>
			</div>
			<div class="col-md-5 col-sm-6 p-tb-10">
				...
				<h5><img alt="Hotel Location Icon" src="<?php echo $template_images?>icons/hotel-location-icon.png">
				 <span class="hotel-location"><?=$hd['HotelLocation']?></span></h5>				
				<h6>
				...
				<div class="row row-no-gutter text-center">
					...
					<div class="col-md-3">
						<div role="group" class="btn-group btn-group-vertical">
							<button class="btn btn-secondary b-r-0" type="button">SMS</button>
							<button class="btn btn-secondary b-r-0" type="button"><i class="fa fa-usd"></i></button>
							...
							<button class="btn btn-secondary b-r-0 room-btn" type="button"><img alt="Double Arrow Down Icon" src="<?=$template_images?>icons/double-arrow-down-icon.png"></button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="clearfix room-list" style="display:none">
			<div class="row">
				<div class="col-md-12">
					<h5 class="text-info text-center">Room Details <i class="fa fa-bed"></i><i class="fa fa-arrow-circle-down float-end"></i></h5>
				</div>
			</div>
			<?=$mini_loading_image?>
