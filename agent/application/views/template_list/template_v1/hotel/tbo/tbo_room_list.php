...
foreach ($_RoomCombinations['RoomCombination'] as $__rc_key => $__rc_value) {
	...
	$clean_room_list .= '<div class="panel card">';
	...
	foreach ($current_combination_wrapper as $__room_index_key => $__room_index_value) {
		...
		$room_panel_details .= '<p><a href="#"class="" data-bs-toggle="tooltip" data-placement="top" title="'.$temp_room_details['CancellationPolicy'].'">Cancellation Policy</a></p>';
		$room_panel_details .= '</div>';
...
$clean_room_list .= '<div class="card-header">';
$clean_room_list .= '<div class="card-title">'.$room_panel_summary.$temp_book_link.'</div>';
$clean_room_list .= '</div>';
$clean_room_list .= '<div class="card-body dtls_body" style="display:none;">';
