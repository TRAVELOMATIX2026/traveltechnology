<main class="search-result-main">
	<div class="container">
		<div class="panel card b-r-0 ser_hotl_rslts">
			<div class="card-body p-0">
				<div class="row m-0 lg-flex">
					...
					<div class="col-lg-2 col-md-4 col-sm-6 col-6 p-tb-10 b-r">
					...
					<div class="col-lg-1 col-md-4 col-sm-6 col-6 p-tb-10 b-r">
					...
					<div class="col-lg-2 col-md-4 col-sm-6 col-12 p-tb-10 b-r">
					...
					<div class="col-lg-2 col-md-4 col-sm-6 p-tb-10">
						<button type="button" class="margt15 btn btn-lg btn-block btn-p b-r-0 hotel_search_form" data-bs-toggle="collapse" href="#hotel_search_form">Modify Search</button>
					</div>
				</div>
