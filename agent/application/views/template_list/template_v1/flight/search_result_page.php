	...
	<div class="container">
		...
		<div class="row rowclear">
						...
						<div class="row">
							<div class="col-lg-12 col-md-4 col-sm-6">
								<h3 class="h4 m-t-0 refine-header trigger-collapse-view"
									data-bs-toggle="collapse" data-bs-target=".price-refine"><img
							...
							<div class="col-lg-12 col-md-4 col-sm-6">
								...
								<h3 class="h4 m-t-0 refine-header trigger-collapse-view"
									data-bs-toggle="collapse" data-bs-target=".airlines-refine"><img
							...
							<div class="col-lg-12 col-md-4 col-sm-6">
								...
								<h3 class="h4 m-t-0 refine-header trigger-collapse-view"
									data-bs-toggle="collapse" data-bs-target=".stop-refine"><img
							...
							<div class="col-lg-12 col-md-4 col-sm-6">
								<hr class="visible-lg-block hr-10">
								<h3 class="h4 m-t-0 refine-header trigger-collapse-view"
									data-bs-toggle="collapse" data-bs-target=".duration-refine"><i class="fa fa-clock-o"></i> Departure</h3>
			...
			<div class="col-lg-10 nopadMob">
				<div class="row row-no-gutter mobHide" id="clone-list-container">
					<div class="col-lg-2">
						<div class="panel card b-r-0 m-0">
							<div class="card-body text-center p-tb-8">
								<img
				...
				<div class="panel card border-info b-r-0 hide summary-container" id="multi-flight-summary-container">
					<div class="card-body p-tb-5">
							...
							<div class="col-md-6 col-sm-6">
								<h5>
									...
									<form id="multi-flight-form" action="" method="POST" target="_blank">
										...
										<button class="btn btn-secondary b-r-0" type="submit" id="multi-flight-booking-btn">Book</button>
										<?php 
				...
				<hr class="hr-10">
				<div class="clearfix">
					<div class="float-end"><span class="h5">Showing: <?php echo $mini_loading_image?><span
...
function cloneSlider(slides)
{
	...
	$.each(cloneList, function(k, v) {
		...
		list += '<div class="panel card b-r-0 m-0">';
