...
?>
<a class="handCursor " data-bs-toggle="modal" data-bs-target="#myModal" data-backdrop="false" href="#" id="forgot-password">Forgot Password ? </a>
<!-- Modal -->
<div class="modal fade frgt_pwd_modl" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
