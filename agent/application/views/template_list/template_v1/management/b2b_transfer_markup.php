	...
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
		<div class="panel_custom_heading"><!-- PANEL HEAD START -->
            ...
            <div class="float-start">
				<i class="fa fa-edit"></i> Manage Transfers Markup
            </div>
		...
		<div class="panel_bdy"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Transfers - Markup</legend>
		...
		<div class="card-body"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Transfers - Specific Domain Markup</legend>
