	...
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
        ...
        <div class="panel_title">
            ...
            <div class="float-start">
				<i class="bi bi-pencil-square"></i> Manage Flight Markup
            </div>
		...
		<div class="panel_bdy mb-3"><!-- Add Airline Starts-->
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0"><i class="bi bi-airplane"></i> Add Airline  <i class="bi bi-plus-lg"></i></h5>
				</div>
				<div class="card-body">
		...
		<!-- PANEL BODY START -->
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0"><i class="bi bi-airplane"></i> Flight - General Markup</h5>
				</div>
				<div class="card-body">
					<form action="" method="POST" autocomplete="off">
		...
		<div class="panel_bdy mb-3"><!-- PANEL BODY START -->
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0"><i class="bi bi-airplane"></i> Flight - Specific Airline Markup</h5>
				</div>
				<div class="card-body">
