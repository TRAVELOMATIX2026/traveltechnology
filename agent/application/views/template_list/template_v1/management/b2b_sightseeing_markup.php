	...
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
		<div class="panel_custom_heading"><!-- PANEL HEAD START -->
            ...
            <div class="float-start">
				<i class="fa fa-edit"></i> Manage Activities Markup
            </div>
		...
		<div class="panel_bdy"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Activities - Markup</legend>
				<form action="" class="row" method="POST" autocomplete="off">
					...
					<div class="card card-body card card-body p-2">
						<div class="clearfix offset-md-1">
		...
		<div class="card-body"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Activities - Specific Domain Markup</legend>
