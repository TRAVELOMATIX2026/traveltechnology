...
<div class="bodyContent">
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
            ...
            <div class="set_wraper">
                <div class="panel_title_bak">
                    <div class="float-start">
                        <i class="fa fa-edit"></i> Manage Bus Markup
                    </div>
		...
		<div class="panel_bdy mb-3"><!-- PANEL BODY START -->
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0"><i class="fa fa-bus"></i> Bus - Markup</h5>
				</div>
				<div class="card-body">
		...
		<div class="panel_bdy mb-3"><!-- PANEL BODY START -->
			<div class="card">
				<div class="card-header">
					<h5 class="card-title mb-0"><i class="fa fa-bus"></i> Bus - Specific Domain Markup</h5>
				</div>
				<div class="card-body">
