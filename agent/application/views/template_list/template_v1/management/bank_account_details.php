...
<ul class="nav nav-tabs b2b_navul" role="tablist" id="myTab">
	<li role="presentation" class="active"><a href="#tabList"
		aria-controls="home" role="tab" data-bs-toggle="tab"><span class="glyphicon glyphicon-book"></span>Bank Account Details
	</a></li>
...
{
	$table = '
<div class="table-responsive col-md-12"><table class="table table-hover table-striped table-bordered table-sm">';
	$table .= '<tr>
