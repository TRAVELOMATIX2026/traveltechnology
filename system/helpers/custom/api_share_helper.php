...
{
	return base_url().'index.php/hotel/confirm_hotel_booking/'.$app_reference.'/'.$booking_source;
}
...
{
	return base_url().'index.php/transfer/pre_cancellation/'.$app_reference.'/'.$booking_source.'/'.$status.'/'.$module;
}
/*************End*********/
/**
 * Flight Voucher
