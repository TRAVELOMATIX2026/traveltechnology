...
class application
{
	...
	function bouncer_page_validation()
	{
		$skip_validation_list = array(
			...
			'delete_b2c_cache_files',
			'delete_agent_cache_files',
			'delete_temp_cache_files',
			'delete_temp_pdf_files'
		); // SKIP LIST
	...
	function set_project_configuration()
	{
		...
		if ($api_data['status'] == true) {
			...
			$this->CI->transfer_url = 'http://test.services.travelomatix.com/webservices/transfer/service/';
