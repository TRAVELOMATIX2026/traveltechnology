                        ...
                        <div class='col-sm-12'>
                           <div class='' style='margin-bottom:0;'>
                              <div class='box-content'>
                                 <form class='form row validate-form' style='margin-bottom: 0;' action="<?php echo base_url(); ?>index.php/management/save_airport_master" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class='form-group'>
                                       ...
                                       <div class='col-sm-6 controls'>
                                          <div class="controls">
                                             <input type="text" name="airport_code" id="airport_code" value ="" required data-rule-required='true' class='form-control'>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="form-label col-sm-3" for="validation_current">Airport Name</label>
                                       <div class="col-sm-6 controls"><input type="text" name="airport_name" id="airport_name" placeholder="Airport Name"  class="form-control" value="" required></div>
                                    </div>
                                    <div class="form-group">
                                       <label class="form-label col-sm-3" for="validation_current">Airport City</label>
                                       <div class="col-sm-6 controls"><input type="text" name="airport_city" id="airport_city" placeholder="Airport City"  class="form-control" value="" required></div>
                                    </div>
                                    <div class="form-group">
                                       <label class="form-label col-sm-3" for="validation_current">Airport Country</label>
                                       <div class="col-sm-6 controls"><input type="text" name="country" id="country" placeholder="Airport Country"  class="form-control" value="" required></div>
                                    </div>
                                    <div class="form-group">
                                       <label class="form-label col-sm-3" for="validation_current">Country Code</label>
                                       <div class="col-sm-6 controls"><input type="text" name="CountryCode" id="CountryCode" placeholder="Country Code"  class="form-control" value="" required></div>
                                    </div>
                                    <div class="form-group">
                                       <label class="form-label col-sm-3" for="validation_current">Latitude</label>
                                       <div class="col-sm-6 controls"><input type="text" name="lat" id="lat" placeholder="Latitude"  class="form-control" value="" required></div>
                                    </div>

                                    <div class="form-group">
                                       <label class="form-label col-sm-3" for="validation_current">Longitude</label>
                                       <div class="col-sm-6 controls"><input type="text" name="lon" id="lon" placeholder="Longitude"  class="form-control" value="" required></div>
                                    </div>

                                    <div class="form-group">
                                       <label class="form-label col-sm-3" for="validation_current">Timezone</label>
                                       <div class="col-sm-6 controls"><input type="text" name="timezonename" id="timezonename" placeholder="Longitude"  class="form-control" value="" required></div>
                                    </div>
                                 
                                    <div class='form-group'>
                                       <label class='form-label col-sm-3' for='validation_current'>Is International</label>
                                       <div class='col-sm-6 col-md-6 controls'>
                                         <input type="checkbox" name="IsInternational" id="IsInternational" value="1"/>   
                                       </div>
                                    </div>
                                    ...
                                    <div class='form-group'>
                                       ...
                                       <div class='col-sm-6 col-md-6 controls'>
                                         <input type="checkbox" name="isTravellerAirport" id="isTravellerAirport" value="1"/>   
                                       </div>
                                    </div>
