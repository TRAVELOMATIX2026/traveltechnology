...
<div class="bodyContent col-md-12">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Manage B2B Domain Markup</h4>
    ...
    <div class="panel <?= PANEL_WRAPPER ?> card mb-4">
        <div class="card-header bg-white border-bottom">
            <h5 class="mb-0"><i class="bi bi-bus-front-fill text-dark"></i> Bus - General Markup</h5>
        </div>
    ...
    <?php if (valid_array($specific_markup_list)) { ?>
        <div class="panel <?= PANEL_WRAPPER ?> card ">
            <div class="card-header bg-white border-bottom">
                <h5 class="mb-0"><i class="bi bi-bus-front-fill text-dark"></i> Bus - Specific Domain Markup</h5>
            </div>
            <div class="card-body p-4">
