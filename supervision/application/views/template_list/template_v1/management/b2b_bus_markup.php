...
<h4 class="mb-2">Manage B2B Domain Markup</h4>
...
<fieldset><legend class="form_legend"><i class="bi bi-bus-front"></i> Bus - Markup</legend>
		...
		<div class="card-body p-4"><!-- PANEL BODY START -->
			<fieldset><legend class="form_legend"><i class="bi bi-bus-front"></i> Bus - Specific Domain Markup</legend>
