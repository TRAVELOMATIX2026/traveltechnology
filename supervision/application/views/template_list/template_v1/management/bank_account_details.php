...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation" class="<?php echo $tab1;?>"><a href="#fromList"
		aria-controls="home" role="tab" data-bs-toggle="tab"><?php echo get_app_message('AL00323');?>
	<span class="glyphicon glyphicon-pencil"></span></a></li>
	<li role="presentation" class="<?php echo $tab2;?>"><a href="#tabList"
		aria-controls="home" role="tab" data-bs-toggle="tab"><?php echo get_app_message('AL00324');?>
...
{
	$table = '
<div class="table-responsive col-md-12 bnk_accnts"><table class="table table-hover table-striped table-bordered table-sm">';
	$table .= '<tr>
...
{
	return '<a role="button" href="'.base_url().'management/bank_account_details?eid='.$id.'" class="btn btn-secondary btn-sm btn-primary">
...
function get_status_label($status)
{
	if (intval($status) == ACTIVE) {
		return '<span class="badge bg-success glyphicon glyphicon-hand-right">'.get_enum_list('status', ACTIVE).'</span>
	<a role="button" href="" class="hide">'.get_app_message('AL0021').'</a>';
	} else {
		return '<span class="badge bg-danger glyphicon glyphicon-hand-right">'.get_enum_list('status', INACTIVE).'</span>
