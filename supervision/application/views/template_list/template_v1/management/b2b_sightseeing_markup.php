...
<fieldset><legend class="form_legend"><i class="bi bi-binoculars"></i> Activities - Markup</legend>
				<form action="" class="row" method="POST" autocomplete="off">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group pt-5 mb-10">
		...
		<div class="card-body p-4"><!-- PANEL BODY START -->
			<fieldset><legend class="form_legend"><i class="bi bi-binoculars"></i> Activities - Specific Domain Markup</legend>
