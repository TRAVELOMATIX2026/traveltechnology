...
<fieldset><legend class="form_legend"><i class="bi bi-car-front"></i> Car - Markup</legend>
		...
		<div class="card-body p-4"><!-- PANEL BODY START -->
			<fieldset><legend class="form_legend"><i class="bi bi-car-front"></i> Car - Specific Domain Markup</legend>
