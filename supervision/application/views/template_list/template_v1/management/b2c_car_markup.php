...
<div class="bodyContent col-md-12">
    ...
    <div class="panel <?= PANEL_WRAPPER ?> card mb-4">
        <div class="card-header bg-white border-bottom">
            <h5 class="mb-0"><i class="bi bi-car-front-fill text-dark"></i> Car - General Markup</h5>
        </div>
    ...
    <?php if (valid_array($specific_markup_list)) { ?>
        <div class="panel <?= PANEL_WRAPPER ?> card ">
            <div class="card-header bg-white border-bottom">
                <h5 class="mb-0"><i class="bi bi-car-front-fill text-dark"></i> Car - Specific Domain Markup</h5>
            </div>
            <div class="card-body p-4">
