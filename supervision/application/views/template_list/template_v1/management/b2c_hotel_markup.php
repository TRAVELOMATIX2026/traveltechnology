...
<fieldset><legend class="form_legend"><i class="bi bi-building"></i> Hotel - Markup</legend>
		...
		<div class="card-body p-4"><!-- PANEL BODY START -->
			<fieldset><legend class="form_legend"><i class="bi bi-building"></i> Hotel - Specific Domain Markup</legend>
