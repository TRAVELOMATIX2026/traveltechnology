<?php 
   ...
   define(SYSTEM_IMAGE_URL, BASE_PATH.SYSTEM_IMAGE_DIR);
   ...
   if(isset($airline_contact_no['data'][0])){
      ...
      $airline_number = '<span><img style="vertical-align:middle;width:16px;" src='.SYSTEM_IMAGE_URL.'phone.png />&nbsp;<span style="font-size:12pt;color:#008100;vertical-align:middle;font-weight: 600;">'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
...
<div style="width:100%; position:relative;font-family: 'Open Sans', sans-serif;">
   <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px;background-color:#fff;border-collapse:separate; color: #000;">
      <tbody>
         <tr>
            <td colspan="2" valign="bottom" style="padding-bottom:10px;background-color:#008100;"><img style="width:150px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->domain_images($data['logo'])?>" /></td>
            <td valign="bottom" colspan="2" style="padding-bottom:10px;background-color:#008100;color:#fff;" align="right"><span>Booking ID : <?=@$booking_details['app_reference']?></span><br><span>Booked on : <?=app_friendly_absolute_date(@$booking_details['booked_date'])?></span></td>
         </tr>

         <tr><td colspan="4" style="line-height:7px;padding:0;">&nbsp;</td></tr>

         <tr>
            <td align="right" colspan="4" style="line-height:25px;font-size:14px;border-top:2px solid #008100; border-bottom:1px solid #008100;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status'])?>" style=" font-size:14px;">
               <?php
         ...
         <tr>
            ...
            <td style="padding:10px 0; vertical-align:middle;width:10%;"><img style="width:50px;" src="<?=SYSTEM_IMAGE_URL.'airline_logo_gif/'.$itinerary_details[0]['airline_code'].'.gif'?>" /></td>
            
            <td style="padding:10px 0; vertical-align:middle; line-height:normal;border-right: 1px solid #999;"><span style="display: block;"><span style="font-size:11pt;"><?=@$itinerary_details[0]['airline_name']?></span><br><br><span style="font-size:11pt;"><?php echo $airline_number ?></span></span></td>

            <td style="padding:10px 0; vertical-align:middle; padding-left: 10%; line-height:normal;"><span style="font-size:11pt;">Agency</span>

               <br><br><span style="font-size:12pt;color:#008100;vertical-align:middle;font-weight: 600;"><img style="vertical-align:middle;width:16px;line-height:normal;" src="<?=SYSTEM_IMAGE_URL.'phone.png'?>" />&nbsp;<span style="line-height:normal;"><?php echo $data['phone']?></span></span></td>
            ...
            <td style="padding:10px 0;text-align: left;">
               ...
               <span style="padding:5px; display:block">AIRLINE PNR: </span>

               <strong style="line-height:35px;padding-bottom: 5px;display:block;font-size:18px;"><?=@$airline_pnr?></strong> <br>
               ...
               <span style="display:block; padding:5px;">GDS PNR: </span>
               <strong style="font-size:18px;"><?=@$airline_pnr?></strong>
         ...
         <tr>
            <td colspan="4" style="padding:0;" width="100%"><table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="4" width="50%" style="background-color:#008100; color:#fff"><img width="9" src="<?=SYSTEM_IMAGE_URL.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Onward Flight Details</span></td> 
                        <td colspan="6" width="50%" align="right" style="background-color:#008100; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                     </tr>
                     ...
                     <?php 
                        ...
                        if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
                              ...
                              foreach ( $itinerary_details as $segment_details_k => $segment_details_v ) { 
                                 ...
                                 $layour = '';
                                    if(isset($itinerary_details[$segment_details_k+1]) && $itinerary_details[$segment_details_k+1]['segment_indicator'] == ($segment_details_v['segment_indicator']+1)){
                                          $layour = flight_segment_duration($itinerary_details[$segment_details_k+1]['from_airport_code'],$segment_details_v['to_airport_code'], $itinerary_details[$segment_details_k+1]['departure_datetime'], $segment_details_v['arrival_datetime']);
                                    }
                     ...
                     <tr>
                        ...
                        <td colspan="4" width="50%" style="background-color:#008100; color:#fff"><img width="9" src="<?=SYSTEM_IMAGE_URL.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Return Flight Details</span></td> 

                        <td align="right" colspan="6" width="50%" style="background-color:#008100; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                       ...
                       // $cabin_baggage += (int) $segment_details_v['cabin_baggage'];  
                        ...
                        # Checking CheckIN Baggage
                                    ...
                                    if (is_int($segment_details_v['checkin_baggage'])) {
                                        ...
                                        @$BaggageSegment_checkin .= 'Checkin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ($booking_source == CLARITYNDC_FLIGHT_BOOKING_SOURCE ? ' ('.$segment_details_v['checkin_baggage'].')</br>':' (Adult :' . $segment_details_v['checkin_baggage'] . ' & Child :'.$segment_details_v['checkin_baggage'] .')<br />');
                                    ...
                                    if (is_int($segment_details_v['cabin_baggage'])) {
                                        ...
                                        @$BaggageSegment_cabin .= 'Cabin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ($booking_source == CLARITYNDC_FLIGHT_BOOKING_SOURCE ? ' ('.$segment_details_v['cabin_baggage'].')</br>':' (Adult :' . $segment_details_v['cabin_baggage'] . ' & Child : '.$segment_details_v['cabin_baggage'].')<br />');
                     ...
                     <tr>
                        ...
                        <td colspan="2" style="background-color:#d9d9d9;border-left:1px solid #008100; color:#555555"><span>Flight <?php echo $fight_count; ?></span></td>

                        <td colspan="2" style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_URL.'flight_up.png'?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>

                        <td colspan="2" style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_URL.'flight_down.png'?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>

                        <td colspan="4" width="100%" style="background-color:#d9d9d9;border-right:1px solid #008100; color:#555555">&nbsp;</td>

                     </tr>
                     <?php endif;?>
                     <tr>

                        <td colspan="2" style="line-height: 13px;"><span><?=@$segment_details_v['airline_name']?><br><?php echo $segment_details_v['airline_code'].' - '.$segment_details_v['flight_number'];?><br>Cabin: <?php echo $booking_details['cabin_class']; ?></span></td>

                        <td colspan="2" style="line-height: 13px;"><span><strong><?=@$segment_details_v['from_airport_name'] ?>(<?=@$segment_details_v['from_airport_code']?>)</strong><br><?php echo date("D, d M Y",strtotime($segment_details_v['departure_datetime'])).", ".date("h:i A",strtotime($segment_details_v['departure_datetime']));?><br><?php echo $origin_terminal;?></span></td>

                        <td colspan="2" style="line-height: 13px;"><span><strong><?=@$segment_details_v['to_airport_name']?>(<?=@$segment_details_v['to_airport_code']?>)</strong><br><?php echo date("D, d M Y",strtotime($segment_details_v['arrival_datetime'])).", ".date("h:i A",strtotime($segment_details_v['arrival_datetime']));?><br><?php echo $destination_terminal;?></span></td>

                        <td colspan="4" width="100%" style="line-height: 13px;border-left: 1px solid #999;">
                        <span style="display:block; padding-left:10%">
                           <!-- <?php echo $non_stop; ?><br> -->
                           <?php echo $segment_details_v['total_duration'];?><br><?php echo $segment_details_v['is_refundable']?>
                        </span></td>

                     </tr>
                     <?php if($layour): ?>
                     <tr>
                     <td colspan="10" style="background-color:#d9d9d9; color:#008100;width:100%;text-align:center;font-style:italic;font-weight:bold;"><span style="vertical-align:middle;"><span style="color:#000;font-weight:normal;">--------</span> Layover <?php echo $layour ?> <span style="color:#000;font-weight:normal;">--------</span></span></td>
                     </tr> 
                     <?php endif;?>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table cellspacing="0" cellpadding="5" width="100%" style="background-color:#008100; border:1px solid #008100;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="4" width="100%" style="color:#fff"><img width="12" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_URL.'people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Passenger(s) Details</span></td>
                     </tr>

                     <tr>
                        <td style="background-color:#d9d9d9;border-left:1px solid #008100; color:#555555" width="100%"><span>Sr No.</span></td>
                        ...
                        <td style="background-color:#d9d9d9;border-right:1px solid #008100; color:#555555" width="100%"><span>E-ticket No</span></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td style="line-height: 13px; background-color:#fff;"><span><?php echo ($cus_k+1);?></span></td>
                        <td style="line-height: 13px; background-color:#fff;"><span><strong><?php echo $pass_name;?></strong></span></td>
                        <td style="line-height: 13px; background-color:#fff;"><span><?php echo ucfirst($cus_v['passenger_type'])?></span></td>
                        <td style="line-height: 13px; background-color:#fff;"><span><?=@$cus_v['TicketNumber'];?></span></td>
         ...
         <tr>
            <td colspan="4" style="padding:0;" width="100%">
               <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td width="100%" colspan="6" style="padding:0;vertical-align:top;">
                           <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #008100;">
                              <tbody>
                                 <tr>
                                    <td style="border-bottom:1px solid #008100;background:#008100;color:#fff;" width="100%" colspan="4"><span style="font-size:10pt">Payment Details</span></td>
                                    <td style="border-bottom:1px solid #008100;background:#008100;color:#fff;" width="100%" colspan="4"><span style="font-size:10pt">Amount ( <?php echo $booking_details['currency']?>
                                       )</span>
                                    </td>
                                 </tr>
                                 <?php  //if($receipt_type == 'price_receipt') { ?>

                                 <tr>
                                    <td style="line-height: 13px;" width="100%" colspan="4"><span>Air Fare</span></td>
                                    <td style="line-height: 13px;" width="100%" colspan="4"><span> <?php echo number_format($BaseFare,2)?></span></td>
                                 </tr>

                                 <?php if($this->uri->segment(2)=='b2c_flight_voucher'):?>

                                    <tr>
                                       <td width="100%" colspan="4"><span>Taxes &amp; Fees</span></td>
                                       <td width="100%"><span> <?php echo number_format(($Tax+$booking_details['admin_markup']+$booking_details['agent_markup']+($booking_details['convinence_amount']))-$booking_details['admin_commission']+$booking_details['admin_tds'], 2)?></span></td>
                                    </tr>
                                    ...
                                    <tr>
                                       <td width="100%" colspan="4"><span>Taxes &amp; Fees</span></td>
                                       <td width="100%"><span> <?php echo number_format(($Tax+$booking_details['admin_markup']+$booking_details['agent_markup']+($booking_details['convinence_amount']+$booking_details['agentServicefee'])), 2)?></span></td>
                                    </tr>
                                 ...
                                 <tr>
                                    <td width="100%" colspan="4"><span>GST</span></td>
                                    <td width="100%"><span> <?php echo number_format(($GST), 2)?></span></td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td style="line-height: 13px;" width="100%" colspan="4"><span>Cabin Baggage</span></td>
                                    <td style="line-height: 13px;" width="100%"><span> <?php echo number_format($baggage_price,2)?></span></td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td style="line-height: 13px;" width="100%" colspan="4"><span>Meals</span></td>
                                    <td style="line-height: 13px;" width="100%"><span> <?php echo number_format($meal_price,2)?></span></td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td style="line-height: 13px;" width="100%" colspan="4"><span>Seat</span></td>
                                    <td style="line-height: 13px;" width="100%"><span> <?php echo number_format($seat_price,2)?></span></td>
                                 </tr>

                                 <?php } if($booking_details['discount']!=0){ ?>

                                 <tr>
                                    <td width="100%" colspan="4"><span>Discount (-)</span></td>
                                    <td width="100%"><span> <?php echo number_format($booking_details['discount'],2)?></span></td>
                                 </tr>

                                 <?php } //} ?>

                                 <tr>
                                    <td style="border-top:1px solid #008100;line-height: 13px;" colspan="4"><span style="font-size:10pt">Grand Total</span></td>
                                    <td style="border-top:1px solid #008100;line-height: 13px;" width="100%" colspan="4"><span style="font-size:10pt"> <?=number_format((@$booking_details['grand_total']+$seat_price+$meal_price+$baggage_price+ $booking_details['agentServicefee']),2)?></span></td>
                                 </tr>
                              </tbody>
                           </table>
                        </td>

                        <td width="100%" colspan="2" style="padding:0;padding-left:14px; vertical-align:top">
                          <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:12px; padding:0;">
                              <tbody>
                                 <tr>
                                    <td colspan="8" width="100%" style="border-bottom:1px solid #008100;background:#008100;color:#fff;"><span style="font-size:13px">Flight Inclusions</span></td>
                                 </tr>

                                 <tr>
                                    <?php if (!empty($TotalBaggageCheckIN)) { ?>
                                    <td colspan="6" width="100%"><span><?php echo $BaggageSegment_checkin; ?></span></td>
                                    <?php } else {

                                       ?>

                                    <td colspan="6" width="100%"><span>Cabin Baggage : Allowed as per the Airline Policy</span></td>
                                    <?php } ?>
                                 </tr>

                                 <tr>
                                    <?php if (!empty($TotalBaggageCabin)) { ?>

                                    <td colspan="6" width="100%"><span><?php echo $BaggageSegment_cabin; ?></span></td>
                                    <?php } else {
                                       ?>
                                       <td colspan="6" width="100%"><span>Cabin Baggage : Allowed as per the Airline Policy</span></td>
                                    <?php } ?>
                                 ...
                                 <tr>
                                    <td colspan="8" width="100%" style="border-top:1px solid #008100"><span style="font-size:10px; color:#666; line-height:20px;">* Flight inclusions are subject to change with Airlines.</span></td>
                                 </tr>
         ...
         <tr>
            <td colspan="4" style="padding-top:10px; vertical-align:top; padding:0;" width="100%">
               <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="8" width="100%" style="background-color:#008100; color:#fff;"><span style="font-size:10pt" width="100%">Flight Extra Information</span></td>
                     </tr>
                     ...
                     <tr>
                        <td colspan="8" width="100%" style="background-color:#d9d9d9; color:#555555"><span><?php echo 'Extra Baggage Information'; ?> ( <?=$bag_lv?> )</span></td>
                     </tr>
                     ...
                     <tr>
                        <td width="100%" style="border-left:none;border-right:1px solid #fff"><?=$bd_v['description']?> ( <?=$bag_v[0]['pax_name']?> )</td>
                     </tr>
                     ...
                     <tr>
                        <td colspan="8" style="background-color:#d9d9d9; color:#555555"><span><?php echo $meal_type_label; ?> ( <?=$meal_lv?> )</span></td>
                     </tr>
                     ...
                     <tr>
                        <td width="100%" style="border-left:none;border-right:1px solid #fff"><?=$md_v['description']?> ( <?=$meal_v[0]['pax_name']?> )</td>
                     </tr>
                     ...
                     <tr>
                        <td colspan="8" width="100%" style="background-color:#d9d9d9; color:#555555"><span><?php echo $seat_type_label; ?> ( <?=$seat_lv?> )</span></td>
                     </tr>
                     ...
                     <tr>
                        <td colspan="8" style="border-left:none; border-bottom:none"><?=$seat_description?> ( <?=$seat_v[0]['pax_name']?> )</td>
                     </tr>
         ...
         <tr>
            <td colspan="4" style="padding-bottom:15px;line-height:30px;border-bottom:1px solid #008100;text-align:center"><span style="font-size:10pt; color:#555;">Customer Contact Details | E-mail : <?=$booking_details['email']?> | Contact No :<?=$booking_details['phone_code']?> <?=$booking_details['phone']?></span></td>
         </tr>
         <tr>
            <td style="line-height:3px;padding:0;">&nbsp;</td>
         </tr>
   ...
   <tr><td colspan="4"><span style="line-height:23px; font-size:10pt;">Important Information</span></td></tr>
   <tr>
      <td colspan="4" style="">
         <ul style="line-height:15px;font-size:9pt; color:#555;">
   ...
   <table style="font-family: 'Open Sans', sans-serif;font-size:9pt;" width="100%">
      <tbody>
         <tr>
            <td colspan="4" style="line-height:8px;padding:0;border-bottom:1px solid #008100;">&nbsp;</td>
         </tr>
         <tr>
            <td colspan="4" style="line-height:8px;padding:0;">&nbsp;</td>
         </tr>
         <tr>
            <td colspan="4" align="" style="padding-top:0px; line-height:16px;font-size:13px;">
            <strong><?php echo strtoupper($data['domainname'])?></strong>&nbsp;&nbsp; | &nbsp;&nbsp;
            <strong>Contact No: </strong><?php echo $data['phone_code']?> <?php echo $data['phone']?>&nbsp;&nbsp; | &nbsp;&nbsp;<?php echo $data['address']?></td>
         </tr>
      </tbody>
   </table>
...
if(isset($airline_contact_no['data'][0])){
   ...
   $airline_number = '<span><img style="vertical-align:middle" src='.SYSTEM_IMAGE_URL.'phone.png /><span style="font-size:16px;color:#008100;vertical-align:middle;font-weight: 600;"> &nbsp;'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
   ...
   <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td align="right" colspan="4" style="line-height:25px;font-size:14px; border-top:2px solid #008100; border-bottom:1px solid #008100;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[1]['status'])?>" style=" font-size:14px;">
         ...
         <tr>
            ...
            <td style="padding:10px 0; vertical-align:middle;width:10%;"><img style="width:50px;" src="<?=SYSTEM_IMAGE_URL.'airline_logo/'.$return_segment_details[0]['airline_code'].'.svg'?>" /></td>
            ...
            <td style="padding:10px 0; vertical-align:middle; padding-left: 10%; line-height:normal;"><span style="font-size:11pt;">Agency</span><br><br><span style="font-size:12pt;color:#008100;vertical-align:middle;font-weight: 600;"><img valign="bottom" style="vertical-align:middle;width:12px;line-height:normal;" src="<?=SYSTEM_IMAGE_URL.'phone.png'?>" />&nbsp; <span style="line-height:normal;"><?php echo $data['phone']?></span></span></td>
            ...
            <span style="color:#008100;padding:5px; display:block">AIRLINE PNR</span>

            <span style="line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?=@$return_airline_pnr?></span>
         ...
         <tr>
            ...
            <td colspan="4" style="padding:0;">
               ...
               <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:9pt; padding:0;">

                  <tbody>

                     <tr>

                        <td colspan="2" style="background-color:#008100; color:#fff"><img width="9" src="<?=SYSTEM_IMAGE_URL.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt"><?php echo $Return;?>Flight Details</span></td>

                        <td align="right" colspan="2" style="background-color:#008100; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
...
# Checking Cabin Baggage
                     ...
                     <tr>
                        ...
                        <td style="background-color:#d9d9d9;border-left:1px solid #008100; color:#555555"><span style="color:#006f8e">Flight <?php echo $segment_details_v['segment_indicator'];?></span></td>

                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_URL.'flight_up.png'?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>

                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_URL.'flight_down.png'?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>

                        <td style="background-color:#d9d9d9;border-right:1px solid #008100; color:#555555">&nbsp;</td>
                     ...
                     <tr>
                        ...
                        <td style="line-height: 13px;"><span style="display:block;border-left: 1px solid #999; padding-left:10%">
                           <!-- <?php echo $non_stop; ?><br> -->
                           <?php echo $segment_details_v['total_duration'];?><br><?php echo $segment_details_v['is_refundable']?>
                        </span></td>
         ...
         <tr>
            ...
            <td colspan="4" style="padding:0;"><table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100; font-size:9pt; padding:0;">

                  <tbody>

                     <tr>

                        <td colspan="4" style="background-color:#008100; color:#fff"><img width="12" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_URL.'people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Passenger(s) Details</span></td>

                     </tr>

                     <tr>

                        <td style="background-color:#d9d9d9;border-left:1px solid #008100; color:#555555"><span>Sr No.</span></td>

                        <td style="background-color:#d9d9d9; color:#555555"><span>Passenger(s) Name</span></td>

                        <td style="background-color:#d9d9d9; color:#555555"><span>Type</span></td>

                        <td style="background-color:#d9d9d9;border-right:1px solid #008100; color:#555555"><span>E-ticket No</span></td>
    ...
    <?php } else {
        ...
        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4" style="border-top:1px solid #008100"><span style="font-size:10px; color:#666; line-height:20px;">* Flight inclusions are subject to change with Airlines.</span></td>
                           ...
                           <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:9pt; padding:0;">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="4" style="background-color:#008100; color:#fff;"><span style="font-size:10pt">Flight Extra Information</span></td>
         ...
         <tr>
            ...
            <td colspan="4" style="padding-bottom:15px;line-height:30px;border-bottom:1px solid #008100;text-align:center"><span style="font-size:10pt; color:#555;">Customer Contact Details | E-mail : <?=$booking_details['email']?> | Contact No : <?=$booking_details['phone']?></span></td>
         ...
         <tr><td colspan="4" style="line-height:8px;padding:0;border-bottom:1px solid #008100;">&nbsp;</td></tr>

         <tr><td colspan="4" style="line-height:8px;padding:0;">&nbsp;</td></tr>

         <tr>

            <td colspan="4" align="" style="padding-top:0px; line-height:16px"><?php echo strtoupper($data['domainname'])?>ContactNo : <?php echo $data['phone']?><?php echo $data['address']?></td>
