        ...
        <section class="invoice">
          ...
          <div class="row">
            ...
            <div class="col-6">
              ...
              <p style="margin-top: 10px;" class="text-muted card card-body card card-body p-2 no-shadow">
          ...
          <div class="row no-print">
            <div class="col-12">
              ...
              <button class="btn btn-success float-end"><i class="fa fa-credit-card"></i> Submit Payment</button>
