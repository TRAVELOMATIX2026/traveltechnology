...
if (isset($return_segment_details)) {
 ...
 if(isset($itinerary_details[0]['airline_pnr']))
    {
        $return_airline_pnr = $itinerary_details[1]['airline_pnr'];
    } else {
...
if (isset($airline_contact_no['data'][0])) {
    $airline_number = '<span><img style="vertical-align:middle" src=' . BASE_PATH.SYSTEM_IMAGE_DIR . 'phone.png /><span style="font-size:16px;color:black;vertical-align:middle;font-weight: 600;"> &nbsp;' . $airline_contact_no['data'][0]['phone_number'] . '</span></span> ';
} else {
    $airline_number = '';
}
...
<div style="background:#ccc; width:100%; position:relative; padding: 20px 0;">
    <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
        <tbody>
            ...
            <tr>
                <td align="right" colspan="4" style="line-height:26px; border-top:1px solid #454545; border-bottom:1px solid #454545;"><span style="font-size:12px;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status']) ?>" style=" font-size:14px;">
<?php
...
?></strong></td>
            ...
            <tr>
                ...
                <td style="padding:10px 0; line-height:25px; width:25%"><span style="display: block;border-right: 1px solid #999;"><span style="font-size:14px;"><?= @$itinerary_details[0]['airline_name'] ?></span><br><?php echo $airline_number ?></span></td>
                <td style="padding:10px 0; padding-left: 8%; line-height:25px;"><span style="font-size:14px;">Agency</span><br><span><img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'phone.png' ?>" /> <span style="font-size:16px;color:black;vertical-align:middle;font-weight: 600;"> &nbsp;<?php echo $data['phone'] ?></span></span></td>
<?php if ((!empty($gds_pnr)) || (!empty($airline_pnr))) { ?>
                    <td style="padding:10px 0; float:right;">
                        <span style="font-size:14px; display:block">
                            ...
                            <span style="padding:5px 5px 0px;">AIRLINE PNR: </span>
                            <span style="font-size:18px;line-height:28px;padding-bottom: 0px;font-weight: 600;"><?= @$airline_pnr ?></span>
                        </span>
                    <?php } ?>
                    <?php if (($booking_transaction_details[0] ['status'] == 'BOOKING_CONFIRMED' || $booking_transaction_details[1] ['status'] == 'BOOKING_HOLD') && !empty($gds_pnr)) { ?>
                                <span style="<?php echo $border; ?>display:block; padding:5px 5px 0;">
                                    <span>GDS PNR: </span>
...
<?php } ?>
            ...
            <tr>
            <tr>
                <td colspan="4" style="border:1px solid #454545; padding:0;">
                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
                        <tbody>
                            <tr>
                                <td colspan="2" style="background-color:#454545; color:#fff"><img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px">Onward Flight Details</span></td>
                                <td align="right" colspan="2" style="background-color:#454545; color:#fff"><span style="font-size:10px">*Please verify flight times with the airlines prior to departure</span></td>
                            </tr>
...
if (isset($booking_transaction_details) && $booking_transaction_details != "") {
    ...
    foreach ($itinerary_details as $segment_details_k => $segment_details_v) {
        ...
        if (in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')) {
            ...
            ?>
                                        <tr>
                                            <td colspan="2" style="background-color:#454545; color:#fff"><img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px">Return Flight Details</span></td>
                                            <td align="right" colspan="2" style="background-color:#454545; color:#fff"><span style="font-size:10px">*Please verify flight times with the airlines prior to departure</span></td>
                                        </tr>
                                  ...
                                  //  $BaggageSegment_cabin = '';
                                   // $BaggageSegment_checkin = '';
                                    ...
                                    if (valid_array($segment_details_v) == true) { 
                                        if($fight_count == 1):?>
                                        <tr>
                                            <td style="background-color:#d9d9d9; color:#555555">
                                                <span>Flight<?php //echo $fight_count; ?></span>
                                            </td>
                                            
                                            <td style="background-color:#d9d9d9; color:#555555">
                                                <img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'flight_up.png' ?>">&nbsp;<span style="vertical-align:middle">Departing</span>
                                            </td>
                                            <td style="background-color:#d9d9d9; color:#555555">
                                                <img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'flight_down.png' ?>">&nbsp;<span style="vertical-align:middle">Arriving</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="display:block;border-left: 1px solid #999; padding-left:10%"><?php echo $segment_details_v['total_duration']; ?><br><?php echo $segment_details_v['is_refundable'] ?></span></td>
                                        </tr>
                                        <?php if($layour): ?>
                                            <tr>
                                                <td colspan="4" style="background-color:#d9d9d9; color:black;width:100%;text-align:center;font-style:italic;font-weight:bold;"><span style="vertical-align:middle;"><span style="color:#000;font-weight:normal;">--------</span> Layover <?php echo $layour ?> <span style="color:#000;font-weight:normal;">--------</span></span></td>
                                            </tr> 
                                            <?php endif;?>
            <?php
        } 
            ...
            <tr>
                <td colspan="4" style="border:1px solid #454545; padding:0;">
                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
                        <tbody>
                            <tr>
                                <td colspan="4" style="background-color:#454545; color:#fff"><img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px">Passenger(s) Details</span></td>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td width="50%" style="padding:0;padding-right:14px;vertical-align:top;">
                                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #454545;">
                                        <tbody>
                                            <tr>
                                                <td style="border-bottom:1px solid #454545;background: #454545;color: #fff;"><span style="font-size:13px">Payment Details</span></td>
                                                <td style="border-bottom:1px solid #454545;background: #454545;color: #fff;"><span style="font-size:13px">Amount ( <?php echo $booking_details['currency'] ?>
                                                        )</span></td>
                                            </tr>
                                            <tr>
...
<?php endif; ?>
                                            ...
                                            <?php } ?>
                                            <tr>
                                                <td style="border-top:1px solid #454545;"><span style="font-size:13px">Grand Total</span></td>
                                                <td style="border-top:1px solid #454545;"><span style="font-size:13px"> <?= number_format((@$booking_details['grand_total'] + $seat_price + $meal_price + $baggage_price + $booking_details['agentServicefee']), 2) ?></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                <td width="50%" style="padding:0;padding-left:14px; vertical-align:top">
                                    <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #454545;font-size:12px; padding:0;">
                                        <tbody>
                                            <tr>
                                                <td colspan="4" style="border-bottom:1px solid #454545;background:#454545;color:#fff;"><span style="font-size:13px">Flight Inclusions</span></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="4" style="border-top:1px solid #454545;"><span style="font-size:10px; color:#666; line-height:20px;">* Flight inclusions are subject to change with Airlines.</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
...
<?php if (isset($booking_transaction_details_value['extra_service_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']) == true) { ?>
                                <tr>
                                    <td colspan="2" style="padding-top:10px; vertical-align:top; padding:0;">
                                        <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid darkgrey;font-size:12px; padding:0;">
                                            <tbody>
                                                <tr>
                                                    <td colspan="4" style="background-color:darkgrey; color:#fff;"><span style="font-size:13px">Flight Extra Information</span></td>
                                                </tr>
...
<?php } ?>
            ...
            <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
            <tr><td colspan="4" style="border-bottom:1px solid #454545;padding-bottom:15px"><span style="font-size:13px; color:#555;">Customer Contact Details | E-mail : <?= $booking_details['email'] ?> | Contact No :<?= $booking_details['phone_code'] ?> <?= $booking_details['phone'] ?></span></td></tr>
            <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
            <tr>
                <td colspan="4"><span style="line-height:20px; font-size:13px;">Important Information</span></td></tr>
            <tr>
                <td colspan="4" style="border-bottom:1px solid #454545; line-height:20px; font-size:12px; color:#555">
            ...
            <tr>
                <td colspan="4" align="" style="padding-top:10px">
                    <span style="font-weight:600;"><?php echo strtoupper($data['domainname']) ?></span>&nbsp;&nbsp; | &nbsp;&nbsp;<span style="font-weight:600;">Contact No: </span><?php echo $data['phone_code'] ?> <?php echo $data['phone'] ?>&nbsp;&nbsp; | &nbsp;&nbsp;<span  style="font-weight:600;">Address: </span><?php echo $data['address'] ?>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div style="background:#ccc; width:100%; position:relative">
        <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate;color: #000;">
            <tbody>
                ...
                <tr>
                    <td align="right" colspan="4" style="line-height:26px; border-top:1px solid #454545; border-bottom:1px solid #454545;"><span style="font-size:12px;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[1]['status']) ?>" style=" font-size:14px;">
                            <?php
                ...
                <tr>
                    <td style="padding:10px 0;width:2%;"><img style="width:60px;" src="<?= SYSTEM_IMAGE_DIR . 'airline_logo/' . $return_segment_details[0]['airline_code'] . '.svg' ?>" /></td>
                ...
                <tr>
                    <td colspan="4" style="border:1px solid darkgrey; padding:0;">
                        <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
                            <tbody>
                                <tr>
                                    <td colspan="2" style="background-color:darkgrey; color:#fff"><img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px"><?php echo $Return; ?> Flight Details</span></td>
                                    <td align="right" colspan="2" style="background-color:darkgrey; color:#fff"><span style="font-size:9px">*Please verify flight times with the airlines prior to departure</span></td>
                                </tr>
...
# Checking Cabin Baggage
                    ...
                    <td colspan="4" style="border:1px solid darkgrey; padding:0;">
                        <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" style="background-color:darkgrey; color:#fff"><img style="vertical-align:middle" src="<?= BASE_PATH.SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px;">Passenger(s) Details</span></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0; vertical-align:top">
                                        <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:12px; padding:0;">
                                            <tbody>
                                                <tr>
                                                    <td colspan="4" style="border-bottom:1px solid #008100;background:#008100;color:#fff;"><span style="font-size:13px">Flight Inclusions</span></td>
                                                </tr>
                                    ...
                                    <tr>
                                        <td style="padding:10px 0 0 0;vertical-align:top">
                                            <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:12px; padding:0;">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="4" style="border-bottom:1px solid #008100;"><span style="font-size:13px">Flight Extra Information</span></td>
                                                    </tr>
        <?php
        if (isset($booking_transaction_details_value['extra_service_details']['baggage_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['baggage_details']) == true) {
            $baggage_details = $booking_transaction_details_value['extra_service_details']['baggage_details'];
    ...
    <?php } ?>
                ...
                <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
                <tr><td colspan="4" style="border-bottom:1px solid #008100;padding-bottom:15px"><span style="font-size:13px; color:#555;">Customer Contact Details | E-mail : <?= $booking_details['email'] ?> | Contact No : <?= $booking_details['phone'] ?></span></td></tr>
                <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
                <tr>
                    <td colspan="4"><span style="line-height:20px; font-size:13px;">Important Information</span></td></tr>
                <tr>
                    <td colspan="4" style="border-bottom:1px solid #008100; line-height:20px; font-size:12px; color:#555">
                      <?php echo $data['terms_conditions']; ?>
                       <!--  <ul style="padding-bottom:10px">
                            <li>All Guests, including children and infants, must present valid identification at check-in.</li>
                            <li>Check-in begins 2 hours prior to the flight for seat assignment and closes 45 minutes prior to the scheduled departure.</li>
                ...
                <tr>
                    <td colspan="4" align="" style="padding-top:10px"><?php echo strtoupper($data['domainname']) ?>Contact No : <?php echo $data['phone'] ?><?php echo $data['address'] ?></td>
                </tr>
            </tbody>
        </table>
    </div>
