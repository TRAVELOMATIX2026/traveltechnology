  ...
  <tbody>
    <!-- <tr>
      <td style="border-collapse: collapse; padding:10px 20px 20px" ><table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0"> -->
        ...
        <tr>
					<td style="background-color:#008100;">
            <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
			        <tr>
					      <td style="padding: 10px;width:65%;"><img style="width:150px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->domain_images($data['logo'])?>"></td>
                  ...
                  <tr>
                    <td style="padding-bottom:10px;line-height:16px;color:#fff;" align="right"><span>Travel Date: <?=date("l\, jS F Y",strtotime($booking_details['travel_date']));?></span><br><span>Booking Reference: <?=$booking_details['app_reference']?></span><br><span>Activity Code: <?=$booking_details['product_code']?></span></td>
                  </tr>
                </table></td>
				      </tr>
				    </table>
          ...
          <td style="padding:0;"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 10pt;padding:5px;">
              <tbody>
                <tr>
                  ...
                  <?php else:?>
                  <td style="padding:10px 0"><img style="width:130px; height:107px;" src="<?=BASE_PATH.$GLOBALS['CI']->template->template_images("no_image_available.jpg");?>" /></td>
                  <?php endif;?>
                  <td width="40%" valign="top" style="padding:10px;line-height:15px;"><span style="font-size:11pt;color:#008100;vertical-align:middle;font-weight: 600;"><?=$booking_details['product_name']?></span><br><span style="display: block;font-size: 10pt;"><?=$attributes['Destination']?> </span><br><br><span style="display: block;font-size: 10pt;"><img style="width:50px;" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>"></span></td>
                  <td width="34%" style="padding:10px 0;text-align: center;line-height:25px;"><table style="border:2px solid #008100;">
                      <tbody>
                        <tr>
        ...
        <tr>
            ...
            <table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
              <tr> -->
                <td style="background-color:#008100;border: 1px solid #008100; color:#fff; font-size:10pt; padding:5px; line-height:normal;"><img width="12" src="<?=BASE_PATH.SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:10pt;color:#fff;line-height:12px;"> &nbsp;Activity Details</span></td>
              </tr>
							<tr>
								<td width="100%" style="border: 1px solid #008100;padding:0"><table width="100%" cellpadding="5" style="padding: 0px;font-size: 9pt;">	    
									    <tr>
											<td colspan="2" style="background-color:#d9d9d9;color: #333333;"><strong>Supplier</strong></td>
											<td width="100%" style="background-color:#d9d9d9;color: #333333;"><strong>Supplier Phone No</strong></td>
											<td width="100%" style="background-color:#d9d9d9;color: #333333;"><strong>Duration</strong></td>
											<td width="100%" align="center" style="background-color:#d9d9d9;color: #333333;"><strong>Total Traveler(s)</strong></td>			   
									    </tr>									    
									    <tr>
              ...
              <tr>
                <td style="background-color:#008100;border: 1px solid #008100; color:#fff; font-size:9pt; padding:5px;"><img width="12" style="vertical-align:middle" src="<?=BASE_PATH.SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:9pt;color:#fff;vertical-align:middle;"> &nbsp;Traveller(s) Details</span></td>
              </tr>
              <tr>
								<td width="100%" style="border: 1px solid #008100;padding:0"><table width="100%" cellpadding="5" style="padding: 0px;font-size: 9pt;">	 
                  <tr>
              ...
              <tr><td style="line-height:2px;">&nbsp;</td></tr>
                ...
                <td width="100%" style="padding:0"><table width="100%" cellpadding="5" style="padding: 0;font-size: 9pt;">   
                    <tbody>
                      <tr>
                        <td width="100%" colspan="4" style="padding:0px;vertical-align:top;"><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #008100;">
                            <tbody>
                              <tr>
                                ...
                                <td style="border-bottom:1px solid #008100;padding:5px;background:#008100;color:#fff;" width="100%" colspan="4"><span style="font-size:9pt">Amount (<?=$booking_details['currency']?>)</span></td>
                              </tr>
                                 <?php if($this->uri->segment(2)=='b2b_transfers_voucher'):?>
                                                        <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px" width="100%" colspan="4"><span style="font-size:13px">Base Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px" width="100%"><span style="font-size:13px"><?php echo roundoff_number($booking_details['grand_total']-$booking_details['gst']); ?></span></td>
                                                         </tr> 
                                                         <?php if($booking_details['gst'] > 0){?>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px" width="100%" colspan="4"><span style="font-size:13px">GST</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px" width="100%"><span style="font-size:13px"><?php echo roundoff_number($booking_details['gst']); ?></span></td>
                                                         </tr> 
                                                         <?php } ?>
                                                          <tr>
                                                            <td style="border-top:1px solid #008100;padding:5px" width="100%" colspan="4"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #008100;padding:5px" width="100%"><span style="font-size:13px"><?php echo roundoff_number($booking_details['grand_total']); ?></span></td>
                                                         </tr>
                                                         ...
                                                         <tr>
                                                            <td style="border-top:1px solid #008100;padding:5px" width="100%" colspan="4"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #008100;padding:5px" width="100%" colspan="4"><span style="font-size:13px"><?php echo roundoff_number($booking_details['product_total_price']+$booking_details['convinence_amount']-$booking_details['discount']+$booking_details['gst']); ?></span></td>
                                                         </tr>
                                                         <?php endif;?>
                            </tbody>
                          </table>
                        </td>
                        <td width="100%" colspan="2" style="padding:0px 0px 0px 14px;vertical-align:top;"><table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #008100;font-size:10pt; padding:0;">
                            <tbody>
                              <tr>
...
<div style="font-family: arial;">
  <tr>
    <td>
      <span style="font-size: 11pt;line-height:12px;font-weight: 500;">Tour Information</span><br>
      ...
      <ul style="font-size:9pt; color:#555">
        <?php foreach($additional_info as $ad):?><li><?=$ad?></li><?php endforeach;?>
      </ul>
