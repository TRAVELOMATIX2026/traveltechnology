...
if($module=='b2b'){
        ...
        $TotalDisplayFare = ($booking_details['product_total_price']+$booking_details['convinence_amount']-$booking_details['discount']);
...
?></td></tr>
    ...
    <div class="row">
        <div class="col-sm-12 invoice-col" style=" width: 100%;"> 
            <div><b>Total Rupees in word: <?php echo getIndianCurrency($total); ?></b></div><br />
        </div>
    </div>
    ...
    <div class="row no-print">
        <div class="col-12">
            <a class="btn btn-secondary" onclick="window.print()"><i class="fa fa-print"></i> Print</a>
<?php // echo flight_inovice_pdf($booking_details['app_reference'], $booking_details['booking_source'], $booking_details['status']);   ?>
            <!-- <button style="margin-right: 5px;" class="btn btn-primary float-end"><i class="fa fa-download"></i> Generate PDF</button> -->
        </div>
    </div>
</section><!-- /.content -->
...
function flight_inovice_pdf($app_reference, $booking_source = '', $status = '') {
    ...
    return '<a href="' . flight_invoice_url($app_reference, $booking_source, $status) . '/show_pdf" target="_blank" class="float-end"><i class="fa fa-download"></i> Generate PDF</a>';
}
?>
