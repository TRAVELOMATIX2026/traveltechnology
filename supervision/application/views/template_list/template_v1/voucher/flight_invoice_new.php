...
<?php foreach ($booking_transaction_details as $t_key => $t_value): ?>
   ...
   <section class="invoice">
      ...
      <div class="row">
         <div class="col-12">
            <h2 class="page-header"> <i class="fa fa-globe"></i> Sales Invoice
      ...
      <div class="row">
         <div class="col-sm-12 invoice-col" style=" width: 100%;">
            <div><b>Total Rupees in words: <?php echo getIndianCurrency($total); ?></b></div>
            <br>
         </div>
      </div>
      <!-- info row -->
      ...
      <div class="row no-print">
         <div class="col-12">
            <a class="btn btn-secondary" onclick="window.print()"><i class="fa fa-print"></i> Print</a> <!-- <button style="margin-right: 5px;" class="btn btn-primary float-end"><i class="fa fa-download"></i> Generate PDF</button> -->
         </div>
      </div>
   </section>
<?php endforeach; ?>
