					...
					<table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td style="padding: 10px;">
												...
												<tr>
													...
													<td style="padding: 10px; width: 35%;">
														<table width="100%" style="border-collapse: collapse; text-align: right; line-height: 15px;" cellpadding="0" cellspacing="0" border="0">
															<tr>
																<td style="font-size: 14px;"><span style="width: 100%; float: left"></span></td>
															</tr>
														</table>
													</td>
												</tr>
								...
								<tr>
									<td width="50%" style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Reservation Ticket (<?php echo ucfirst($booking_details['car_pickup_lcation']).' To '.ucfirst($booking_details['car_drop_location']);?>)</td>
								</tr>
								<tr>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Rental Price Includes
										</td>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Payment Details
										</td>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 13px; font-weight: bold;color:#fff;background:#008100;">Pay at Pickup
										</td>
