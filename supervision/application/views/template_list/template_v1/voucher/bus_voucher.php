                                                ...
                                                <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td style="padding:5px"><span><?=@$booking_details['fare']+$booking_details['admin_markup']+$booking_details['agent_markup']?></span></td>
                                                      </tr>
      ...
      ?>
                     ...
                     <tr>
                        <td colspan="4" style="line-height:20px; border-bottom:1px solid #999999; padding-bottom:15px; font-size:12px; color:#555"><?php echo $data['terms_conditions']; ?></td>
                              ...
                              <tr>
                                 <td align="center" colspan="4" style="border-bottom:1px solid #999999;padding-bottom:15px"><span style="font-size:13px; color:#555;">Customer Contact Details | E-mail : <?php echo $booking_details['email'];?> | Contact No : <?php echo $booking_details['phone_code'];?><?php echo $booking_details['phone_number'];?></span></td>
                              </tr>
                              <tr>
                                 <td style="line-height:12px;">&nbsp;</td>
                              </tr>
