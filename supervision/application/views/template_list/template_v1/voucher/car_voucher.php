					...
					<tr>
						<td>
							<table width="100%" style="border-collapse: collapse;"
								...
								<tr>
									<td width="50%"
										style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Reservation Ticket (<?php echo ucfirst($booking_details['car_pickup_lcation']).' To '.ucfirst($booking_details['car_drop_location']);?>)</td>
								</tr>
								<tr>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Travelers
										Information</td>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Rental Price Includes
										</td>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Payment Details
										</td>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Cancellatio Policy
										</td>
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Pay at Pickup
										</td>
								...
								<tr>
									<td width="50%"
										style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;color:#fff;background:#008100;">Terms
										and Conditions</td>
								</tr>
								<tr>
	...
	<tbody>
		<tr>
			<td align="center"><input
				style="background: #008100; height: 34px; padding: 10px; border-radius: 4px; border: none; color: #fff; margin: 0 2px;"
