...
// exit;
   ...
   ?>
<div class="table-responsive" style="width:100%; position:relative;background: #ccc; padding:20px 0px;" id="tickect_hotel">
   <table class="table" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; width:800px; margin:0px auto;background-color:#fff;">
      <tbody>
         <tr>
            <td style="border-collapse: collapse; padding:30px 35px; color:#000;" >
                  ...
                  <tr>
                     <td style="padding: 0px;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                              ...
                              <td colspan="2" style="border-bottom:1px solid #ddd;">
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    <tr style="background: #008100;">
                                       <td style="padding: 0px 0px 10px; vertical-align:middle;"><img src="<?=BASE_PATH.$GLOBALS['CI']->template->domain_images($data['logo'])?>"></td>
                                       <td style="padding: 0px 0px 10px; float:right;line-height: 26px;color:#fff;">
                                          <span style="font-weight:600;"><img width="15px" style="margin-right:5px; filter: brightness(0) invert(1);" src="<?=BASE_PATH.$GLOBALS['CI']->template->template_images("call_v.png");?>"> <?=$data['phone_code']?><?=$data['phone']?></span><br>
                           ...
                           <!-- <tr>
                              <td align="left" width="80%" style="line-height:24px;font-size:13px;border-top:1px solid #00a9d6;border-bottom:1px solid #00a9d6;padding: 5px;color:#FF0000">
                              <?php if($booking_details['booking_status']=='BOOKING_HOLD'){?> Note: This is not a final voucher. After final booking, the original booking ID will generate. <?php } ?>
                              </td>
                           </tr> -->
                           ...
                           <tr>
                              <td coslpan="2"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                 <tbody>
                                    ...
                                    <tr>
                                       <td style="font-weight:600; font-size:15px; padding:0;padding:12px 0 20px;">Your booking is<strong class="<?php echo booking_status_label( $booking_details['status']);?>" style="font-size:15px; background:none !important; color:#000 !important; padding:0;">
                                          <?php 
                           ...
                           <tr>
                              <td colspan="2" style="background:#efefef;padding:10px;border-radius:5px;"><table width="100%" cellpadding="5" style="padding: 0px;font-size: 14px;">
                                 <tbody>
                                    <tr>
                                    ...
                                    <tbody>
                                       <tr style="display:flex;align-items:stretch;padding-bottom: 10px;border-bottom:1px dashed #ccc;">
                                          ...
                                          <td valign="top" style="padding:0px 10px;width:70%;">
                                             ...
                                             <span style="display: block;line-height:22px;font-size: 13px;"><img style="width:70px;" src="<?php echo BASE_PATH.$GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>" /></span><span style="display: block;line-height:22px;font-size: 12px;"><?php echo $booking_details['hotel_address']; ?> </span>
                           ...
                           <tr>
                              <td  width="100%" style="background:#efefef; padding:10px;border-radius:5px;">
                                 <table width="100%" cellpadding="5" style="padding: 0px;font-size: 13px;">
                                    <tr>
                                       <td style="padding:5px;color: #333333;font-weight:600;font-size: 14px;">Sr No.</td>
                                       <td style="padding:5px;color: #333333;font-weight:600;font-size: 14px;">Passenger(s) Name</td>
                                       ...
                                       <td style="padding:5px;color: #333333;font-weight:600;font-size: 14px;">Type</td>
                                       <td style="padding:5px;color: #333333;font-weight:600;font-size: 14px;">Age</td>
                                    </tr>
                                    <!-- <tr>
                                       ...
                                       <tr>
                                          <td width="100%" style="background: #efefef;padding: 10px;border-radius:5px;">
                                             <table cellspacing="0" cellpadding="5" width="100%" style="font-size:13px; padding:0;">
                                                <tbody>
                                                   <tr>
                                                      <td style="padding:5px;"><span style="font-size:14px;font-weight:600;">Payment Details</span></td>
                                                      <td style="padding:5px;"><span style="font-size:14px;font-weight:600;">Amount (<?=COURSE_LIST_DEFAULT_CURRENCY_SYMBOL?>)</span></td>
                                                   </tr>
                                                   <tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td style="padding:5px"><span><?php echo roundoff_number(($booking_details['total_fare_tax']+$booking_details['agentServicefee'])/$booking_details['currency_conversion_rate']); ?></span></td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px;font-weight:600;">Total Fare</span></td>
                                                      <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px;font-weight:600;"><?php echo roundoff_number(($booking_details['total_fare_markup']+$booking_details['total_fare_tax']+$booking_details['agentServicefee']-$booking_details['discount'])/$booking_details['currency_conversion_rate']); ?></span></td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td style="border-top:1px solid #ccc;padding:5px"><span><?php echo roundoff_number($booking_details['total_destination_charge']/$booking_details['currency_conversion_rate']); ?></span></td>
                                                   </tr>
                                                      <?php } ?>
                                                </tbody>
                                             </table>
                           ...
                           <tr>
								      <td colspan="4" style="line-height:20px; border-bottom:1px solid #999999; padding-bottom:15px; font-size:12px; color:#555">
                                 <ul>
                           ...
                           <!--<tr>
                           <td colspan="4"><span style="line-height:26px;font-size: 14px;font-weight: 500;">Important Information</span></td>
                           </tr>
                           <tr>
   ...
   <table id="printOption"onclick="w=window.open();w.document.write(document.getElementById('tickect_hotel').innerHTML);w.print();w.close(); return true;"
      ...
      <tbody>
         <tr>
            <td align="center"><input style="background:#008100; height:34px; padding:10px; border-radius:4px; border:none; color:#fff; margin:0 2px;" type="button" value="Print" />
         </tr>
      </tbody>
   </table>
</div>