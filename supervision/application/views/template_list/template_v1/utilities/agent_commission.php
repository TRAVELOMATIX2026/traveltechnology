...
<?php if($show_update_form == true || $add_default_commission == true) { ?>
	<li role="presentation" class="<?php echo $tab1; ?>"><a
		...
		data-bs-toggle="tab"> <i class="fa fa-edit"></i> <?php echo get_app_message($update_tab_label);?>
	</a></li>
	<?php  } ?>
...
function get_table($table_data='')
{
	...
	$search_filter = '<div class="">
					...
					<button title="Search:Agency,Email,Mobile,ID" class="btn btn-secondary" type="submit"><i class="fa fa-search"></i></button>
					<a title="Clear Search" class="btn btn-secondary" href="'.base_url().'index.php/management/agent_commission"><i class="fa fa-history"></i></a>
					</form>';
	$table .= $pagination;
	$table .= $search_filter;
	$table .= '
   <div class="table-responsive agnt_cmmsn">
...
function flight_commission_tab($flight_commission_details, $agent_ref_id, $super_admin_flight_commission)
{
	...
	$details = '
        ...
        <div class="card-header">
        	<div class="card-title"><span class="fa fa-plane"></span> flight Commission</div>
       </div>
...
function bus_commission_tab($bus_commission_details, $agent_ref_id, $super_admin_bus_commission)
{
	...
	$details = '
        ...
        <div class="card-header">
        	<div class="card-title"><span class="fa fa-bus"></span> Bus Commission</div>
       </div>
        <div class="card-body commission_wrapper" >
	        <div class="hide hidden_commission_details">
...
function sightseeing_commission_tab($sightseeing_commission_details, $agent_ref_id, $super_admin_sightseeing_commission){
	...
	$details = '
        ...
        <div class="card-header">
        	<div class="card-title"><span class="far fa-binoculars"></span> Activities Commission</div>
       </div>
        <div class="card-body commission_wrapper" >
	        <div class="hide hidden_commission_details">
...
function transfer_commission_tab($transfer_commission_details, $agent_ref_id, $super_admin_transfer_commission){
	...
	$details = '
        ...
        <div class="card-header">
        	<div class="card-title"><span class="fa fa-taxi"></span> Transfer Commission</div>
       </div>
        <div class="card-body commission_wrapper" >
	        <div class="hide hidden_commission_details">
