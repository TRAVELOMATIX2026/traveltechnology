...
$(document).ready(function() {
	...
	$('.updateButton').on('click', function () {
		...
		var val = $(this).closest('td').siblings().children('[name="value"]').val();
		var id = $(this).closest('td').siblings().children('[name="value"]').attr('id');
//console.log(val);
//console.log(id);
 
		$.post(app_base_url+'index.php/utilities/edit_social_login1/'+$(this).closest('td').siblings().children('[name="value"]').val()+'/'+$(this).closest('td').siblings().children('[name="value"]').attr('id'), function (response) {
