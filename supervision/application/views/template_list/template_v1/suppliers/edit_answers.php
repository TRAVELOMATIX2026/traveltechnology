...
<form class='form row validate-form' style='margin-bottom: 0;' action="<?php echo base_url(); ?>supplier/update_answers/" method="post">
<?php foreach ($packdata as $key => $packdata); ?>
 ...
 <div><h1></h1></div>
                    ...
                    <div class='form-group'>
                           <label class='form-label col-sm-3'  for='validation_quest'>Question
  </label>
                      ...
                      <!-- <input type="text" name="excludes" id="excludes" data-rule-required='true' class='form-control'> -->
                       <textarea name="quest" class="form-control" data-rule-required="true"  cols="70" rows="3" placeholder="Question"><?php echo $packdata->question;?></textarea>
                          ...
                          <div class='form-group'>
                           <label class='form-label col-sm-3'  for='validation_answer'>Answer
  </label>
                             <div class='col-sm-4 controls'>
