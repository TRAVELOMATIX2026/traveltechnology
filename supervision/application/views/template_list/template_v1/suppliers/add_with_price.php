              ...
              <div class='box-content'>
                <form action="<?php echo base_url(); ?>index.php/supplier/add_package_new" method="post"  enctype="multipart/form-data" class='form row validate-form'>
                  ...
                  <div class='form-group'>
                    <label class='form-label col-sm-3' for='validation_name'>Package type</label>
                  ...
                  <div class='form-group' id="price_with" hidden>
                    <label class='form-label col-sm-3'  for='validation_current'>Price Includes
                    </label>
                  ...
                  <div class='form-group'>
                    <label class='form-label col-sm-3' for='validation_company'>Package Dsiplay Image</label>
                    <div class='col-sm-4 controls'>
                  ...
                  <div class="box-content">
                    <!--  <div class='form-group'>
                      <label class='form-label col-sm-2'>From Date</label>
                      ...
                      <label class='form-label col-sm-2'>To Date</label>
                      <div class='input-group col-sm-3' >
                    ...
                    <div class='form-group'>
                      <label class='form-label col-sm-2' for='adult'>Price</label>
                      <div class='input-group col-sm-3' >
                      ...
                      <!--  <label class='form-label col-sm-2' for='child'>Child Price</label>
                        <div class='input-group col-sm-3' >
                  ...
                  <div class="duration_info" id="duration_info">
                    <div class='form-group'>
                      <label class='form-label col-sm-3'  for='validation_desc'>Itinerary Description
                      </label>
                      <div class='col-sm-4 controls'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4 controls'>
                      ...
                      <textarea name="advance" class="form-control ckeditor" data-rule-required="true"  cols="70" rows="3" placeholder="Cancellation In Advance"></textarea>
                    </div>
                  </div>
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4 controls'>
                      <!-- <input type="text" name="excludes" id="excludes" data-rule-required='true' class='form-control'> -->
                      <textarea name="penality" class="form-control ckeditor" data-rule-required="true"  cols="70" rows="3" placeholder="Cancellation Penalty"></textarea>
                    </div>
                  </div>
                  <div class='box-header blue-background'>
