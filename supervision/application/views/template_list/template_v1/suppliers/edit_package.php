...
<script src="<?=base_url();?>assets/javascripts/jquery/jquery-1.10.2.js" type="text/javascript"></script>
  ...
  <form class='form row validate-form' style='margin-bottom: 0;' action="<?php echo base_url(); ?>supplier/update_package/<?php echo $packdata->package_id;?>" method="post" enctype="multipart/form-data">
                       <!--  <form class='form row validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>supplier/update_package/<?php echo $package_id->package_country; ?>" method="post"  enctype="multipart/form-data">  -->
      ...
      <input type="text" name="duration" class="form-control" id="duration" value ="<?php echo $packdata->duration;?>" onchange="show_duration_info(this.value)" size="40" disabled>                          
                      ...
                      <label class='form-label col-sm-3'  for='validation_current'>Number of Questions
  </label>
      <div class="col-sm-4 controls"> 
                ...
                <option><?php echo $packdata->rating;?></option>
                  ...
                  <div class='box-header blue-background'>
                    ...
                    <div>
                     <div><h2></h2></div>
                    <div class='form-group'>
                           <label class='form-label col-sm-3'  for='validation_current'>Value
 </label>
                             <div class='col-sm-4 controls'>
                          ...
                          <div class='form-group'>
                           <label class='form-label col-sm-3'  for='validation_current'>Discount
 </label>
                             <div class='col-sm-4 controls'>
                          ...
                          <div class='form-group'>
                           <label class='form-label col-sm-3'  for='validation_current'>You Save
 </label>
                             <div class='col-sm-4 controls'>
                          ...
                          <div class='form-group'>
                           <label class='form-label col-sm-3'  for='validation_current'>Available Seats
 </label>
                             <div class='col-sm-4 controls'>
                          ...
                          <div class='form-group'>
                           <label class='form-label col-sm-3'  for='validation_current'>Time
 </label>
                             <div class='col-sm-4 controls'>
