...
<html>
<head>
    <title>View Bookings | China Dream Travel</title>
            ...
            <div class='col-12'>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Send mail to <?php echo $user->first_name; ?></div>
                    
                      
                    </div>
                    <div class='box-content '>
                      <form class='form row validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>supplier/send_mail" method="post"  enctype="multipart/form-data"> 
                ...
                <div class='form-group'>
                          <label class='form-label col-sm-3' for='validation_subject'>Subject</label>
