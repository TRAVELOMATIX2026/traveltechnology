...
<div class='form-group clearfix'>
	<label class='form-label col-sm-3' for='validation_name'>Day </label>
...
<div class='form-group clearfix'>
	<label class='form-label col-sm-3' for='validation_company'>Itinerary
		Image</label>
...
<div class='form-group clearfix'>
	...
	<div class='col-sm-8 controls'>
		<textarea name="desc[]" class="form-control itenary_elements iteditor" 
