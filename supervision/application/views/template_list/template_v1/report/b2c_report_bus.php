            ...
            <div id="show-search">
                ...
                <form method="GET" autocomplete="off">
                    ...
                    <div class="form-group row gap-0 mb-0">
                        ...
                        <!-- <a href="<?php echo base_url() . 'index.php/report/b2c_bus_report? ' ?>" id="clear-filter" class="btn btn-gradient-info"><i class="fa fa-times"></i> Clear Filter</a> -->
...
<div class="clearfix table-responsive reprt_tble"><!-- PANEL BODY START -->
            ...
            <table class="table table-sm table-bordered example3" id="b2c_report_bus_table">
					<thead>
						<tr>
							<th>Sno</th>
						...
						<?php
							...
							if (isset($table_data) == true and valid_array($table_data['booking_details']) == true) {
								...
								?>
								<tr>
									<td colspan="22" class="text-center no-data-found">
