...
<div class="bodyContent col-md-12">
	<div class="panel card clearfix"><!-- PANEL WRAP START -->
		...
		<div class="card-body">
			...
			<hr>			
			<h4>Advanced Search Panel <button class="btn btn-primary btn-sm toggle-btn" data-bs-toggle="collapse" data-bs-target="#show-search">+
				</button> </h4>
			<hr>
...
<div class="col-sm-6 col-md-3">
	...
	<input type="text" readonly id="created_datetime_to" class="form-control disable-date-auto-update" name="created_datetime_to" value="<?=@$created_datetime_to?>" placeholder="Request Date">
					...
					<button type="submit" class="btn btn-gradient-primary"><i class="fa fa-search"></i> Search</button> 
					<button type="reset" id="btn-reset" class="btn btn-gradient-warning"><i class="fa fa-refresh"></i> Reset</button>
					<a href="<?=base_url().'report/b2b_transfers_report?' ?>" id="clear-filter" class="btn btn-gradient-info"><i class="fa fa-times"></i> Clear Filter</a>
					</div>
            ...
            <div class="clearfix"></div>
                ...
                <div class="dropdown col-1">
                    <button class="btn btn-info dropdown-toggle" type="button" id="pdf_imp_drop" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <i class="fa fa-download" aria-hidden="true"></i> Pdf
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="pdf_imp_drop">
                        <li >
                            <a href="<?php echo base_url(); ?>index.php/report/export_confirmed_booking_transfer_report_b2b/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">Confirmed Booking</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/report/export_cancelled_booking_transfer_report_b2b/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" >Cancelled Booking</a>
                        </li>
                    </ul>
                </div>
		...
		<div class="clearfix table-responsive"><!-- PANEL BODY START -->
					<div class="float-start">
						<?php echo $this->pagination->create_links();?> <span class="">Total <?php echo $total_rows ?> Bookings</span>
									...
									<table class="table table-sm table-bordered" id="b2b_report_airline_table">
						<thead>
							<tr>
								<th>Sno</th>
