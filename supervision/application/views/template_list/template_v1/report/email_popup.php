    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	...
        	<div id="email_voucher_parameters">
					...
					<select class="form-control" id="voucher_type" required="required">
						<option value="no_price">No Price Include</option>
						<option value="price_receipt">Prices Include</option>
					</select>
					<br>
