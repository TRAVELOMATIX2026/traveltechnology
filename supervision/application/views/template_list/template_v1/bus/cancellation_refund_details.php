...
<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
	...
	<li role="presentation" class="active"><a
		...
		data-bs-toggle="tab"> <i class="fa fa-bus"></i> Bus Cancellation Details
	</a></li>
...
<form class="row" role="form" method="POST" action="<?=base_url()?>index.php/bus/update_refund_details" autocomplete="off" name="refund_details">
	<div class="card-body">
		<div class="col-md-12">
		...
		<?php } else { ?>
				...
				<div class="form-group">
					<label form="refund_details" class="col-sm-3 form-label">CancellationChargePercentage(%)</label>
					<div class="col-sm-6">
