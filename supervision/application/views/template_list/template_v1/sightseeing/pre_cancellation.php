			...
			<div class="col-6 nopad">
				<div class="btn_continue">
					<div class="amnt_disply">
						Total Amount Paid:
						<div class="amnt_paid"><?php echo $booking_details['currency'];?>
							...
							if($module=='b2b'){
								...
								echo roundoff_number($booking_details['product_total_price']+$booking_details['convinence_amount']-$booking_details['discount']);
							}
						?>
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		...
		<form method="get" action="<?=base_url().'index.php/sightseeing/cancel_booking/'.$app_reference.'/'.$booking_source?>">
