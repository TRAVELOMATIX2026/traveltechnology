...
<form class="row" role="form" method="POST" action="<?=base_url()?>index.php/sightseeing/update_refund_details" autocomplete="off" name="refund_details">
	<div class="card-body">
		<div class="col-md-12">
...
$(document).ready(function(){
	...
	$('#get_change_request_status').click(function(e){
		...
		$.get('<?=base_url()?>sightseeing/update_supplier_cancellation_status_details', params, function(response){
