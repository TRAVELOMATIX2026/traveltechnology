...
{
	if ($status == 'PENDING') {
		$action = '<button data-bs-toggle="modal" data-request-domain-name="'.$request_domain_name.'" data-request-default-amount="'.$default_currency_value.'" data-bs-target="#myModal" class="request-process-btn btn btn-success btn-sm" data-system-request-id="'.$system_request_id.'" data-request-origin="'.$request_origin.'" data-status-id="'.$status.'">Process</button>';
	} else {
