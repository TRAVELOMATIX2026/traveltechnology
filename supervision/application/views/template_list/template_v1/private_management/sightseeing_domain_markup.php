...
<div class="bodyContent">
	<div class="panel <?=PANEL_WRAPPER?>"><!-- PANEL WRAP START -->
		...
		<div class="card-body"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Sightseeing - General Markup</legend>
		...
		<div class="card-body"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Sightseeing - Specific Domain Markup</legend>
				<form action="<?=$_SERVER['PHP_SELF']?>" class="row" method="POST" autocomplete="off">
