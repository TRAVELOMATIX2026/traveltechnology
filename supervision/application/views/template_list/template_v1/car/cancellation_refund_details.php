...
<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
	...
	<li role="presentation" class="active"><a
		...
		data-bs-toggle="tab"> <i class="fa fa-home"></i> Car Cancellation Details
	</a></li>
...
<form class="row" role="form" method="POST" action="<?=base_url()?>index.php/car/update_refund_details" autocomplete="off" name="refund_details">
	<div class="card-body">
		<div class="col-md-12">
		...
		<p class="list-group-item">ConfirmationReference: <?=$booking_details['booking_reference'];?></p>
...
$(document).ready(function(){
	...
	$('#get_change_request_status').click(function(e){
		...
		$.get('<?=base_url()?>car/update_supplier_cancellation_status_details', params, function(response){
