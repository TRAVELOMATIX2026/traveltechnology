        ...
        <div class="card-header">
            <div class="card-title">
                <ul class="nav nav-tabs" role="tablist" id="myTab">
                    <li role="presentation" class="">Add Collaborations</li>
                </ul>
            </div>
        </div>
        <div class="card-body">
                ...
                <div role="tabpanel" class="clearfix tab-pane active" id="fromList">
                    <div class="col-md-12">
                        <div class="panel card border-info clearfix">
                            <div class="col-md-12">
                                <form class="row" role="form" enctype="multipart/form-data" method="POST" action="<?= base_url(); ?>cms/save_collaboration" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 form-label">Created Date <span class="text-danger">*</span></label>
                                        <div class="col-sm-4">
                                            <input type="date" name="created_date" class="form-control" required placeholder="Select Created Date" value="">
                                        </div>
                                    </div>
