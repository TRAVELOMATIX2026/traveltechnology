...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation" class="<?=$tab1?>">
		<a id="fromListHead" href="#fromList" aria-controls="home" role="tab"	data-bs-toggle="tab">Manage Tour Styles</a>
	</li>
         ...
         <form class="row" role="form" enctype="multipart/form-data" method="POST" action="<?= $action; ?>" autocomplete="off" name="home_page_heading">
            <fieldset form="promo_codes_form_edit">
               ...
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="destination" class="col-sm-3 form-label">Destination</label>
                  	<div class="col-sm-6">
                     <?php
                ...
                <div class="form-group">
                  <label form="promo_codes_form_edit" for="category" class="col-sm-3 form-label">Category</label>
                     <div class="col-sm-6">
                     <?php
               ...
               <?php } ?>
              	<div class="form-group">
                  <label form="promo_codes_form_edit" for="image" class="col-sm-3 form-label">Image</label>
                  	<div class="col-sm-6">
