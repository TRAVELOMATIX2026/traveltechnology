	...
	<div class="row">
		<div class="float-start" style="margin:5px 0">
			<a href="<?=base_url().'index.php/cms/add_tour_styles'?>">
				<button  class="btn btn-primary btn-sm float-end amarg">Add Tour Style</button>
			</a>
		</div>
	</div>
...
{
	return '<a role="button" href="'.base_url().'index.php/cms/add_tour_styles?'.$_SERVER['QUERY_STRING'].'&	origin='.$origin.'" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
