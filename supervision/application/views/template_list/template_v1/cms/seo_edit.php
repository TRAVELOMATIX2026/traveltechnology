...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation" class="<?=$tab1?>">
		<a id="fromListHead" href="#fromList" aria-controls="home" role="tab"	data-bs-toggle="tab">Manage SEO</a>
	</li>
...
<div class="tab-content">
   <div id="fromList" class="clearfix tab-pane  active " role="tabpanel">
      <div class="card-body">
         <form class="row" role="form" id="promo_codes_form_edit" enctype="multipart/form-data" method="POST" action="<?=base_url().'index.php/cms/update_seo_action?bid='.$primary_id?>" autocomplete="off" name="promo_codes_form_edit">
            ...
            <fieldset form="promo_codes_form_edit">
               ...
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="banner_title" class="col-sm-3 form-label">Keyword</label>
                     <div class="col-sm-6">
               ...
               <div class="form-group" style="margin-top:5px;">
                  <label form="promo_codes_form_edit" for="banner_order" class="col-sm-3 form-label">Module</label>
                  	<div class="col-sm-6">
            ...
            <div class="form-group">
               <div class="col-sm-8 offset-sm-4"> <button class=" btn btn-success " id="promo_codes_form_edit_submit" type="submit">Update</button>
            </div>
         </form>
      </div>
   </div>
