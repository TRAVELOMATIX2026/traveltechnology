...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation" class="<?=$tab1?>">
		<a id="fromListHead" href="#fromList" aria-controls="home" role="tab"	data-bs-toggle="tab">Manage Top Airlines</a>
	</li>
         ...
         <form class="row" role="form" enctype="multipart/form-data" method="POST" action="<?= $action; ?>" autocomplete="off" name="home_page_heading">
            <fieldset form="promo_codes_form_edit">
               ...
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="airline_name" class="col-sm-3 form-label">Airline</label>
                  	<div class="col-sm-6">
                     <?php
               ...
               <?php } ?>
              	<div class="form-group">
                  <label form="promo_codes_form_edit" for="airline_logo" class="col-sm-3 form-label">Logo</label>
                  	<div class="col-sm-6">
