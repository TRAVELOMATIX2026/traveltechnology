			...
			<div class="card-title">
				<ul class="nav nav-tabs" role="tablist" id="myTab">
					...
					<li role="presentation" class=""><a href="#fromList"
						aria-controls="home" role="tab" data-bs-toggle="tab"><?php echo get_app_message('AL00316');?> <span
				...
				<div role="tabpanel" class="clearfix tab-pane active" id="fromList">
					<div class="col-md-12">
						<div class="panel card border-info clearfix">
							<div class="col-md-12 offset-md-3 domain_logo_align">
							<?php echo get_banner_image($banner_image);?>
							</div>
							<div class="col-md-12">
								<form class="row" role="form" id="banner_image"
									...
									<div class="form-group">
										<label form="domain_logo" for="domain_logo"
											class="col-sm-4 form-label">Change banner_image<span
