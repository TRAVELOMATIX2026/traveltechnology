   ...
   <tr>
      ...
      <table width="100%">
         <tr style="background:#008100;color:#fff">
            <td align="center"><img src="<?php echo  BASE_PATH. $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo()); ?>" style="height:50px;" alt=" <?php echo domain_name();?>"></td>
         </tr>
         <tr>
