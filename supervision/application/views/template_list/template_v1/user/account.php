		...
		<div class="card-header"><!-- PANEL HEAD START -->
			<div class="card-title">
				<ul class="nav nav-tabs" role="tablist" id="myTab">
					...
					<li role="presentation" class="active"><a id="tableListHead" href="#tableList" aria-controls="profile" role="tab" data-bs-toggle="tab"><?php echo get_app_message('AL0016');?> <span class="glyphicon glyphicon-book"></span></a></li>
				  ...
				  <div role="tabpanel" class="tab-pane clearfix" id="fromList">
						<div class="col-md-12">
							<div class="panel <?=PANEL_WRAPPER?> clearfix">
								<div class="card-header"><?php echo get_utility_message('UL008')?>
								</div>
								<div class="card-body">
								<?php 
				...
				<?php } ?>
					<div role="tabpanel" class="tab-pane active clearfix" id="tableList">
						<div class="col-md-12 table-responsive">
							<div class="panel <?=PANEL_WRAPPER?> clearfix">
								<div class="card-header"><?php echo get_utility_message('UL007')?>
								</div>
								<div class="card-body">
								<?php
...
function get_details_summary($default_data='')
{
	if ((check_default_edit_privilege($default_data['user_id']) || super_privilege())) {
		$edit_button = '<div class="col-md-12"><a href="#fromList" id="fromListHead" aria-controls="home" role="tab" data-bs-toggle="tab" class="btn btn-primary float-end"><span class="glyphicon glyphicon-pencil"></span> &nbsp;'.get_app_message('AL0017').'</a></div>';
	} else {
		$edit_button = '';
	}
	return $summary = '<div class="col-md-12">
		<div class="col-md-3"><img src="'.$GLOBALS['CI']->template->domain_images(get_profile_image($default_data['image'])).'" alt="..." class="rounded col-md-12"></div>
		<div class="col-md-9">
			<div class="tr_titl">
