					...
					<div class="col-md-12">
						<div class="panel clearfix">
							...
							<div class="col-md-12 <?php echo $input_class;?>">
								<form class="row" role="form" id="key_details" enctype="multipart/form-data" method="POST" action="<?=base_url().'confidentials/update_details' ?>"
									autocomplete="off" name="key_details">
									<div class="form-group">
					                  	<label form="promo_codes_form_edit" for="banner_title" class="col-sm-3 form-label">Decrypt Key</label>
					                  	<div class="col-sm-6">
				               		...
				               		<div class="form-group">
					                  	<label form="promo_codes_form_edit" for="banner_title" class="col-sm-3 form-label">Secret Key</label>
					                  	<div class="col-sm-6">
				               		...
				               		<div class="form-group">
					                  	<label form="promo_codes_form_edit" for="banner_title" class="col-sm-3 form-label">Secret IV</label>
					                  	<div class="col-sm-6">
								...
								<input type="hidden" name="uid" value="VH1431938932">
									<div class="form-group">
					                  	<label form="promo_codes_form_edit" for="banner_title" class="col-sm-3 form-label">Email</label>
					                  	<div class="col-sm-6">
				               		...
				               		<div class="form-group">
					                  	<label form="promo_codes_form_edit" for="banner_title" class="col-sm-3 form-label">Password</label>
					                  	<div class="col-sm-6">
