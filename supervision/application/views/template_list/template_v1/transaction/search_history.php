...
<div class="panel card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <div id='daily-search-summary' class="col-md-12">
                //Daily Search Summary - Module Wise
                </div>
            </div>
        </div>
    </div>
...
<script>
$(function () {
    $('#daily-search-summary').highcharts({
        chart: {
            type: 'column'
        },
        title: {
            text: 'Daily Search Hits'
        },
        subtitle: {
            text: '<?=date("F Y")?>'
        },
        xAxis: {
            categories: <?=$daily_time_line_interval?>
        },
        yAxis: {
            min: 0,
            title: {
