...
$itinerary_details_details = $booking_data['booking_details'][0]['itinerary_details'][0];
$cancellation_details = $booking_data['booking_details'][0]['cancellation_details'][0];
...
<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
	...
	<li role="presentation" class="active"><a
		...
		data-bs-toggle="tab"> <i class="fa fa-home"></i> Activity Cancellation Details
	</a></li>
...
<form class="row" role="form" method="POST" action="<?=base_url()?>index.php/transfer/update_refund_details" autocomplete="off" name="refund_details">
	<div class="card-body">
		<div class="col-md-12">
		...
		<?php } else { ?>
				...
				<div class="form-group">
					<label form="refund_details" class="col-sm-3 form-label">RefundAmount</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label form="refund_details" class="col-sm-3 form-label">CancellationCharge</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label form="refund_details" class="col-sm-3 form-label">Refund Status<span class="text-danger">*</span></label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label form="refund_details" class="col-sm-3 form-label">Comments<span class="text-danger">*</span></label>
					<div class="col-sm-6">
...
$(document).ready(function(){
	...
	$('#get_change_request_status').click(function(e){
		...
		$.get('<?=base_url()?>index.php/transfer/update_supplier_cancellation_status_details', params, function(response){
