...
<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
	...
	<li role="presentation" class="active"><a
		...
		data-bs-toggle="tab"> <i class="fa fa-plane"></i> Flight Cancellation Details
	</a></li>
...
<div class="card-body">
	<div class="col-md-12">
			<div class="card-body">
				<div class="col-md-12">
				<!-- Refund Form Starts -->
				<form class="row" role="form" method="POST" action="<?=base_url()?>index.php/flight/update_ticket_refund_details" autocomplete="off" name="refund_details">
				...
				<?php if($agent_refund_status != 'PROCESSED'){ ?><!-- agent Refund Status Condition Starts -->
						...
						<div class="form-group">
							<label form="refund_details" class="col-sm-3 form-label">ServiceTaxOnRefundAmount</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label form="refund_details" class="col-sm-3 form-label">SwachhBharatCess</label>
							<div class="col-sm-6">
