...
$form_configuration['inputs'] =array(
    ...
    'ifsc_code' => array('type' => 'text',  'label_line_code' => 223, 'mandatory' => false),
    'pan_number' => array('type' => 'text',  'label_line_code' => 224, 'mandatory' => false),
...
$auto_validator['ifsc_code'] = 'trim|min_length[3]';
$auto_validator['pan_number'] = 'trim|min_length[3]';
