...
$form_configuration['inputs'] = array(
	...
	'pan_number' 	   => array('type' => 'hidden',     'label_line_code' => 226),
	...
	// 'currency' 	   => array('type' => 'select',   'label_line_code' => 147, 'source' => 'db', 'source_location'  => 'user_model::get_currency_user_creation'),
	...
	'gst_number' 	   => array('type' => 'text',     'label_line_code' => 257, 'mandatory' => false),
	'state' 	   => array('type' => 'select',     'label_line_code' => 258),
 ...
 * Add FORM
 */
$form_attributes = array('method' => 'POST', 'action' => '', 'class' => array('form-horizontal', 'user-form'));
...
'form_header' => $form_attributes,
		'sections' => array(
			...
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'date_of_birth', 'country_code', 'phone','gst_number','country_name', 'state', 'city','address', 'status', 'language_preference'),
				'fieldset' => 'FFL003'
			),
...
// $auto_validator['currency'] = 'trim|required|min_length[1]|max_length[3]';
...
$auto_validator['date_of_birth'] = 'required|trim|min_length[5]|xss_clean';
