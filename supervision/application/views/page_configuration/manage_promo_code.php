...
$form_configuration['inputs'] = array(
	...
	'alt_text'	=>	array('type' => 'hidden','label_line_code' => 1200,'mandatory' => false ),
...
'form_header' => '',
		'sections' => array(
			array('elements' => array(
					'origin' ,'promo_code', 'description', 'module', 'value_type', 'value', 'minimum_amount', 'expiry_date','promo_code_image','promo_code_image1','alt_text','display_home_page','status'
				),
				'fieldset' => 'FFL0051'
			)
		),
