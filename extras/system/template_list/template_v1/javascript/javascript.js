   ...
   */
   $.AdminLTE.tree = function (menu) {
    ...
    $("li a", $(menu)).on('click', function (e) {
      ...
      //Check if the next element is a menu (support both .treeview-menu and .menu-dropdown)
      var isMenu = checkElement.is('.treeview-menu') || checkElement.is('.menu-dropdown') || 
                   checkElement.find('.menu-dropdown').length > 0;
      
      // Find the actual dropdown if it's wrapped in a div
      if (checkElement.find('.menu-dropdown').length > 0) {
        checkElement = checkElement.find('.menu-dropdown').first();
      }

      //Check if the menu is visible
      if (isMenu && checkElement.is(':visible')) {
        //Close the menu
        ...
        // Update arrow
        $this.find('.menu-item-arrow').removeClass('menu-item-arrow-active').addClass('menu-item-arrow-inactive');
      }
      //If the menu is not visible
      else if (isMenu && !checkElement.is(':visible')) {
        //Get the parent menu
        ...
        parent.find('.menu-item-arrow-active').removeClass('menu-item-arrow-active').addClass('menu-item-arrow-inactive');

        //Open the target menu and add the menu-open class
        checkElement.slideDown(300, function () {
          //Add the class menu-open to the dropdown and parent li
          checkElement.addClass('menu-open');
          parent.find('li.active').removeClass('active');
          $parentLi.addClass('active menu-open');
        });
        
        // Update arrow to active state
        $this.find('.menu-item-arrow').removeClass('menu-item-arrow-inactive').addClass('menu-item-arrow-active');
      }
